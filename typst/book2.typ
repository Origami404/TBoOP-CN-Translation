...
#character[
  ...
  #p_normal[
    The disciplines of mathematics and the like are so necessary for magic that it is professed that without them, everyone will lose their way. Their work will be frustrated and they will achieve few desired effects.#t_footnote(<nt1148>, "nr1148")[1] Indeed, whatever exists and is possible in these more inferiors, natural virtues happen and are ruled by “number, weight, and measure.”#t_footnote(<nt1149>, "nr1149")[2] Harmony, motion, light, and all things that we see in these inferiors have their root and foundation in them.
  ]
  #p_normal[
    Yet, even without natural virtues, operations can be produced that are similar to nature from only the discipline of mathematics—as Plato said, things not true and participating with the divine, but with a certain likeness to those things related to them. Some examples are bodies that can move or speak but exist without animal virtues:#t_footnote(<nt1150>, "nr1150")[3] such things were made by the ancients—for instance, the statues and αὐτóματα#t_footnote(<nt1151>, "nr1151")[4] of Daedalus. As Aristotle recalled, the tripods of Vulcan and Daedalus moved by themselves and entered into contest by their own volition, as narrated by Homer.#t_footnote(<nt1152>, "nr1152")[5] We also read of the feast of Hiarba the Gymnosophist,#t_footnote(<nt1153>, "nr1153")[6] whose golden statues moved by themselves and worked as cupbearers and carvers for the guests.#t_footnote(<nt1154>, "nr1154")[7] We also read of the statues of Mercury that spoke#t_footnote(<nt1155>, "nr1155")[8] and the wooden pigeon of Architas that flew.#t_footnote(<nt1156>, "nr1156")[9] Cassiodorus wrote of the wonders of Boethius, a Diomedes in bronze that blew a trumpet, a bronze snake that hissed, and imitation birds that sang sweet songs.#t_footnote(<nt1157>, "nr1157")[10]
  ]
  #p_quote[
    #emph[Of the wonderful arts of mirrors.]
  ]
  #p_normal[
    Of this kind are various wonders that are produced in images from geometry and optics, of which we made mention earlier when we spoke of the element air. Thus, mirrors are made—some concave, others cylindrical—that make the likeness of things in air, remote and outside of their space, that seem like shadows. Apollonius and Vitellius#t_footnote(<nt1158>, "nr1158")[11] taught of these in their books on perspective and mirrors. We read that Pompey the Great brought a certain mirror among the spoils to Rome from the east, in which armies of soldiers could be seen.
  ]
  #p_normal[
...
#character[
  ...
  #p_normal[
    Finally, all natural species and those that are above nature are bound by certain numbers, which Pythagoras considered, saying that everything depends on numbers, distributing each virtue to each thing.#t_footnote(<nt1168>, "nr1168")[2] And Proclus said: “Number always exists, yet one is in voice, another is in the proportion of things, another in the soul and reason, and another in the divine.” Themistius, Boethius, and Averroes the Babylonian, together with Plato, thus extolled numbers, as no one can be a correctthinking philosopher without them.#t_footnote(<nt1169>, "nr1169")[3]
  ]
  #p_normal[
    But they speak of rational formalized numbers, not of the material, sensible, or vocal numbers of merchants,#t_footnote(<nt1170>, "nr1170")[4] of which the Pythagoreans, the Platonic Academy, and our Augustine make no regard. They turned their attention to the proportion resulting from them, which are called natural and formalized and rational numbers, from which great sacraments arise in such an extent in nature, as well as the divine and celestial.#t_footnote(<nt1171>, "nr1171")[5] Through them is a way to investigate and understand all that is knowable, and through them is a close access to natural prophecies. The abbot Joachim himself proceeded in no other way in his prophecies than though formalized numbers.#t_footnote(<nt1172>, "nr1172")[6]
  ]
]

#character[
  #p_title[
    Chapter 3. That numbers possess such great virtues in natural things as well as transnatural#t_footnote(<nt1173>, "nr1173")[1] things.
  ]
  #p_normal[
    In numbers therefore lie such a wonderful efficacy and virtue for good as well as for evil, which not only do the most splendid philosophers teach but Catholic teachers do as well; the chief among others, Saint Jerome, Augustine, Origen, Ambrose, Gregory of Nazianzus, Athanasius, Basil, Hilary, Rabanus,#t_footnote(<nt1774>, "nr1174")[2] Bede, and many others confirm. Hence, Hilary in #emph[Commentaries on the Psalms] testified that the seventy elders arranged the order of the Psalms according to the efficacy of numbers;#t_footnote(<nt1175>, "nr1175")[3] likewise, Rabanus, the famous teacher, composed a book on the singular virtues of numbers.#t_footnote(<nt1176>, "nr1176")[4]
  ]
  #p_quote[
    #emph[The virtues of the herb pentaphyllon.]
  ]
  #p_normal[
    Now of other such great virtues numbers possess in nature is shown in the herb pentaphyllon, which is [also called] cinquefoil. Indeed, it is said from the virtue of five, it resists poison, drives away daemons, is conducive to atonement, and its leaf, if one is taken twice a day in wine, cures a quotidian#t_footnote(<nt1177>, "nr1177")[5] fever, three for tertian, and four for quartan.#t_footnote(<nt1178>, "nr1178")[6] Similarly, four grains of the heliotrope#t_footnote(<nt1179>, "nr1179")[7] seed cures quartan; however, it is said that three is useful for tertian. In a similar way, it is said that vervain in wine cures fever, if in tertian cut from the third joint, if in quartan into the fourth joint. Serpents will die if pierced by an arrow once, but if twice they will strengthen.#t_footnote(<nt1180>, "nr1180")[8] These and many more of the like are gathered and testified by various authorities, and wherever they occur we can be sure that the cause is in the various proportions of various numbers with each other.
  ]
  #p_quote[
...
#character[
  ...
  #p_normal[
    Three is the first uncomposed number, a sacred number, the number of perfection, and the most powerful number. Indeed, there are three persons in God and three theological virtues in religion.#t_footnote(<nt1203>, "nr1203")[1] Hence this number is collected in ceremonies for the gods and many religions, whose auspices, prayers, and libations are repeated three times; of which Virgil sang:
  ]
  #p_img[
    #emph[. . . odd numbers are the joy of God.]#t_footnote(<nt1204>, "nr1204")[2]
  ]
  #p_normal[
    And Pythagoreans use them in sanctifications and purifications;#t_footnote(<nt1205>, "nr1205")[3] of which from Virgil:
  ]
  #p_poetry[
    #emph[He encircled his companions three times with pure water.]#t_footnote(<nt1206>, "nr1206")[4]
  ]
  #p_normal[
  ...
  #p_poetry[
    #emph[Bearing the image . . .]#t_footnote(<nt1207>, "nr1207")[5]
  ]
  #p_normal[
    And a little later:
  ]
  ...
  #p_poetry[
    #emph[Tie them in this way while you say, “ for Venus, I tie these chains.”]#t_footnote(<nt1208>, "nr1208")[6]
  ]
  #p_normal[
  ...
  #p_poetry[
    #emph[Calmed the churning seas and stopped rapid rivers].#t_footnote(<nt1209>, "nr1209")[7]
  ]
  #p_normal[
    And from Pliny: “In all medicines it is the custom to spit three times in prayer, and from this effect, one will be cured.”#t_footnote(<nt1210>, "nr1210")[8]
  ]
  #p_normal[
...
#emph[heimarmene,]#t_footnote(<nt1211>, "nr1211")[9] necessity and order—namely, the mutual agreement of causes, which many call fate, and the distribution of what must be carried out to the fruitful and their offspring.#t_footnote(<nt1212>, "nr1212")[10] The entirety of time is contained in three measurements—namely the past, present, and future. All sizes are contained in three, line, surface, and body. All bodies are contained in three intervals, length, width, and thickness.#t_footnote(<nt1213>, "nr1213")[11] Harmony is contained in three symphonies, a whole octave, a perfect fifth, and a fourth.#t_footnote(<nt1214>, "nr1214")[12] Likewise, there are three kinds of souls, vegetative, sensitive and intellectual, and together with these three are distributed: rationality, irascibility, and desire.#t_footnote(<nt1215>, "nr1215")[13]
  ]
  #p_quote[
    #emph[Things in which there are three.]
  ]
  #p_normal[
    And also according to the Prophet, there are three dispositions of the world from God, “number, weight, and measure”; and appointed them to the ideal forms, as two to procreating matter and one to God the Maker.#t_footnote(<nt1216>, "nr1216")[14] Likewise, magicians distribute the three princes of the world, Ahura Mazda, Mithra, and Ahriman#t_footnote(<nt1217>, "nr1217")[15]—namely, God, Mind, and Spirit. Through three cubes or solids are distributed three things producing nine—that is, the supercelestial ordered into nine intelligences, the celestial into nine orbs, the inferiors into nine kinds of generables and corruptibles. Finally, in these three cubes—that is, the twenty-seven—includes all musical proportions, as Plato and Proclus discussed in a long series;#t_footnote(<nt1218>, "nr1218")[16] and three has a harmony of fifths, the grace of five voices.
  ]
  #p_quote[
    #emph[Three appointed to ideal forms.]
  ]
  #p_normal[
    And also, in the intelligences, there are three hierarchies of angelic spirits. There are three powers in intellectual creatures, memory, mind, and will. There are three orders of the blessed—that is, martyrs, confessors, and innocents. There are three quadruplicities in the celestial signs, the fixed, moveable and common;#t_footnote(<nt1219>, "nr1219")[17] and [there are three kinds of] houses, the angular,#t_footnote(<nt1220>, "nr1220")[18] succedent, and cadent.#t_footnote(<nt1221>, "nr1221")[19] Likewise, there are three faces and decans in any of the signs,#t_footnote(<nt1222>, "nr1222")[20] and three lords of each triplicity;#t_footnote(<nt1223>, "nr1223")[21] there are three fortunes among planets;#t_footnote(<nt1224>, "nr1224")[22] there are three Graces among goddesses; there are three Fates among the infernals; there are three judges, three Furies, and the three-headed Cerberus. We also read:
  ]
  #p_img[
    #emph[And the threefold Hecate, three mouths of the chaste Diana.]#t_footnote(<nt1225>, "nr1225")[23]
  ]
  #p_normal[
    There are three persons in the supersubstantial divinity. There are three times: nature, law, and grace. There are three theological virtues: hope, faith, and charity. Jonah was in the stomach of the fish for three days, and Christ was in the tomb for as many days.#t_footnote(<nt1226>, "nr1226")[24]
  ]
  #p_normal[
...
#character[
  ...
  #p_normal[
    Also, the entirety of mathematics is contained in the limits of four—namely, point, line, plane, and depth. All of nature is combined in the limits of four—namely, substance, quality, quantity, and motion. It also fills natural philosophy, in which is the seminal virtue of nature, natural sprouting, maturing of form, and composing. There are also four limits contained in metaphysics—namely, being, essence, virtue, and action. Moral philosophy contains four virtueses#t_footnote(<nt1231>, "nr1231")[5]—namely, prudence, justice, fortitude, and temperance. It also has the power of justice; hence, the fourfold law, which is providence from God, fate from the World Soul, nature from the heavens, and prudence from man. There are also four judicial powers arising from things—namely, intellect, discipline, belief, and perception.#t_footnote(<nt1232>, "nr1232")[6]
  ]
  #p_normal[
    Likewise, it has many powers and great mysteries; for this reason, the Pythagoreans testified to four with an oath, climbing to the summit of faith and strengthening their belief.#t_footnote(<nt1233>, "nr1233")[7] Hence the Pythagoreans expressed this oath in the following verses:
  ]
  #p_poetry[
    #emph[I swear to you by the sacred four with a pure mind,]
  ]
  #p_poetry[
    #emph[Eternal fountain of nature and parent of mind.]#t_footnote(<nt1234>, "nr1234")[8]
  ]
  #p_normal[
    Likewise, there are four rivers in Paradise and four Gospels—which were universally received by as many evangelists and all churches.#t_footnote(<nt1235>, "nr1235")[9]
  ]
  #p_quote[
    #emph[The name of God is expressed in four.]
  ]
  #p_normal[
    The Hebrews’ particular name of God was taken in writing with four letters.#t_footnote(<nt1236>, "nr1236")[10] Likewise, the Egyptians, Arabs, Persians, Magi, Muslims, Greeks, Etruscans, and Latins wrote the name of God in four letters: Theut, Alla, Sire, Orsi, Abgdi, θεός,#t_footnote(<nt1237>, "nr1237")[11] Esar, Deus.#t_footnote(<nt1238>, "nr1238")[12] Hence the Spartans#t_footnote(<nt1239>, "nr1239")[13] customarily depicted the Supreme Jove with four ears; hence, in the theology of Orpheus, Neptune drove his chariot with four horses.
  ]
  #p_normal[
    Likewise, there are four kinds of divine frenzies, each of which proceeds from a single divine presence#t_footnote(<nt1240>, "nr1240")[14]—namely, from the Muses, Dionysus, Apollo, and Venus. Likewise, Ezekiel the prophet saw four animals by the river Chobar and four Cherubim in four wheels. According to Daniel, four great animals ascended from the sea and fought the four winds.#t_footnote(<nt1241>, "nr1241")[15] In Revelation four animals were filled with eyes in front and behind standing around the throne of God. [In that same book] four angels who have the gift of harming the earth and sea stood over the quarters of the earth and held the four winds that they would not blow over the earth and sea, nor upon any tree.#t_footnote(<nt1242>, "nr1242")[16]
  ]
  #p_normal[
    #t_img("./images/00016.jpeg")
#t_footnote(<nt1243>, "nr1243")[17]
  ]
  #p_normal[
...
#character[
  ...
  #p_normal[
    The number five is not unimportant and is powerful. Indeed, it is made up of the first even and first odd number, from the feminine and masculine. Indeed, the odd number is male, but the even is female (from which mathematicians call one the father, and other the mother). Therefore, five is of no small perfection or virtue, because it is generated from the mixture of these numbers.#t_footnote(<nt1244>, "nr1244")[1] Additionally, it is the most lawful middle of the universal number—that is, ten. [This is because] on every side around five you can divide ten: hence if you take nine, one remains; if you take eight, two remains; taking seven then three, or six then four; each one totaled consists of ten. Five is always that perfect medium#t_footnote(<nt1245>, "nr1245")[2] and is equidistant.
  ]
  #p_normal[
    Therefore it is called the number of marriage by the Pythagoreans, and it is said to be justice because it is divided equally from ten.#t_footnote(<nt1246>, "nr1246")[3] There are five senses in man, sight, sound, smell, taste, touch; five powers in the soul, vegetative, sensitive, concupiscible, irascible, rational; there are five fingers in the hand; there are five wandering planets in the heavens,#t_footnote(<nt1247>, "nr1247")[4] according to which there are fivefold terms#t_footnote(<nt1248>, "nr1248")[5] in each of the signs; in the elements there are five kinds of mixtures—that is, stones, metals, plants, zoophytes, and animals—there are as many kinds of animals (for example, men, quadrupeds, reptiles, swimming things,#t_footnote(<nt1249>, "nr1249")[6] and flying things); and there are five kinds, from which God composed everything (namely, being, the same, the other, standing,#t_footnote(<nt1250>, "nr1250")[7] and moving).#t_footnote(<nt1251>, "nr1251")[8] Swallows do not bear unless it is with five chicks, which they feed with great equality, beginning with the eldest and then the rest according to their birth. Likewise, this number has great power in purifications: for in the sacred it drives away evil daemons, and in the natural, it drives away poisons. Likewise, it is said to be the number of happiness and gratitude, is the seal of the Holy Spirit, entwines all bindings, and is the number of the cross; likewise, it signifies Christ’s principal wounds, which were also glorified in his body to protect the worthy.#t_footnote(<nt1252>, "nr1252")[9] Gentile philosophers dedicated it as sacred to Mercury, and of a much more excellent power than four, as much as a living thing surpasses a non-living thing.#t_footnote(<nt1253>, "nr1253")[10]
  ]
  #p_quote[
    #emph[The names of five.]
  ]
  #p_normal[
    Indeed, the patriarch Noah found in this number the grace of the Lord, which preserved him from the flooding waters;#t_footnote(<nt1254>, "nr1254")[11] in the virtue of this number the hundred-year-old Abraham from the ninety-yearold barren woman Sarah begat a son despite being at an age above which nature allows this to happen, from whom arose a great people.#t_footnote(<nt1255>, "nr1255")[12] Hence, five letters invoked the name of God Almighty in the time of grace: for in the time of nature, the name of God was invoked with the Trigrammaton 
...
#t_img("./images/00022.jpeg") Ihesu,#t_footnote(<nt1256>, "nr1256")[13] 
which is no less mysterious than the three lettered invocation 
#t_img("./images/00023.jpeg").#t_footnote(<nt1257>, "nr1257")[14]
  ]
  #p_normal[
...
#character[
  ...
  #p_normal[
    The number seven has various and manifold powers. Indeed, it consists of one and six, or two and five, or three and four, and it has a unity as if it were tying twin threes. From which, if we consider each of its members and their joining, without a doubt we acknowledge that just as its joined parts are as complete as its separate parts, they are also as complete as its whole greatness.#t_footnote(<nt1264>, "nr1264")[1]
  ]
  #p_quote[
    #emph[Names of seven.]
  ]
  #p_normal[
    Pythagoreans call it the vehicle of human life because it does not borrow from its parts, as it perfects from the totality of its own law. Indeed, it contains the body and soul: for the body consists of the four elements and is affected by the four qualities. Three likewise considers the soul according to its threefold power—namely, rationality, irasciblity, and desire.#t_footnote(<nt1265>, "nr1265")[2]
  ]
  #p_normal[
    Therefore, seven (because it contains three and four) connects the soul and body. Likewise, the power of this number pertains to the generation of men: it conceives, forms, feeds, nourishes, enlivens, and altogether makes man exist. For instance, when the womb of a woman receives the reproductive seed, if it remains for seven hours without shedding, it will stay and life is certain. Then, after the first seven days, it coagulates and is made suitable for receiving a human figure. It then produces matured infants, which is called a #emph[septimestres], [which means] born in the seventh month. Then, after birth, a newly born infant is distinguished in the seventh hour; indeed, beyond this number, the child should be able to breathe air and support life. After seven days, it throws away the remains of the umbilical cord. After two times seven, it begins to see moving light. In the third seventh, it freely moves its eyes and entire face. After seven months, it begins teething. After the second seventh month, it sits without fear of falling. After the third seventh, sounds rush forth into words. After the fourth seventh, it stands firmly and walks. After the fifth seventh month, it begins to dread breastfeeding. After seven years, the first teeth fall and others more suitable for solid food emerge, and integral speaking comes. After the second seventh year, boys start puberty and a generation is born. For the third seventh year, he emerges a tall man showing his youthful prime, grows a beard, and becomes strong and is able to generate. All the way to the fourth seventh, man begins to grow wider and stops growing taller. In the fifth, all power and strength has completely increased. However, in the sixth seventh year, they keep their strength. With the seventh seventh, prudence is consummated and arrives at the perfect age of man. After reaching the tenth seventh year, where the number seven brings together completion, he then reaches the common limit for life, as the Prophet said: “The days of our years are seventy years.”#t_footnote(<nt1266>, "nr1266")[3]
  ]
  #p_quote[
    #emph[The power of seven in the human body.]
  ]
  #p_normal[
    Also, the highest measure of the height of the human body is seven feet.#t_footnote(<nt1267>, "nr1267")[4] Likewise, there are seven degrees in the body that complete the measurement of height from the bottom to the top—namely, the marrow, bones, nerves, veins, arteries, flesh, and skin. There are seven which the Greeks called “black members”—namely, the tongue, heart, lungs, liver, and two kidneys. There are seven principal parts of the body, the head, chest, hands, feet, and genitals. Likewise, breath and food depend on it because without drinking and breathing beyond seven hours, life does not endure.#t_footnote(<nt1268>, "nr1268")[5] Furthermore, if [a living being is] placed in continued hunger, they will not live after seven days.
  ]
  #p_normal[
    Likewise, as handed down by physicians, the veins and arteries are moved by the number seven. Judgments in diseases have greater visibility with the seventh days, which are called critical by physicians—that is, judicial.#t_footnote(<nt1269>, "nr1269")[6] Likewise, God created the soul in seven portions, as testified by the divine Plato in #emph[Timaeus].#t_footnote(<nt1270>, "nr1270")[7] Likewise, the soul rules the body with seven. All disagreeing voices proceed to the seventh degree, after which a revolution happens. Again, there are seven melodies of voices, a major third, minor third, perfect fourth, perfect fifth#t_footnote(<nt1271>, "nr1271")[8] with a tone, a fifth with a semitone, and an octave.#t_footnote(<nt1272>, "nr1272")[9]
  ]
  #p_normal[
    Of the celestial powers there are seven most powerful: for, with the four angles of heaven gazing diametrically upon each other, indeed this, which is a most full and powerful aspect, agrees with the number seven.#t_footnote(<nt1273>, "nr1273")[10]
  ]
  #p_quote[
    #emph[Seven in the celestial powers.]
  ]
  #p_normal[
    Accordingly, [the angles of heaven] are made from the seventh sign making a cross,#t_footnote(<nt1274>, "nr1274")[11] the most powerful figure of all, of which we will speak in its place, but you must not ignore the great association seven has with the cross. By a similar radiation and number, the winter solstice happens. A solstice is seven [signs] from winter, in seven from equinox to equinox,#t_footnote(<nt1275>, "nr1275")[12] all of which happen with seven signs each. Additionally, there are seven circles in the heavens according to the longitudinal axis.#t_footnote(<nt1276>, "nr1276")[13] There are seven [stars] around the arctic pole of Ursa Major and Minor, and there are seven sisters, which are called the Pleiades.#t_footnote(<nt1277>, "nr1277")[14] Likewise, there are seven planets, and according to these are seven days constituting a week.
  ]
  #p_quote[
    #emph[The figure of the cross is the most powerful of all.]
  ]
  #p_normal[
    Likewise, the Moon is the seventh of the planets and closest to us, watching this number before the rest, and moving and dispensing the light of that number: for in twenty-eight days it circuits around the entire zodiac, with which number of days seven with seven is its limit—namely, from one all the way to seven, with as many numbers added to their preceding, making, filling, and accomplishing four times seven days,#t_footnote(<nt1278>, "nr1278")[15] in which the Moon circuits and wanders through the entire latitude and longitude of the zodiac by measuring and going over it again. Similarly, it dispenses its light with a perpetual varying law in seven days; indeed, the first seven to the middle are, as it were, an increasing divided orb. The second seven is a complete orb of light. The third decreases again drawing a divided orb. The last, the fourth seventh, its light is diminished to renew again. And by the same seven it disposes the increase and decrease of the sea: for the first seven from the initial increase of the Moon [the sea] decreases a little; for the second it gradually increases; for the third seven it is similar to the first, and for the fourth it is like the second.#t_footnote(<nt1279>, "nr1279")[16] It also applies to Saturn, which is the seventh planet, and arises from the lower. Seven beckons rest, to whom is assigned the seventh day, which indicates the seven thousandth (as John testified), with the dragon captured, suggesting the evil devil, mortals will rest, spending their lives in tranquillity.#t_footnote(<nt1280>, "nr1280")[17]
  ]
  #p_normal[
    Additionally, Pythagoreans called seven the number of virgins, because it is the first number that is not generated or generates, nor is it able to be divided into two equal parts, as to be generated from any repeating number, nor doubled to produce any other number from itself that is within the limits of ten, which is the first limited number. Therefore, they made seven sacred to Pallas.#t_footnote(<nt1281>, "nr1281")[18] In religion, seven has great power in indications of veneration,#t_footnote(<nt1282>, "nr1282")[19] and it is called the number of oaths; hence, among Hebrews swearing is called a #emph[septenare]—as it were, imploring by seven. Thus, when Abraham made a covenant with Abimelech, he set up seven ewe lambs in testimony.#t_footnote(<nt1283>, "nr1283")[20] It is likewise said to be the number of blessedness and rest, of which [it was said]:
  ]
  #p_quote[
    #emph[The names of seven.]
  ]
  #p_img[
    #emph[. . . O three and four times blessed;#t_footnote(<nt1284>, "nr1284")[21]]
  ]
  #p_normal[
    namely, in the soul and in the body. Likewise, God rested from work on the seventh day, which is why this day is called the Sabbath by Moses, which is the day of rest;#t_footnote(<nt1285>, "nr1285")[22] hence, Christ rested in his tomb on the seventh day.#t_footnote(<nt1286>, "nr1286")[23] Likewise, this is the number of the cross, as is demonstrated above, and has a great association with Christ; indeed, in Christ is all of our blessedness, rest, and happiness. Additionally, it is most suitable for purifications; from Apuleius: “I immediately placed myself with eagerness in the purifying bath of the sea, submerging my head in the waves seven times.”#t_footnote(<nt1287>, "nr1287")[24]
  ]
  #p_normal[
    Lepers are likewise to be cleansed according to the Law by sprinkling seven times with the blood of a sparrow.#t_footnote(<nt1288>, "nr1288")[25] The prophet Elisha, as it has in the fourth#t_footnote(<nt1289>, "nr1289")[26] book of Kings, said to the leprous: “Hurry and wash seven times in the Jordan, and your flesh will receive cure, and you will be cleansed.” Again, as he states somewhat later: “he washed himself seven times in the Jordan according to the prophet’s sermon, and he was cleansed.”#t_footnote(<nt1290>, "nr1290")[27]
  ]
  #p_normal[
    It is the number of repentance and forgiveness, hence setting up seven years of penance for some sin according to the opinion of the Wise Man saying: “And sevenfold over the sinner.” Likewise, the seventh year is made for forgiveness and after seven squared satisfies the forgiveness, as we read in Leviticus. Christ consummated his oration of our atonement with seven petitions, and hence it is called the number of freedom because Hebrew slaves claimed liberty for themselves on the seventh year. It is most suited for divine praises; of which the Prophet said: “I say praises to you over your righteous judgments seven times a day.” It is also the number of revenge, as the scriptures say: “From Cain is given a sevenfold revenge”; and in Psalms, it says: “Return sevenfold to our neighbors into their bosoms.” Hence, we read in the Gospels that Solomon took seven abominations and seven more wicked spirits. It also signifies the time of the present circle, which completes the circle of seven days. And it is sacred to the Holy Spirit, which the prophet Isaiah described His gifts are sevenfold—that is, the spirit of wisdom and understanding, the spirit of deliberation and strength, the spirit of knowledge and piety, and the spirit of fear of the Lord, and as we read in Zachariah, the seven eyes of God.#t_footnote(<nt1291>, "nr1291")[28] Likewise, there are seven angels, spirits standing before the face of God, as we read in Tobias;#t_footnote(<nt1292>, "nr1292")[29] and in Revelation there were seven burning torches before the throne of God,#t_footnote(<nt1293>, "nr1293")[30] and seven golden candlesticks, and in the middle of them was one like the Son of Man, and He held the seven stars in his right hand. Likewise, there were seven spirits watching the throne of God,#t_footnote(<nt1294>, "nr1294")[31] and seven angels standing in watch of God and were given seven trumpets.#t_footnote(<nt1295>, "nr1295")[32] Likewise, he saw a lamb with seven horns and seven eyes and saw books sealed with seven seals,#t_footnote(<nt1196>, "nr1296")[33] and when the seventh seal was opened, the heavens were made silent.#t_footnote(<nt1297>, "nr1297")[34]
  ]
  #p_normal[
    From all that was said above, it is evident that seven among other numbers is deservedly said to be most full of efficacy. Seven also has a great conformity with twelve: for as three and four make up seven, thus three times four become twelve, which are the numbers of the celestial planets and signs resulting from the same root and three of divinity,#t_footnote(<nt1298>, "nr1298")[35] and sharing by the four of inferior nature.#t_footnote(<nt1299>, "nr1299")[36] This number has a very great reverence in sacred literature before all other numbers and has great and manifold mysteries, which is why we have decided that many sacred speeches must be repeated upon the subject. By the examples provided, the reader will easily agree that seven is distinguished by a certain fullness of sacred mysteries.
  ]
  #p_normal[
    Indeed, we read in Genesis that on the seventh day God rested,#t_footnote(<nt1300>, "nr1300")[37] the seventh from Adam was Enoch, a sacred and pious man,#t_footnote(<nt1301>, "nr1301")[38] and there was also another seventh from Adam a wicked and twice-married man named Lamech.#t_footnote(<nt1302>, "nr1302")[39] Likewise, seven generations destroyed the sin of Cain, as it is written: “The sevenfold punishment of Cain” and “Whoever kills Cain will pay with seven vengeances”;#t_footnote(<nt1303>, "nr1303")[40] to which that master of history reported that there were seven sins of Cain.#t_footnote(<nt1304>, "nr1304")[41] Likewise, seven and seven of all clean animals and flying animals were introduced into Noah’s ark;#t_footnote(<nt1305>, "nr1305")[42] then after seven days the Lord rained over the earth, and all of the fountains of the abyss broke through on the seventh day and flooded over the earth with water.#t_footnote(<nt1306>, "nr1306")[43] Likewise, Abraham gave Abimelech seven ewe-lambs#t_footnote(<nt1307>, "nr1307")[44] and Jacob served seven years for Leah and another seven for Rachel,#t_footnote(<nt1308>, "nr1308")[45] and the people of Israel mourned the death of Jacob for seven days.#t_footnote(<nt1309>, "nr1309")[46] Additionally, we read in the same place of seven cattle, seven ears of grain, seven years of fertility, and seven of barrenness.#t_footnote(<nt1310>, "nr1310")[47]
  ]
  #p_quote[
    #emph[Seven is the most effective of all.]
  ]
  #p_normal[
    However, in Exodus, the seventh day is the Sabbath of Sabbaths, sanctioned by the Lord for rest because the Lord rested from work on the seventh day. Likewise, on the seventh day, Moses ceased to pray. On the seventh day there is a solemnity for the Lord,#t_footnote(<nt1311>, "nr1311")[48] on the seventh year a slave will be freed,#t_footnote(<nt1312>, "nr1312")[49] for seven days cattle and sheep stay with their mother,#t_footnote(<nt1313>, "nr1313")[50] on the seventh year land that has been sowed for six years will rest, the seventh day will be the sacred Sabbath and rest;#t_footnote(<nt1314>, "nr1314")[51] the seventh day, because it is the Sabbath, is called sacred.#t_footnote(<nt1315>, "nr1315")[52]
  ]
  #p_normal[
    Also in Leviticus, the seventh day is more solemn and more holy,#t_footnote(<nt1316>, "nr1316")[53] and the first day of the seventh month there will be a memorial Sabbath;#t_footnote(<nt1317>, "nr1317")[54] burnt offerings for the Lord are offered for seven days,#t_footnote(<nt1318>, "nr1318")[55] for seven days celebrate festivals for the Lord, seven days in a year are a law in your generations. On the seventh month celebrate a feast and live in the tabernacle for seven days.#t_footnote(<nt1319>, "nr1319")[56] One whose finger was dipped in blood shall sprinkle with it seven times before the Lord.#t_footnote(<nt1320>, "nr1320")[57] To be cleansed from leprosy one shall sprinkle themselves seven times with the blood of a sparrow.#t_footnote(<nt1321>, "nr1321")[58] For seven days wash in living water that has taken flowing blood;#t_footnote(<nt1322>, "nr1322")[59] one shall sprinkle with his finger seven times with the blood of a calf;#t_footnote(<nt1323>, "nr1323")[60] I will smite you seven times for your sins.#t_footnote(<nt1324>, "nr1324")[61]
  ]
  #p_normal[
    In Deuteronomy, seven peoples had the land of promise;#t_footnote(<nt1325>, "nr1325")[62] and we read of the seventh year of remission,#t_footnote(<nt1326>, "nr1326")[63] and seven lights with the candlestick placed in the south part.#t_footnote(<nt1327>, "nr1327")[64]
  ]
  #p_normal[
    And in Numbers, we read of seven immaculate ewe-lambs offered by the sons of Israel, and for seven days they fed on unleavened bread, and these seven lambs and goats expiated their sins, and the seventh day was solemn and sacred, and the first day of the seventh month was venerated and sacred, and the seventh month of the Feast of Tabernacles, and seven calves were offered on the seventh day,#t_footnote(<nt1328>, "nr1328")[65] and Balaam raised seven altars,#t_footnote(<nt1329>, "nr1329")[66] seven days Maria,#t_footnote(<nt1330>, "nr1330")[67] sister of Aaron, left the fortress leprous,#t_footnote(<nt1331>, "nr1331")[68] and for seven days one who touched a corpse was unclean.#t_footnote(<nt1332>, "nr1332")[69]
  ]
  #p_normal[
    And in Joshua, seven priests carried the Ark of the Covenant before Jericho, and for seven days encircled the city, and seven and seven trumpets were carried by seven priests, and the on seventh day the seven priests blew the trumpets.#t_footnote(<nt1333>, "nr1333")[70]
  ]
  #p_normal[
    Likewise, in the book of Judges, for seven years Abessa reigned in Israel,#t_footnote(<nt1334>, "nr1334")[71] for seven days Samson kept his nuptials, and on the seventh day he explained the riddle to his wife,#t_footnote(<nt1335>, "nr1335")[72] and he was bound with seven cords of sinew and the seven locks of his hair,#t_footnote(<nt1336>, "nr1336")[73] for seven years the children of Israel were oppressed by the king of Midian.#t_footnote(<nt1337>, "nr1337")[74]
  ]
  #p_normal[
    In the books of Kings, [Elias returned] seven times, and on the seventh time he said: “Behold a little cloud”;#t_footnote(<nt1338>, "nr1338")[75] for seven days the sons of Israel ordered their armies, and on the seventh day joined in battle,#t_footnote(<nt1339>, "nr1339")[76] for seven years famine was threatened to David because of the sins of the murmuring people,#t_footnote(<nt1340>, "nr1340")[77] and seven times the child yawned and was roused again by Elisha,#t_footnote(<nt1341>, "nr1341")[78] and seven men were crucified at the same time in the first days of harvest,#t_footnote(<nt1342>, "nr1342")[79] Naaman was cleansed by Elisha by washing seven times,#t_footnote(<nt1343>, "nr1343")[80] and in the seventh month Goliath was slain.#t_footnote(<nt1344>, "nr1344")[81]
  ]
  #p_normal[
    And in Paralipomenon,#t_footnote(<nt1345>, "nr1345")[82] we read that in the seventh month all were gathered to complete the foundation.#t_footnote(<nt1346>, "nr1346")[83] And in Esther, we read of the seven eunuchs of the Persian king.#t_footnote(<nt1347>, "nr1347")[84] And in the book of Tobias, seven men coupled with Sara, the daughter of Raguel.#t_footnote(<nt1348>, "nr1348")[85]
  ]
  #p_normal[
    And in Daniel, Nebuchadnezzar’s furnace was heated seven times more,#t_footnote(<nt1349>, "nr1349")[86] and seven lions were in the cave,#t_footnote(<nt1350>, "nr1350")[87] and Nebuchadnezzar came on the seventh day.
  ]
  #p_normal[
    In the book of Job is mentioned his seven sons,#t_footnote(<nt1351>, "nr1351")[88] and for seven days and nights Job’s friends sat with him on the earth,#t_footnote(<nt1352>, "nr1352")[89] and in the same place we read: “On the seventh, no evil will touch you.”#t_footnote(<nt1353>, "nr1353")[90]
  ]
  #p_normal[
    In Ezra, we read of seven weeks of years,#t_footnote(<nt1354>, "nr1354")[91] the seven councilors of Artaxerxes,#t_footnote(<nt1355>, "nr1355")[92] and in that place: “in the seventh month you will sound the trumpet,”#t_footnote(<nt1356>, "nr1356")[93] and under Ezra in the seventh month was the Feast of the Tabernacles, while the sons of Israel were in the cities,#t_footnote(<nt1357>, "nr1357")[94] and the first day of the seventh month Ezra read the law to the people.#t_footnote(<nt1358>, "nr1358")[95]
  ]
  #p_normal[
    And in Psalms, David says praises seven times a day,#t_footnote(<nt1359>, "nr1359")[96] silver is tested seven times,#t_footnote(<nt1360>, "nr1360")[97] and we return sevenfold to our neighbors into their bosoms.#t_footnote(<nt1361>, "nr1361")[98]
  ]
  #p_normal[
    And Solomon said that wisdom carved herself seven columns,#t_footnote(<nt1362>, "nr1362")[99] and seven men [who] speak opinions,#t_footnote(<nt1363>, "nr1363")[100] [there are] seven [behaviors] that the Lord hates and detests,#t_footnote(<nt1364>, "nr1364")[101] seven evils in the heart of an enemy,#t_footnote(<nt1365>, "nr1365")[102] seven watchmen,#t_footnote(<nt1366>, "nr1366")[103] and seven foolish eyes.#t_footnote(<nt1367>, "nr1367")[104]
  ]
  #p_normal[
    Isaiah counted seven gifts of the Holy Spirit,#t_footnote(<nt1368>, "nr1368")[105] and seven women shall apprehend one man.#t_footnote(<nt1369>, "nr1369")[106]
  ]
  #p_normal[
    And in Jeremiah, that with seven the mind of a woman longs, and with the bearing of seven sons, the mother weakens, and her soul fails.#t_footnote(<nt1370>, "nr1370")[107]
  ]
  #p_normal[
    In Ezekiel, the prophet grieved for seven days.#t_footnote(<nt1371>, "nr1371")[108]
  ]
  #p_normal[
    In Zechariah, seven lamps and seven funnels were over the tops of the candlesticks, and seven eyes running over the whole earth,#t_footnote(<nt1372>, "nr1372")[109] and seven eyes over one stone,#t_footnote(<nt1373>, "nr1373")[110] and the seventh day is turned to joy.#t_footnote(<nt1374>, "nr1374")[111]
  ]
  #p_normal[
    And in Micah, seven shepherds are raised over the Assyrians.#t_footnote(<nt1375>, "nr1375")[112]
  ]
  #p_normal[
    Now in the Gospels, we read of seven conditions of blessedness,#t_footnote(<nt1376>, "nr1376")[113]
  ]
  #p_normal[
    seven virtues to which are opposed seven vices, #t_footnote(<nt1377>, "nr1377")[114] seven petitions of the Lord’s prayer,#t_footnote(<nt1378>, "nr1378")[115] seven words of Christ on the cross, 
#t_footnote(<nt1379>, "nr1379")[116] seven words of the Virgin Mary,#t_footnote(<nt1380>, "nr1380")[117] seven breads distributed by the Lord,#t_footnote(<nt1381>, "nr1381")[118] seven baskets of fragments,#t_footnote(<nt1382>, "nr1382")[119] seven brothers having one wife,#t_footnote(<nt1383>, "nr1383")[120] seven disciples of the Lord who were fishers,#t_footnote(<nt1384>, "nr1384")[121] seven water pots in Canaan in Galilee,#t_footnote(<nt1385>, "nr1385")[122] seven wraths that the Lord threatens to hypocrites,#t_footnote(<nt1386>, "nr1386")[123] seven daemons expelled from the sinful woman,#t_footnote(<nt1387>, "nr1387")[124] and seven more wicked daemons taken in after expulsion.#t_footnote(<nt1388>, "nr1388")[125] Likewise, for seven years, Christ was in refuge in Egypt,#t_footnote(<nt1389>, "nr1389")[126] and in the seventh-hour fever left the son of the ruler.#t_footnote(<nt1390>, "nr1390")[127]
  ]
  #p_normal[
    Also in the canonical Epistles, James described seven degrees of the wise,#t_footnote(<nt1391>, "nr1391")[128] and Peter seven degrees of virtue.#t_footnote(<nt1392>, "nr1392")[129] And in Acts, there are counted seven deacons and seven disciples chosen by the Apostles.#t_footnote(<nt1393>, "nr1393")[130] Likewise in Revelation there are many mysteries in this number; indeed, seven candlesticks are gathered, seven stars,#t_footnote(<nt1394>, "nr1394")[131] seven crowns,#t_footnote(<nt1395>, "nr1395")[132] seven churches, seven spirits watching the throne,#t_footnote(<nt1396>, "nr1396")[133] seven rivers of Egypt, seven seals, seven signs, seven horns, seven eyes, seven spirits of God,#t_footnote(<nt1397>, "nr1397")[134] seven angels with seven trumpets,#t_footnote(<nt1398>, "nr1398")[135] seven horns of the dragon, and seven heads of the dragon, which had seven diadems.#t_footnote(<nt1399>, "nr1399")[136] Likewise, seven plagues and seven phials were given to one of the seven angels,#t_footnote(<nt1400>, "nr1400")[137] seven heads of the scarlet beast, seven mountains and seven kings sitting on them,#t_footnote(<nt1401>, "nr1401")[138] and seven thunders speaking their voices.#t_footnote(<nt1402>, "nr1402")[139]
  ]
  #p_normal[
    Additionally,#t_footnote(<nt1403>, "nr1403")[140] there are many powers with this number in the natural, the sacred and ceremonial, as well as in others. Therefore here they refer to seven days, seven planets, seven Pleiades, seven ages of the world, seven changes in man, seven liberal arts, and as many mechanical, and as many forbidden, seven colors, seven metals, seven holes in the heads of men, seven pairs of nerves, seven hills in the city of Rome, seven kings of Rome, seven civil wars, seven wise men in the time of the prophet Jeremiah, and seven wise men of Greece.
  ]
  #p_normal[
    Likewise, Rome burned for seven days under Nero. Seven kings slew ten thousand martyrs. There were seven sleepers. There are seven principal churches in Rome, Gregory built as many monasteries, and Saint Felicity bore as many sons. There were seven electors placed in the Empire, and seven solemn acts in crowning the emperor. Laws in the testament required seven witnesses, there are seven civil penalties, seven canons, and seven canonical hours. There are seven sacred greetings in Mass, seven sacraments, and seven orders of clerics. At seven years, a boy is able to be ordained with a lesser order and can obtain the blessing to be without care.#t_footnote(<nt1404>, "nr1404")[141] There are seven penitential Psalms, and seven mandates on the second tablet, seven hours Adam and Eve were in paradise, and there were seven men foretold by the angel before they were born—namely, Ishmael, Isaac, Samson, Jeremiah, John the Baptist, James the brother of the Lord, and Jesus Christ.#t_footnote(<nt1405>, "nr1405")[142] Finally, this number is the most powerful of all in good and evil; of this, the ancient poet Linus#t_footnote(<nt1406>, "nr1406")[143] sang:
  ]
  #p_poetry[
  ...
  #p_poetry[
    #emph[Revolved and with as many orbs they circled around.]#t_footnote(<nt1407>, "nr1407")[144]
  ]
  #p_normal[
    #t_img("./images/00026.jpeg")
#t_footnote(<nt1408>, "nr1408")[145]
  ]
]
...
#character[
  ...
  #p_normal[
    Pythagoreans called eight the number of justice and fullness. It [was called] the first (justice), because it is the first of all numbers to be divided into equal parts—that is, in four. It is likewise connected for the same reason by being divided by two twos: twice two times two, and because of this division it assumed the name justice for itself. However, the other name of “fullness” is taken because of a connection with corporeal solidity, because it is the first to make a solid body.#t_footnote(<nt1409>, "nr1409")[1]
  ]
  #p_quote[
    #emph[The names of eight.]
  ]
  #p_normal[
    Hence, in the Orphic tradition, they swore by the eight deities if one wished for divine justice, whose names were Fire, Water, Earth, Heaven, Moon, Sun, Phanes, and Night.#t_footnote(<nt1410>, "nr1410")[2] Likewise, there are only eight visible spheres in the heavens,#t_footnote(<nt1411>, "nr1411")[3] and it signifies to us the quality of corporeal nature, as Orpheus embraced in the eight maritime hymns.#t_footnote(<nt1412>, "nr1412")[4] And it is also said to be the number of covenant and circumcision, which according to Jewish teaching, happens on the eighth day.#t_footnote(<nt1413>, "nr1413")[5] Also in the Old Law, there are eight ornaments of the priest—namely, breeches, a tunic, a girdle, a headdress, a cloak to the ankles, ephod, sash, and a golden plate.#t_footnote(<nt1414>, "nr1414")[6]
  ]
  #p_quote[
    #emph[Orpheus swore by eight deities.]
  ]
  #p_normal[
    Also, this number relates to eternity and the end of the world because it follows seven, which symbolizes time. Hence it is also the number of blessedness; indeed, Christ teaches as many degrees of blessedness in Matthew.#t_footnote(<nt1415>, "nr1415")[7] It is also said to be the number of health and preservation: there were as many souls in Noah’s ark saved from the flooding waters.#t_footnote(<nt1416>, "nr1416")[8] Likewise, there were eight sons of Jesse, of which David was the eighth;#t_footnote(<nt1417>, "nr1417")[9] and Zechariah, the father of John, received speech on the eighth day.#t_footnote(<nt1418>, "nr1418")[10] They regard this number as sacred to Dionysus, because he was brought into the light on the eighth month, in which perpetual testimony to him the island of Naxos was dedicated to him, they held this prerogative, as only women of Naxos are able to bear and produce healthy babies in the eighth month, while in all other nations, these kinds of births thus perish and mothers may live in clear danger.#t_footnote(<nt1419>, "nr1419")[11]
  ]
  #p_normal[
...
#character[
  ...
  #p_normal[
    Likewise, there are nine orders of blessed angels—namely, Seraphim, Cherubim, Thrones, Dominations, Virtues, Powers, Principalities, Archangels, and Angels#t_footnote(<nt1420>, "nr1420")[1]—and which He forms Ezekiel through nine stones, which are sapphire, emerald, carbuncle, beryl, onyx, chrysolite, jasper, topaz, and carnelian.#t_footnote(<nt1421>, "nr1421")[2]
  ]
  #p_normal[
    Also, this number has a great and occult sacrament with the cross: for in the ninth hour our Lord Jesus Christ’s spirit departed.#t_footnote(<nt1422>, "nr1422")[3] In nine days the ancients buried their dead, and in as many years they say Minos received the laws from Jove in a cave: from where Homer especially observed this number, such as when the laws were being built, answers given, or a raging disaster.#t_footnote(<nt1423>, "nr1423")[4]
  ]
  #p_normal[
    Likewise, astrologers have enneatic years—that is, consisting of nine#t_footnote(<nt1424>, "nr1424")[5]—in the ages of men not otherwise than with seven, which are called critical, watchful, and notable of conspicuous changes. Yet sometimes it denotes imperfections and incompleteness, because it does not reach the perfection of ten, but fails before it by being less one, as interpreted by Augustine on the gospel about the ten lepers.#t_footnote(<nt1425>, "nr1425")[6] Nor is there a lack of mystery of the length of nine cubits of Og king of Basan, who is a type of devil.#t_footnote(<nt1426>, "nr1426")[7]
  ]
  #p_normal[
...
#character[
  ...
  #p_normal[
    Ten is called the all or universal number, and the complete number, indicating a full course of life. Indeed, no number is counted beyond it unless it is through replication,#t_footnote(<nt1427>, "nr1427")[1] and it interweaves all numbers, either within themselves, or through themselves, and brings about their multiplication; wherefore it is applied to compounding religion and a power of purging the soul.
  ]
  #p_quote[
    #emph[Ceremonies once called denariae].
  ]
  #p_normal[
    Hence the ancients called ceremonies #emph[denariae,]#t_footnote(<nt1428>, "nr1428")[2] which when taking expiations or sacrifices, they abstained from some certain things for ten continuous days; and it was the custom of the Egyptians, when they wished to begin sacrifices to Isis,#t_footnote(<nt1429>, "nr1429")[3] to appoint ten days for fasting, which Apuleius testified for himself, saying: “Then clearly, with many witnesses, he ordered that for ten continuous days that I would abstain from the pleasures of food, and that I should eat no animal or drink wine.”#t_footnote(<nt1430>, "nr1430")[4]
  ]
  #p_normal[
    There are ten sanguine parts of man: menses, sperm, formative spirit, the mass,#t_footnote(<nt1431>, "nr1431")[5] humors, organs of the body, invigorative, sensitive, reason, and mind. Likewise, there are ten simple integral parts placed in man: bone, cartilage, nerve, sinew, ligament, arteries, veins, membrane, flesh, and skin. What is more, there are ten inner parts on which men depend: spirit, brain, lungs, heart, liver, gall, spleen, kidneys, genitalia, and womb.#t_footnote(<nt1432>, "nr1432")[6]
  ]
  #p_normal[
    Additionally there were ten curtains in the temple, ten strings in a psaltery,#t_footnote(<nt1433>, "nr1433")[7] ten musical instruments with which the psalms were sung, whose names are #emph[neza,] in which odes were sung; #emph[nablum,] the same as organs; #emph[mizmor,] in which are the psalms; #emph[sir,]#t_footnote(<nt1434>, "nr1434")[8] in which are songs; #emph[tephila,] in which are orations; #emph[beracha,] in which are blessings; #emph[halel,] in which are praises; #emph[hodaia,] in which are acts of gratitude; #emph[asre,] in which is any happiness, and #emph[hallelujah,] in which are only praises and contemplations of God. Likewise, there are ten singers of psalms—namely, Adam, Abraham, Melchizedek, Moses, Asaph, David, Solomon, and the three sons of Korah. Likewise, there are ten commandments of law. On the tenth day after Christ ascended, the Holy Spirit descended.#t_footnote(<nt1435>, "nr1435")[9] Finally, this is the number in which Jacob conquered the angel fighting with them all night in contest and at the rising of the morning star#t_footnote(<nt1436>, "nr1436")[10] was blessed and called by the name Israel.#t_footnote(<nt1437>, "nr1437")[11] In this number, Joshua conquered thirty-one kings,#t_footnote(<nt1438>, "nr1438")[12] David conquered Goliath and the Philistines,#t_footnote(<nt1439>, "nr1439")[13] and Daniel evaded the dangers of the lions.#t_footnote(<nt1440>, "nr1440")[14]
  ]
  #p_normal[
    This number, as with one, is also circular, because adding it together returns to one from where it has its beginning, is the limit of all numbers, and completes and begins tens. As ten flows back to one from where it comes, thus everything that is flowing returns back to the beginning of its emanation. Thus, water runs to the sea from which it originally drew, bodies are taken from the earth and return, time returns to eternity from which it flows, and mind is made by God and returns to Him. Finally, all creatures flow into nothing, from which they are created—unless it is from the divine word, in which all is hidden. Everything with ten or through ten makes a circle, as Proclus said, beginning from God and ending with him. Likewise, God is the first unity, before he communicated himself to the inferiors, first diffusing himself into the first numbers—namely, three—afterward into ten, as it were, into ten ideas and making measures of all numbers and all things, which the Hebrews called ten attributes and count ten divine names—from which cause there is no further number. Hence all tens have a certain divinity in them and, in the Law, they are taken as God’s own together with first-fruits. [They are] as primordial things, the beginning of numbers, and each ten is a limit as it were, returning to the beginning and end of everything.#t_footnote(<nt1441>, "nr1441")[15]
  ]
  #p_normal[
...
#character[
  ...
  #p_normal[
    The number eleven, since it crosses over ten, which is law and commandments, thus falls short of twelve, which is grace and perfection; therefore, it is said to be the number of sin and repentance. Hence it was ordered in the tabernacle that eleven cloaks of hair were to be made, which is the habit of repentance and mourning for sins.#t_footnote(<nt1442>, "nr1442")[1]
  ]
  #p_normal[
    For this reason, this number has no association with the divine or the celestials, nor attracts them, or is a scale for reaching above, nor has any merit; but it sometimes receives a free grace from God, as with those who are called in the eleventh hour in the vineyard of the Lord, receive the reward of those who carried the burden and heat of the day.#t_footnote(<nt1443>, "nr1443")[2]
  ]
  #p_quote[
    #emph[Eleven has no association with the divine.]
  ]
  #p_normal[
    But the number twelve is divine and is how the celestials are measured#t_footnote(<nt1444>, "nr1444")[3]; indeed, it helps the celestial signs and spirits ruling over them. For there are twelve signs in the zodiac, of which there are twelve particular angels, supported by the irrigation of the great name of God. Jupiter completes its course in twelve years, and the Moon runs daily through twelve degrees. There are twelve particular joints in the human body—namely, the hands, elbows, shoulders, thighs, knees, and joints of the feet.
  ]
  #p_normal[
    Additionally, there are great divine mysteries in the power of twelve: God selected twelve families of Israel, and twelve princes were placed in charge of them.#t_footnote(<nt1445>, "nr1445")[4] Twelve stones were placed in the area of Jordan,#t_footnote(<nt1446>, "nr1446")[5] and that number was ordered to be fastened to the breastplate of priests.#t_footnote(<nt1447>, "nr1447")[6] There were also twelve loaves of bread made,#t_footnote(<nt1448>, "nr1448")[7] and as many stones were constructed in the altar,#t_footnote(<nt1449>, "nr1449")[8] and that number of brazen lions supported the sea.#t_footnote(<nt1450>, "nr1450")[9] There were as many fountains in Elim,#t_footnote(<nt1451>, "nr1451")[10] as many spies sent out to the land of promise,#t_footnote(<nt1452>, "nr1452")[11] and as many apostles of Christ#t_footnote(<nt1453>, "nr1453")[12] perfecting the twelve tribes. Twelve thousand people were marked and chosen,#t_footnote(<nt1454>, "nr1454")[13] and the queen of heaven is crowned with twelve stars.#t_footnote(<nt1455>, "nr1455")[14]
  ]
  #p_quote[
    #emph[Twelve is a divine number.]
  ]
  #p_normal[
    In the Gospels, twelve loaves of bread were collected from fragments,#t_footnote(<nt1456>, "nr1456")[15] twelve angels preside over the twelve gates of the city,#t_footnote(<nt1457>, "nr1457")[16] and twelve stones of celestial Jerusalem.#t_footnote(<nt1458>, "nr1458")[17] Also, in the inferior world, many things that increase proceed from this number; thus, hares and rabbits, as most fruitful, generate and bear twelve times a year, camels bear young in as many months,#t_footnote(<nt1459>, "nr1459")[18] and peacocks#t_footnote(<nt1460>, "nr1460")[19] lay twelve eggs.#t_footnote(<nt1461>, "nr1461")[20]
  ]
  #p_normal[
    #t_img("./images/00032.jpeg")
#t_footnote(<nt1462>, "nr1462")[21]
  ]
  #p_normal[
...
#character[
  ...
  #p_normal[
    Thus, thirteen indicates the mystery of Christ’s appearance to the gentiles: as thirteen days after his birth, a star led the Magi.#t_footnote(<nt1464>, "nr1464")[2]
  ]
  #p_quote[
    #emph[XIV.]
  ]
  #p_normal[
    Fourteen bears the figure of Christ himself, because, on the fourteenth day#t_footnote(<nt1465>, "nr1465")[3] on the first month, he sacrificed himself for us, on which day the children of Israel were ordered by the Lord to celebrate 
#emph[Phase]#t_footnote(<nt1466>, "nr1466")[4]—that is, Passover.#t_footnote(<nt1467>, "nr1467")[5] This number was so anxiously observed by Matthew that he omitted some generations so that he could everywhere limit the generations [before] Christ [to fourteen].#t_footnote(<nt1468>, "nr1468")[6]
  ]
  #p_quote[
    #emph[XV.]
  ]
  #p_normal[
    Fifteen is the number that symbolizes spiritual ascension, and therefore there are songs of degrees fitted into fifteen Psalms,#t_footnote(<nt1469>, "nr1469")[7] and there were also fifteen years added to [the life of] King Hezekiah,#t_footnote(<nt1470>, "nr1470")[8] and the fifteenth day of the seventh month is venerable and sacred.#t_footnote(<nt1471>, "nr1471")[9]
  ]
  #p_quote[
    #emph[XVI.]
  ]
  #p_normal[
    The number sixteen is composed of equal quadruples and is obedient to ten.#t_footnote(<nt1472>, "nr1472")[10] Therefore, Pythagoreans called it the number of happiness; it includes all of the prophets of the Old Testament and also the apostles and evangelists of the New Testament.#t_footnote(<nt1473>, "nr1473")[11]
  ]
  #p_quote[
    #emph[XVIII, XX.]
  ]
  #p_normal[
    The numbers eighteen and twenty are each interpreted as inauspicious by theologians: for in the former, Israel served Eglon, king of Moab#t_footnote(<nt1474>, "nr1474")[12]; in the latter, Jacob served,#t_footnote(<nt1475>, "nr1475")[13] and Joseph was sold.#t_footnote(<nt1476>, "nr1476")[14] Finally, among polypods, none exceed the number of twenty feet.
  ]
  #p_quote[
    #emph[XXII.]
  ]
  #p_normal[
    But the number twenty-two signifies a fullness of wisdom, as there are twenty-two characters of Hebrew letters, and the Old Testament contains as many books.#t_footnote(<nt1477>, "nr1477")[15]
  ]
  #p_quote[
    #emph[XXVIII.]
  ]
  ...
  #p_normal[
    The number thirty is remarkable for many mysteries, which our Lord Jesus Christ valued, whereby in the thirtieth year of his age he was baptized, began making miracles, and taught the kingdom of God. The thirtieth year was also active for John the Baptist since he began to preach in the desert and prepared the ways of the Lord. Likewise, at the same age, Ezekiel began to prophesy, and at thirty years of age Joseph was released from prison and received command of Egypt from the pharaoh.#t_footnote(<nt1478>, "nr1478")[16]
  ]
  #p_quote[
    #emph[XXXII.]
  ]
  #p_normal[
    Hebrew teachers appoint the number thirty-two to wisdom; indeed, as Abraham describes as many paths to wisdom. However, Pythagoreans call this the number of justice because it is always divisible in equal parts all the way to one.#t_footnote(<nt1479>, "nr1479")[17]
  ]
  #p_quote[
    #emph[XL.]
  ]
  #p_normal[
    The ancients cherished the number forty with great observation, from which they celebrated the feast of #emph[tesseracoston]. It is said to be effective for planning births: in as many days the seed is prepared and changed in the womb until the body’s organs are duly perfected and united in a harmonious measurement disposed for accepting a rational soul. For as many days after birth women contend with grave illness, until which time the woman adjusts from the agitation of the birth, after which she is purified. Infants do not smile for as many days, are unhealthy, and live in great danger.#t_footnote(<nt1480>, "nr1480")[18]
  ]
  #p_normal[
    This is the number of atonement and repentance in religion, and it signifies great mysteries. Accordingly, in the time of the deluge the Lord rained forty days and nights over the earth,#t_footnote(<nt1481>, "nr1481")[19] the children of Israel lived in the desert for forty years,#t_footnote(<nt1482>, "nr1482")[20] and the destruction of Nineveh was delayed for forty days.#t_footnote(<nt1483>, "nr1483")[21] The same number is also holy for the fasts of saints, accordingly Moses,#t_footnote(<nt1484>, "nr1484")[22] Elias,#t_footnote(<nt1485>, "nr1485")[23] and Christ#t_footnote(<nt1486>, "nr1486")[24] fasted for forty days. Christ was carried in the womb of the Virgin for forty weeks, and Christ remained in Bethlehem for forty days after birth before being presented to the temple.#t_footnote(<nt1487>, "nr1487")[25] He publicly preached for forty months,#t_footnote(<nt1488>, "nr1488")[26] He rested dead in the sepulcher for forty hours,#t_footnote(<nt1489>, "nr1489")[27] and forty days after resurrection He ascended to heaven:#t_footnote(<nt1490>, "nr1490")[28] which according to theologians everything with this number did not happen without hidden and mysterious properties.#t_footnote(<nt1491>, "nr1491")[29]
  ]
  #p_quote[
    #emph[L.]
  ]
  #p_normal[
    Fifty is the number signifying the remission of sins, and also servitude and freedom. Indeed, according to the law on the fiftieth year debts were remitted, and everyone’s own possessions were returned: hence by the jubilee year and by the psalm of repentance shows a sacrament of indulgence and repentance.#t_footnote(<nt1492>, "nr1492")[30] Likewise, the Law and Holy Spirit are declared the same: for on the fiftieth day after the Israelites’ exit from Egypt, the Law was given to Moses on Mount Sinai.#t_footnote(<nt1493>, "nr1493")[31] On the fiftieth day after resurrection, the Holy Spirit descended over the apostles on Mount Zion, which is why it is said to be the number of grace and is attributed to the Holy Spirit.#t_footnote(<nt1494>, "nr1494")[32]
  ]
  #p_quote[
    #emph[LX.]
  ]
  ...
  #p_normal[
    And the number seventy has its own mysteries: for as many years the sacrificial fire was hidden underwater during the Babylonian captivity.#t_footnote(<nt1495>, "nr1495")[33] In as many years Jeremiah predicted the destruction of the temple, for as many years endured the Babylonian captivity,#t_footnote(<nt1496>, "nr1496")[34] and as many years completed the desolation of Jerusalem.#t_footnote(<nt1497>, "nr1497")[35] Likewise there were seventy palms in the place where the children of Israel encamped,#t_footnote(<nt1498>, "nr1498")[36] the Fathers descended into Egypt with seventy souls,#t_footnote(<nt1499>, "nr1499")[37] seventy kings with amputated fingers and toes gathered up the remains of food from under the table of Adoni-Bezek,#t_footnote(<nt1500>, "nr1500")[38] seventy sons came from Jacob’s thigh,#t_footnote(<nt1501>, "nr1501")[39] seventy men all sons of Jerobaal, seventy weights of silver were given to Abimelech, Abimelech killed as many men on one stone,#t_footnote(<nt1502>, "nr1502")[40] Abdon had seventy sons and grandsons, who mounted upon seventy ass colts,#t_footnote(<nt1503>, "nr1503")[41] Solomon had seventy thousand men who carried burdens,#t_footnote(<nt1504>, "nr1504")[42] seventy sons of King Ahab were decapitated in Samaria,#t_footnote(<nt1505>, "nr1505")[43] according to the psalmist seventy years is our age,#t_footnote(<nt1506>, "nr1506")[44] Lamech shall be judged seventy times seven,#t_footnote(<nt1507>, "nr1507")[45] and seventy times seven pardons for offenses of sins.#t_footnote(<nt1508>, "nr1508")[46]
  ]
  #p_quote[
    #emph[LXXII.]
  ]
  #p_normal[
    And the number seventy-two is as many languages of speech, as many elders in the Synagogue, as many interpreters of the Old Testament,#t_footnote(<nt1509>, "nr1509")[47] and as many disciples of Christ. It also has a great association with twelve; hence, in the heavens, each sign is divided into six parts, resulting in seventy-two fives, of which as many angels preside,#t_footnote(<nt1510>, "nr1510")[48] and as many names of God flow and each five presides over one particular property.#t_footnote(<nt1511>, "nr1511")[49] They are of such great efficacy that astrologers and physiognomists can recognize each property from where it originates. Likewise, responding to these are as many well-known joints in the human body, in which each digit of the hands and feet have three, which with the twelve principles mentioned above in the number twelve constitute seventy-two.#t_footnote(<nt1512>, "nr1512")[50]
  ]
  #p_quote[
    #emph[C.]
  ]
  #p_normal[
    A hundred is applied to the sheep that are found, and which also pass from the left hand to the right, is found as holy. Also, because it begets itself from ten, it designates complete perfection.#t_footnote(<nt1513>, "nr1513")[51]
  ]
  #p_quote[
    #emph[M.]
  ]
  #p_normal[
    However, a thousand complements all numbers, which is a cube of ten, signifying complete and absolute perfection.#t_footnote(<nt1514>, "nr1514")[52] But there are two numbers especially celebrated by Plato in #emph[The Republic,] and not disapproved by Aristotle in #emph[Politics,] which predict great changes in cities. These are twelve squared and the same cubed—that is, 144 and 1,728, which are fated numbers. Any city or republic will afterward decline when it has reached a complete cube. Yet, in a square it enters a change, but for the better if managed with prudent discipline. Then it will collapse not by fate, but with imprudence.#t_footnote(<nt1515>, "nr1515")[53] Let these sayings be sufficient for particular numbers.
  ]
  #p_quote[
...
#character[
  ...
  #p_normal[
    The marks of numbers are depicted in different ways by various nations; the Romans formed these by the following marks. Valerius Probus described the letters of the ancients, which are hitherto in use today, these being:#t_footnote(<nt1520>, "nr1520")[1]
  ]
  #p_normal[
...
#character[
  ...
  #p_normal[
    In the second [way], the Greeks divided the entire alphabet into three classes. The first begins with alpha as one; the second, beginning with iota, is ten; and the third, beginning with rho, is hundred#t_footnote(<nt1521>, "nr1521")[1]—and the Greeks followed this order from the Hebrews, whom they imitated. However, because their alphabet is crippled by that rule, it is necessary to add three more figures and letters, which of course are explained in the numbers 6, 90 and 900,#t_footnote(<nt1522>, "nr1522")[2] which is clear in the following:#t_footnote(<nt1523>, "nr1523")[3]
  ]
  #p_normal[
    #t_img("./images/00040.jpeg")
  ]
  #p_normal[
    If to any of these letters is under-signed a tone of a small sharp stick, it signifies as many thousands, as in this example:#t_footnote(<nt1524>, "nr1524")[4]
  ]
  #p_normal[
    #t_img("./images/00041.jpeg")
  ]
  #p_normal[
    In the third way, the Greeks use only six letters to designate their numbers—namely, I for 1, Π for 5, because it is the start of the word πέντε,#t_footnote(<nt1525>, "nr1525")[5] which is 5, Δ for 10 from δέκα,#t_footnote(<nt1526>, "nr1526")[6] H for 100 from ἑκατόν,#t_footnote(<nt1527>, "nr1527")[7] X for 1,000 from the word χίλια,#t_footnote(<nt1528>, "nr1528")[8] and M for 10,000 from μύρια.#t_footnote(<nt1529>, "nr1529")[9] From these six letters are joined, according to this method, to four or to other numbers, forming the rest, in addition to Π, which is not multiplied or joined but always signifies the fives of others, as is shown in the following example: #t_img("./images/00042.jpeg")
  ]
]
...
#character[
  ...
  #p_normal[
    These are the classes of Hebrew numbers:#t_footnote(<nt1530>, "nr1530")[1]
  ]
  #p_normal[
...
#t_img("./images/00047.jpeg"), which makes 15, so that the sacred name is not wasted on the profane.
  ...
  #p_normal[
    From the arrangement and mixture of these marks, some other mixtures and compositions of numbers elegantly emerge, as can be easily seen in these few [examples]:#t_footnote(<nt1532>, "nr1532")[3]
  ]
  #p_normal[
...
#character[
  ...
  #p_poetry[
    #emph[Thus, Hector was Achilles’ prey.#t_footnote(<nt1534>, "nr1534")[2]]
  ]
  #p_normal[
    Also, Pliny said that Pythagoras discovered that a name assigned with an uneven number of vowels gives lameness, loss of eyesight, and similar problems on the right side, but on the left side if even.#t_footnote(<nt1535>, "nr1535")[3] The philosopher Alchandrinus taught how one can find from the numbers of letters the ruling stars and natal horoscope, and if the husband or wife will die first or outlive the other, and our prosperous and unhappy events of our other works.#t_footnote(<nt1536>, "nr1536")[4] He was pleased to join with that tradition, and the astrologer Ptolemy did not reject it.
  ]
  #p_normal[
...
#t_footnote(<nt1537>, "nr1537")[5] If 1 or 4 remain, each indicates the Sun; but if 2 or 7, each signifies the Moon; of the others 3 is Jupiter, 5 is Mercury, 6 is Venus, 8 is Saturn, and 9 denotes Mars. This account is shown elsewhere. By a similar rationale, if one wishes to know some horoscope,#t_footnote(<nt1538>, "nr1538")[6] compute their name and the name of the mother and father and collect the entire total and divide by 12. If the remainder is 1 it denotes Leo; if Juno 2 then Aquarius, if Vestal 3 then Capricorn, if 4 then Sagittarius, if 5 Cancer, if Venusian 6 Taurus, if Palladian 7 Aries, if Vulcan 8 Libra, if Martial 9 Scorpio, if 10 Virgo, if 11 Pisces, if Phoeban 12 it represents Gemini; and this is also accounted elsewhere.
  ...
  #p_normal[
    But no one should wonder that numbers through names can foretell many things since Pythagorean philosophers and Hebrew kabbalists testify that in these numbers lie some occult mysteries that are understood by few. Indeed, the Most High created all “numbers, measures, and weights,”#t_footnote(<nt1539>, "nr1539")[7] from which the truth of letters and names had its birth, whose method was not built accidentally but certainly (although unknown to us). Hence John in Revelation said: “He who has understanding, compute the number of the name of the beast, which is the number of man.”#t_footnote(<nt1540>, "nr1540")[8] These are not of those names, which are imposed by the dissonant dissimilarlity of nations and the rites of diverse people according to the causes and cultures of the places of men, but those which are inspired into each at its birth by the heavens and joining of the stars, which the Hebrew mekubalim and Egyptian wise men once taught to elicit from each birth.
  ]
]
...
#character[
  ...
  #p_normal[
    Now, the Pythagoreans dedicated sacred numbers to the elements and deities of heaven: for eight is air, four is fire,#t_footnote(<nt1541>, "nr1541")[1] earth is six, and water is assigned twelve.
  ]
  #p_quote[
    #emph[One.]
  ]
  #p_normal[
    Additionally one agrees with the Sun because there is one king of the stars, in which “God placed his tabernacle.”#t_footnote(<nt1542>, "nr1542")[2] This is also Jupiter, testifying to that ideal and intellectual causative power. Indeed, he is the head and father of the gods,#t_footnote(<nt1543>, "nr1543")[3] as the monad is the beginning and parent of the numbers.
  ]
  #p_quote[
    #emph[Two.]
  ]
  #p_normal[
    However, two is given to the Moon, which is the second luminary and forms the World Soul. She is called Juno because, between that and the monad, the number two is the first union, partner, and the like.#t_footnote(<nt1544>, "nr1544")[4] This number is also given to Saturn and Mars, which to astrologers are the two infortunes.
  ]
  #p_quote[
    #emph[Three.]
  ]
  ...
  #p_img[
    #emph[The threefold Hecate, the three mouths of the virgin Diana;]#t_footnote(<nt1545>, "nr1545")[5]
  ]
  #p_normal[
    therefore, three is dedicated to this virgin, as they say, “powerful in heaven and Erebus.”#t_footnote(<nt1546>, "nr1546")[6]
  ]
  #p_quote[
    #emph[Four.]
  ]
  ...
  #p_normal[
    Five is from the first even and first uneven, just as it consists of both sexes, female and male, is assigned to Mercury. It is also attributed to the celestial world, which over the four elements is itself under another form, the fifth.#t_footnote(<nt1547>, "nr1547")[7]
  ]
  #p_quote[
    #emph[Six.]
  ]
  #p_normal[
    Six, which is collected by two triads, just as a mixture of two sexes, is applied by the Pythagoreans to birth and marriage, and pertains to Venus#t_footnote(<nt1548>, "nr1548")[8] and Juno.
  ]
  #p_quote[
    #emph[Seven.]
  ]
  #p_normal[
    Seven is quiet and the number of Saturn.#t_footnote(<nt1549>, "nr1549")[9] It also dispenses the motion and light of the Moon and therefore it takes the name of Tritonia the virgin because it begets nothing. It is assigned to Minerva because nothing is born from it. It is likewise assigned to the #emph[virago] Pallas because this number contains both male and female;#t_footnote(<nt1550>, "nr1550")[10] hence Plutarch also gives it to Apollo.#t_footnote(<nt1551>, "nr1551")[11]
  ]
  #p_quote[
    #emph[Eight.]
  ]
  #p_normal[
    Eight, because it is sacred to justice, is Jupiter. It is likewise said to be Vulcan, for the first motion and dyad (which is Juno) is drawn twice into itself. It is likewise attributed to the mother goddess Cybele, because it bestows all cubes.#t_footnote(<nt1552>, "nr1552")[12] Plutarch assigns it to Bacchus or Dionysus, who is said to have been born in the eighth month;#t_footnote(<nt1553>, "nr1553")[13] others assign it to Saturn and the Fates, because births in the eighth month do not live.
  ]
  #p_quote[
    #emph[Nine.]
  ]
  #p_normal[
    Nine pertains to the Moon, who is the receptacle of all influences, celestial and beyond. It is no less dedicated to the nine Muses. It is also associated with Mars, from whom is the end of all things.#t_footnote(<nt1554>, "nr1554")[14]
  ]
  #p_quote[
    #emph[Ten.]
  ]
  ...
  #p_normal[
    Ten, the circular number, considers the Sun with the same rationale as the monad. It is also given to Janus, because the first turns toward the end and helps satisfy the second monad.#t_footnote(<nt1555>, "nr1555")[15] It is additionally assigned to the world. Similarly, twelve is attributed to the world and heavens and the Sun because the Sun passes through the twelve signs annually in twelve months.
  ]
  #p_quote[
    #emph[Eleven.]
  ]
  #p_normal[
    However, eleven, because it is semicircular, is attributed to the Moon and is also given to Neptune.#t_footnote(<nt1556>, "nr1556")[16]
  ]
]
...
#character[
  ...
  #p_normal[
    Additionally, magicians refer to certain tables of numbers assigned to the seven planets, which are called the sacred tables of the planets.#t_footnote(<nt1557>, "nr1557")[1] They signify many and very great virtues of the heavens, inasmuch as they represent the divine reasoning of the celestial numbers, impressed upon the celestials by the Divine Mind through the reason of the World Soul, and the sweetest harmony of those celestial rays according to proportion of effigies, co-signifying the super-mundane intelligences, which can be expressed in no other way than by the marks of numbers and characters.
  ]
  #p_normal[
...
#t_footnote(<nt1559>, "nr1559")[3], #t_footnote(<nt1560>, "nr1560")[4]
  ]
  #p_normal(italic: true)[
...
#t_footnote(<nt1562>, "nr1562")[6]
  ...
  #p_img[
    #strong[Intelligence of Mercury].#t_footnote(<nt1563>, "nr1563")[7]
  ]
  #p_normal[
  ...
  #p_img[
    #strong[Daemon of the Moon].#t_footnote(<nt1565>, "nr1565")[9]
  ]
  #p_normal[
...
#character[
  ...
  #p_normal[
    Likewise, the figures and characters of which we have spoken conceive whatever virtues from the celestial figure inasmuch as they are impressed on suitable things that [the celestials] rule, or inasmuch as they are made at the right time when a figure [is] conspiring and expressing toward its like figure.#t_footnote(<nt1571>, "nr1571")[6] As these virtues are said to be from figures, thus they are also understood to be from geometrical bodies, which are the sphere, tetrahedron, hexahedron, octahedron, icosahedron, dodecahedron, and the like.
  ]
  #p_normal[
    One should not disregard the figures that Pythagoras and his followers—Timaeus, Locrus, and Plato—assigned to the elements and celestials: for instance, earth is the cube, 8 solid angles, and 24 planes and 6 sides, squared in the form of a die; but fire is a pyramid with 4 triangular sides and as many solid angles and 12 planes; but to air is placed an octahedron, out of 8 triangular sides and 6 solid angles and 24 planes; finally to water is signified an icosahedron, 20 sides, and 12 solid angles; but dedicated to the heaven is the dodecahedron, having 12 pentagonal sides and 20 solid angles, but 60 planes.#t_footnote(<nt1572>, "nr1572")[7]
  ]
  #p_quote[
    #emph[Earth. Fire. Air.]
  ]
  ...
  #p_normal[
    But those who learn about the power of these figures and bodies, and their consideration and properties with each other, can work many wonderful things in natural and perspective#t_footnote(<nt1573>, "nr1573")[8] magic—indeed, especially in mirrors. I have learned how to make these wonderful things and mirrors, in which one can see whatever they wish from a long distance.
  ]
]
...
#character[
  ...
  #p_normal[
    Musical harmony is not void of gifts from the stars. Indeed, it is the most powerful imitator#t_footnote(<nt1574>, "nr1574")[1] of everything. Since it appropriately follows celestial bodies, it wonderfully provokes celestial influences and affects all listeners, [shaping their] intentions, gestures, movements, and actions. Customs are changed, and their qualities are suddenly provoked.#t_footnote(<nt1575>, "nr1575")[2] [They are moved] to joy or lamentation, towards boldness or tranquillity, and the like. Beasts, serpents, birds, and dolphins are provoked when hearing melodies. Thus, pipes allure birds and capture stags; fish are restrained in a lake in Alexandria by rattling; [musical] chords persuade friendship between dolphins and men; songs from a cithara induce Hyperborean swans; Indian elephants are charmed by the voices of organs.#t_footnote(<nt1576>, "nr1576")[3]
  ]
  #p_normal[
    The elements themselves also delight in melodies.#t_footnote(<nt1577>, "nr1577")[4] The Halesian#t_footnote(<nt1578>, "nr1578")[5] fountain, otherwise tranquil and quiet, jumps up and rises over its banks when a flute is sounded.#t_footnote(<nt1579>, "nr1579")[6] In Lydia, there are what are called the isles of nymphs. From the singing of a flute, [the nymphs] immediately go to the middle of a lake and dance in a circular motion, afterward returning to the shore. M. Varro wrote that he saw this himself.
  ]
  #p_normal[
    There are some things more wonderful than these. For instance, on the Attica shore, in the sea there are sounds like a cithara. There are certain stones in Megaris that make [the sound of] a lyre with each strike.#t_footnote(<nt1580>, "nr1580")[7] Such is the great power of music. Indeed, it soothes the soul, stimulates the mind, incites warriors to battle, and soothes the labor and fatigue of every work. It calls back the lapsed and desperate and comforts travelers. Arabs say that camels carrying loads are comforted by their leader’s singing. In a similar way, those carrying heavy loads sing because it enables and lightens them.
  ]
  #p_quote[
    #emph[Songs of praise.]
  ]
  #p_normal[
    Indeed, songs enable and delight labors, soften anger, delight sadness and anxiety, pacify discord, temper raging madness, and dissipate false thinking. Hence, Democritus and Theophrastus affirmed that some sicknesses of the body and mind are thus either cured or caused; thus, we read that Terpander and Arion of Methymna cured sick people in Lesbos and Ionia, and Ismenias cured very many gravely ill Thebans by shaking them with singing. Additionally, Orpheus, Amphion, David, Pythagoras, Empedocles, Asclepiades, and Timotheus often caused certain wonders with singing and sounds. Indeed, when lethargic, familiar melodies excite the dull mind, and playful tones restrain madness and anger. Thus, David held back the fury of Saul with his cithara, Pythagoras called back the immoderate adolescent from lust, and Timotheus excited King Alexander into a frenzy and again held him back.#t_footnote(<nt1581>, "nr1581")[8]
  ]
  #p_normal[
    Saxo Grammaticus wrote in #emph[Danish History] of a certain musician who had such a power that they could drag anyone into a frenzy of madness with sounds of little melodies, as none of the listeners’ minds could agree with these. Whenever he was compelled to perform by the king’s order, he attempted to change the intellects [of the listeners] by a variety of sounds. With a high singing of unusual severity, he first filled the listeners with a kind of sadness and numbness, then with more vigorous sounds. They stood with him applauding with delighted minds and bodies, wantonly moving, gesturing, and bending. Finally, in a sharper manner, he rapidly stirred a great spirit of fury, as a frenzy to madness, proceeding to rashness.#t_footnote(<nt1582>, "nr1582")[9]
  ]
  #p_normal[
    We also read that in Apulia, when those who were touched by a venomous spider became stupefied and layed down as if dead, each of the listeners rose when hearing certain sounds and danced to the rhythm,, afterward growing stronger. If after a long time they heard a similar sound, they would be quickly moved to dance.#t_footnote(<nt1583>, "nr1583")[10] It is believed, as Gellius wrote, that a flute melody lessens the pain for those who are ill with a great hip pain. It is also written by Theophrastus that viper bites are cured by a flute melody, and Democritus acknowledged that flute harmonies are a medicine for many illnesses of men.#t_footnote(<nt1584>, "nr1584")[11]
  ]
]
...
#emph[proslambanomenos].#t_footnote(<nt1598>, "nr1598")[8] Calliope holds the Hypophrygian Mercury and 
...
#emph[meses;]#t_footnote(<nt1599>, "nr1599")[9] which we read thus in the following verses: #emph[She spouts in the first nocturnal silences with a song,]
  ]
  #p_poetry[
  ...
  #p_poetry[
    #emph[Is born, hence rising it begets prosmeledes.]#t_footnote(<nt1600>, "nr1600")[10]
  ]
  #p_poetry[
  ...
  #p_poetry[
    #emph[Hypomixolydian turns near the Pole.]#t_footnote(<nt1601>, "nr1601")[11]
  ]
  #p_normal[
...
#emph[stadia]#t_footnote(<nt1602>, "nr1602")[12]—makes an interval of a tone. However, from the Moon to Mercury, being half of that space makes a semitone. It is just as much from that to Venus making another semitone. But from there to the Sun is as it were a threefold and a half tone makes a 
...
#emph[diapason] of six whole tones.
  ...
  #p_normal[
    The proportion of the planets’ motion about each other and the eighth heaven makes the sweetest harmony of all.#t_footnote(<nt1603>, "nr1603")[13] The proportion of the motion of Saturn to Jupiter is twice and a half, Jupiter to Mars is one and a half times,#t_footnote(<nt1604>, "nr1604")[14] that to the Sun, Venus, and Mercury, who journey equally, are proportionally doubled, those to the Moon are twelvefold, but Saturn to the starry orb is 1,200—if what Ptolemy said is true, heaven moves contrary to the 
#emph[Primum Mobile] in a hundred years to one degree.#t_footnote(<nt1605>, "nr1605")[15]
  ]
  #p_normal[
...
#emph[Primum Mobile] is the swiftest and sharpest of all, and the Moon is the slowest and most grave. This proportionate motion and reciprocation gives the sweetest harmony.#t_footnote(<nt1606>, "nr1606")[16] Hence, no songs, sounds, and musical instruments are more powerful in moving a man’s affections and inducing magical impressions than those composed from numbers, measures, and proportions according to their celestial equals.
  ]
  #p_normal[
...
#emph[diapason] and #emph[diapente] arise. Between air and water, there is a double and a half proportion in their bases#t_footnote(<nt1607>, "nr1607")[17] (from which is 
#emph[diapason] and #emph[diapente]), but the angles are double (from which again is 
#emph[diapason]). But between water and earth is a proportion of three and a third#t_footnote(<nt1608>, "nr1608")[18] in bases (from which rise 
...
#emph[diapente]) but double angles (constituting a #emph[diapason]). Between fire and water, and between air and earth, they fail to achieve concord since among these there is a complete contrariety in their qualities. However, they are able to agree through an intervening element.#t_footnote(<nt1609>, "nr1609")[19]
  ]
]
...
#emph[cubit].#t_footnote(<nt1614>, "nr1614")[5] Hence, four cubits constitute the length of a man; however, the width of the shoulders is one cubit, but encircling it is one foot. A cubit is made up of six palms, but a foot is four [palms], four fingers a palm, and the entire length of a man is twenty-four palms, six feet, ninety-six fingers. From the pubis to the top of the breast is six parts in length.#t_footnote(<nt1615>, "nr1615")[6] From the top of the breast to the top of the forehead and the roots of the hair is a seventh#t_footnote(<nt1616>, "nr1616")[7] part in length. A strong and well-squared body is six feet long, but a taller is seven. As Varro and Gellius testify, a human body cannot exceed seven feet in height.#t_footnote(<nt1617>, "nr1617")[8]
  ]
  #p_normal[
    #t_img("./images/00098.jpeg")
  ]
  #p_normal[
    Finally, the diameter of the waist is the [same] space as the heel of a hand to the inner folding of the elbow. From the breast to the top of the nipples to the top lip, or downward to the navel, and which between the ends of the bones at the top of the breast surrounding the throat and which from the soles of the feet to the end of the calf,#t_footnote(<nt1618>, "nr1618")[9] and from there to the kneecap, are all coequal and constitute a seventh of the total height.
  ]
  #p_normal[
...
#character[
  ...
  #p_normal[
    But hurrying back to the harmony of the soul, we must search to those mediums that pass above us—namely, from the celestial bodies and spheres. By knowing which powers of the soul respond to which planets (a subject discussed above) we should easily recognize their agreements with each other.#t_footnote(<nt1634>, "nr1634")[3] Indeed, the Moon rules the power of increase and decrease; Mercury the power of fantasy and ingenuity; Venus the concupiscible virtue; the Sun vitality; Mars impulsiveness and anger; natural [virtues] are assigned to Jupiter; from Saturn [come] all receptive [virtues].#t_footnote(<nt1635>, "nr1635")[4] The will [belongs] to the 
...
#character[
  ...
  #p_normal[
    Indeed, every natural virtue acts more wonderfully when not only composed of a physical virtue but also observing a celestial suitably chosen for this#t_footnote(<nt1639>, "nr1639")[1]—that is, when the power of an approved celestial is strongest for such an effect that we desire; then it is also shaped with many celestials helping and subjecting the inferior celestials, just as individual females everywhere are made fertile for their males.#t_footnote(<nt1640>, "nr1640")[2]
  ]
  #p_normal[
    Therefore, in any operation, the place, motion, and aspect of the stars and planets in signs, degrees, and qualities are observed—all according to the longitude and latitude of the climate.#t_footnote(<nt1641>, "nr1641")[3] Indeed, it is from these various qualities of the angles that the rays of the celestial bodies are described over the thing, and according to which qualities the virtues of the celestials are thereby infused.
  ]
  #p_quote[
    #emph[What must be observed in any operation.]
  ]
  #p_normal[
    Thus, often when making an operation concerning some planet, you must place it in its fortunate and powerful dignities, in its day and hour, and dominating the figure of heaven.#t_footnote(<nt1642>, "nr1642")[4]
  ]
  #p_quote[
    #emph[How a planet must be observed.]
  ]
  #p_normal[
    Nor should you expect only the significator of the operation to be powerful, but also observe that the Moon be suitably placed; indeed, nothing beneficial is completed without the Moon. But if you have many advocates in your operation, observe that they are all powerful and in friendly aspects with each other; but if you cannot have an aspect of this kind, you can at least make them angular. However, observe the Moon either when it considers both or is joined to one and aspects the other, or when it passes from the conjunction or aspect of one to a conjunction, or to the aspect of the other.#t_footnote(<nt1643>, "nr1643")[5]
  ]
  #p_quote[
    #emph[How the Moon must be observed.]
  ]
  #p_normal[
    Also, I believe it must not be omitted, that one must diligently observe Mercury in all operations. Indeed, he is the messenger of each of the inferior and superior gods,#t_footnote(<nt1644>, "nr1644")[6] when joined to a benefic he becomes benefic, and when joined to a malefic he exudes maleficence. Presently we refer here to an unfortunate sign or planet aspecting Saturn or Mars, especially by opposition or square, because these aspects are unfortunate. However, the aspects of conjunction, trine, and sextile are friendly. Among these, the strongest is conjunction. Yet if a planet is aspecting by a trine and also received, it is valued as if it is a conjunction. However, all the planets fear a conjunction with the Sun,#t_footnote(<nt1645>, "nr1645")[7] but they are happy with a trine or sextile.
  ]
  #p_quote[
...
#character[
  ...
  #p_normal[
    The planets are powerful when they are ruling by domicile, exaltation, triplicity, term, or decan, out of combustion,#t_footnote(<nt1646>, "nr1646")[1] direct, increasing in the figure and dominating the heavens—that is, when in the angles,#t_footnote(<nt1647>, "nr1647")[2] especially oriental,#t_footnote(<nt1648>, "nr1648")[3] or in the tenth or succedent,#t_footnote(<nt1649>, "nr1649")[4] or in its joy.#t_footnote(<nt1650>, "nr1650")[5] But beware that they are not in the terms#t_footnote(<nt1651>, "nr1651")[6] or under the lordship of Saturn or Mars, and not in dark, pitted, or empty degrees.#t_footnote(<nt1652>, "nr1652")[7]
  ]
  #p_normal[
    You must also observe that the angles of the ascendant, tenth, and seventh are fortunate, and that the ruler of the ascendant, place of the Sun, place of the Moon, the place of the Part of Fortune and their rulers, and that the ruler of the preceding conjunction and prevention [of the Moon] are fortunate.#t_footnote(<nt1653>, "nr1653")[8] But the malefic planets should fall unfortunately, unless by chance they are significators of your operation, or can be useful to you in some way, or if [a malefic] holds lordship in a revolution of your birth; indeed, then they are to be minimally suppressed.
  ]
  #p_quote[
...
#emph[via combusta,]#t_footnote(<nt1654>, "nr1654")[9] slow in course, nor in an eclipse, or in combustion from the Sun, unless strong in a unity with the Sun. Nor should it descend in a southern latitude when it passes out of combustion, nor should it be opposed the Sun, decreasing in light, or impeded by Mars or Saturn. I am unwilling to speak on these points for too long since these and many more vital things are sufficiently handled in the volumes of astrologers.#t_footnote(<nt1655>, "nr1655")[10]
  ]
]
...
#character[
  ...
  #p_normal[
    The natures of the fixed stars are discerned by their colors that agree with certain planets. The colors of the planets are as follows:#t_footnote(<nt1656>, "nr1656")[1] Saturn is bluish or leaden and shining in these [colors]; Jupiter is citron, almost pale, and with these is clear; Mars is red and fiery; the Sun is yellow and when rising is glowing, and afterward radiant; Venus is white, but as Lucifer shining, however as Vesperus#t_footnote(<nt1657>, "nr1657")[2] gleaming; Mercury is radiant; the Moon pale.#t_footnote(<nt1568>, "nr1658")[3] Likewise, know the fixed stars by how much greater, brighter, and apparent they are; the greatest and strongest in their significations#t_footnote(<nt1659>, "nr1659")[4] are those stars which astrologers call the first and second magnitude.
  ]
  #p_quote[
  ...
  #p_normal[
    I will tell you of some of the more useful in this faculty, which are:#t_footnote(<nt1660>, "nr1660")[5] the Navel of Andromeda#t_footnote(<nt1661>, "nr1661")[6] in the 22nd degree of Aries is of the nature of Venus and Mercury, others say Jupiter and Saturn.
  ]
  #p_normal[
    Caput Algol#t_footnote(<nt1662>, "nr1662")[7] in the 18th degree of Taurus is of the nature of Saturn and Jupiter.
  ]
  #p_normal[
    The Pleiades#t_footnote(<nt1663>, "nr1663")[8] are in the 22nd degree of the same [sign], a star of a Lunar nature and Martial complexion.
  ]
  #p_normal[
    Likewise, in the 3rd degree of Gemini, Aldebaran#t_footnote(<nt1664>, "nr1664")[9] is of the nature of Mars and complexion of Venus: but Hermes [Trismegistus] placed this in the 25th [degree] of Aries.
  ]
  #p_normal[
    In the 13th degree of Gemini, Capella#t_footnote(<nt1665>, "nr1665")[10] is of the nature of Jupiter and Saturn.
  ]
  #p_normal[
    In the 7th degree of Cancer, Canis Major#t_footnote(<nt1666>, "nr1666")[11] [has the nature of] Venus.
  ]
  #p_normal[
    In the 17th degree of the same [sign] is Canis Minor,#t_footnote(<nt1667>, "nr1667")[12] is Mercurial by nature and Martial by complexion.
  ]
  #p_normal[
    In the 21st degree of Leo is the King’s Star,#t_footnote(<nt1668>, "nr1668")[13] which is called Cor Leonis, of the nature of Jupiter and Mars.
  ]
  #p_normal[
    In the 19th degree of Virgo is the Tail of Ursa Major#t_footnote(<nt1669>, "nr1669")[14] [having the nature] of Venus and the Moon.
  ]
  #p_normal[
    In the 7th degree of Libra is the Right Wing of the Raven#t_footnote(<nt1670>, "nr1670")[15] and in the same [sign] in the 13th degree is the Left Wing,#t_footnote(<nt1671>, "nr1671")[16] each of the nature of Saturn and Mars.
  ]
  #p_normal[
    In the same [sign] in the 16th degree is Spica,#t_footnote(<nt1672>, "nr1672")[17] [of the nature of] Venus and Mercury; in the same [sign] in the 17th degree is Alcameth#t_footnote(<nt1673>, "nr1673")[18] of the nature of Mars and Jupiter: but of [Jupiter] when in a good aspect with a luminary, of [Mars] when opposed.
  ]
  #p_normal[
    In the 4th degree of Scorpio is Elepheia#t_footnote(<nt1674>, "nr1674")[19] of the nature of Venus and Mars.
  ]
  #p_normal[
    In the 3rd degree of Sagittarius is the Heart of the Scorpion#t_footnote(<nt1675>, "nr1675")[20] of the nature of Mars and Jupiter.
  ]
  #p_normal[
    In the 7th degree of Capricorn is the Falling Vulture,#t_footnote(<nt1676>, "nr1676")[21] temperate, [of the nature] of Mercury and Venus.
  ]
  #p_normal[
    In the 16th degree of Aquarius is the Tail of Capricorn#t_footnote(<nt1677>, "nr1677")[22] of the nature of Saturn and Mercury.
  ]
  #p_normal[
    In the 3rd degree of Pisces is the Shoulder of the Horse#t_footnote(<nt1678>, "nr1678")[23] of the nature of Jupiter and Mars.#t_footnote(<nt1679>, "nr1679")[24]
  ]
  #p_normal[
    It is a general rule that you should expect each of the stars’ own gifts when they dominate, but they are hindered when an unfortunate [planet] opposes them, which is shown above; indeed, the celestial bodies, as far as they are affected happily or unfortunately, happily or unfortunately affect us and our works and those things we use. And although the fixed stars produce many effects, they are yet attributed to the planets, since they are closer to us and more distinct and recognized. Moreover, [the planets] carry out each of the influences from the fixed stars.#t_footnote(<nt1680>, "nr1680")[25]
  ]
]
...
#character[
  ...
  #p_normal[
    Because the Moon traverses the entire zodiac in the space of twenty-eight days, the wise Indians and most ancient astrologers granted twenty-eight Lunar mansions. Fixed in the eighth sphere, they hold the various constellations and stars, from which, as Alphaus said, they obtained different qualities and names. While the Moon travels through these, it obtains one or another powers and virtues.#t_footnote(<nt1692>, "nr1692")[1] The mansions, according to the opinion of Abraham,#t_footnote(<nt1693>, "nr1693")[2] are contained in 12 degrees, 51 minutes and almost 26 seconds; the names of which [mansions] and likewise their beginnings in the zodiac within the eighth sphere are these.#t_footnote(<nt1694>, "nr1694")[3]
  ]
  #p_normal[
    The 1st#t_footnote(<nt1695>, "nr1695")[4] is called Alnath,#t_footnote(<nt1696>, "nr1696")[5] which is in the Horns of Aries; it starts at the beginning of Aries in the eighth sphere; it is used for journeys and discord.
  ]
  #p_normal[
    The 2nd is called Allothaim or Albochan,#t_footnote(<nt1697>, "nr1697")[6] which is the Stomach of Aries; and the beginning of this is in 12 degrees, 51 minutes, 22 seconds of the same sign; it brings the discovery of treasure, and the restraining of captives.
  ]
  #p_normal[
    The 3rd is called Achoamazone or Athoraye#t_footnote(<nt1698>, "nr1698")[7]—that is, the Raining or Pleiades—it begins at 25 degrees, 42 minutes, and 51 seconds Aries; it is used for navigation, hunters, and alchemical operations.
  ]
  #p_normal[
    The 4th mansion is called Aldebaran or Aldelamen#t_footnote(<nt1699>, "nr1699")[8]—that is, the Eye or Head of Taurus—it begins at 8 degrees, 34 minutes, 17 seconds Taurus; it destroys and impedes buildings, fountains, wells, goldmines, makes reptiles flee, and generates discord.
  ]
  #p_normal[
    The 5th is called Alchataya or Albachaya;#t_footnote(<nt1700>, "nr1700")[9] its beginning is after 21 degrees, 25 minutes, 43 seconds#t_footnote(<nt1701>, "nr1701")[10] Taurus; it brings the return from journeys, for the instruction of students, strengthening buildings, and granting health and favor.
  ]
  #p_normal[
    The 6th is called Alhanna or Alchaya#t_footnote(<nt1702>, "nr1702")[11]—that is, the Small Star of great light—it begins after four degrees, 17 minutes, and 9 seconds Gemini; it is used for hunting and besieging cities and vengeance of princes, destroys harvests and crops, and impedes the work of physicians.
  ]
  #p_normal[
    The 7th is called Aldimiach or Alarzach#t_footnote(<nt1703>, "nr1703")[12]—that is, the Arm of Gemini—it begins from 17 degrees, 8 minutes, 34 seconds Gemini, and lasts all the way to the end of the sign; it brings gain and friendship, is useful for lovers, makes flies flee, and destroys officials.
  ]
  #p_normal[
  ...
  #p_normal[
    Therefore, the next seven mansions begin from the beginning of Cancer, the names of which are Alnaza or Anatrachya#t_footnote(<nt1704>, "nr1704")[13]—that is, the Misty or Cloudy, of course, the 8th mansion. It is used for love and friendship, alliances with travelers, drives away mice, overthrows prisoners, and strengthens prisons.
  ]
  #p_normal[
    After this is the 9th is called Archaam or Alcharph#t_footnote(<nt1705>, "nr1705")[14]—that is, the Eye of Leo—it harms harvests and travelers, and places discord between men.
  ]
  #p_normal[
    The 10th is called Algelioche or Algebh#t_footnote(<nt1706>, "nr1706")[15]—that is, the Neck or Forehead of Leo—it strengthens buildings, grants love, benevolence, and helps against enemies.
  ]
  #p_normal[
    The 11th is called Azobra or Ardaf#t_footnote(<nt1707>, "nr1707")[16]—that is, the Mane of Leo—it is used for travel, gain from merchandise, and rescuing prisoners.
  ]
  #p_normal[
    The 12th is called Alzarpha or Azarpha#t_footnote(<nt1708>, "nr1708")[17]—that is, the Tail of Leo—it gives success in harvests and planting, and harms sailing; but is good for improving servants, prisoners, and associates.
  ]
  #p_normal[
    The 13th is called Alhayre#t_footnote(<nt1709>, "nr1709")[18]—that is, the Dogs#t_footnote(<nt1710>, "nr1710")[19] or Wings of Virgo—it is strong for benevolence, gain, traveling, harvests, and the liberation of captives.
  ]
  #p_normal[
    The 14th is called Achureth or Arimet, and by others Azimeth or Alhumech or Alcheymech#t_footnote(<nt1711>, "nr1711")[20]—that is, the Spike#t_footnote(<nt1712>, "nr1712")[21] or Flying Spike—it is strong for lovers marrying, for curing illness, and is useful for sailing, but harms for traveling by land.
  ]
  #p_normal[
    This completes the second quarter of heaven. The other seven follow, the first of which starts in the beginning of Libra, of course the 15th mansion, whose name is Agrapha or Algarpha#t_footnote(<nt1713>, "nr1713")[22]—that is, the Covered or the Flying Covered—it is used for extracting treasure, for digging wells, is made for separation and discord, the destruction of homes and enemies, and for impeding travelers.
  ]
  #p_normal[
    The 16th is called Azubene or Ahubene#t_footnote(<nt1714>, "nr1714")[23]—that is, the Horns of Scorpio—it impedes traveling and marriages, harvests and merchandise, and is strong for the liberation of prisoners.
  ]
  #p_normal[
    The 17th is called Alchil#t_footnote(<nt1715>, "nr1715")[24]—that is, the Crown of Scorpio—it is used for the improvement of unjust fortune, for lasting love, for strengthening buildings, and is useful for sailing.
  ]
  #p_normal[
    The 18th is called Akhas or Altob#t_footnote(<nt1716>, "nr1716")[25]—that is, the Heart of Scorpio—it is used for discord, sedition, and conspiracy against princes and powerful men, and for vengeance from enemies, but liberates prisoners, and is useful for buildings.
  ]
  #p_normal[
    The 19th is called Allatha or Akhala,#t_footnote(<nt1717>, "nr1717")[26] but by others Hycula or Axala—that is, the Tail of Scorpio—it is strong for besieging and capturing cities, for expelling men from their place, for the destruction of sailing, and destroying prisoners.
  ]
  #p_normal[
    The 20th is called Abnahaya#t_footnote(<nt1718>, "nr1718")[27]—that is, the Beam—it is used for taming wild beasts, for strengthening prisons, destroying the wealth of associates,#t_footnote(<nt1719>, "nr1719")[28] and forces men to leave from some place.
  ]
  #p_normal[
    The 21st is called Abeda or Albeldach#t_footnote(<nt1720>, "nr1720")[29]—that is, the Deserted—it is used for harvests, gain, buildings and travelers, and for causing separation.
  ]
  #p_normal[
    This completes the third quarter of the sky. The last remaining seven mansions, complete the last quarter of the sky, the first of which in order is the 22nd, starting at the beginning of Capricorn, and is called Sadahacha, Zodeboluch, or Zandeldena#t_footnote(<nt1721>, "nr1721")[30]—that is, the Shepherd—it promotes the flight of servants and prisoners so that they can escape, and for strengthening the cure of illnesses.
  ]
  #p_normal[
    The 23rd is called Sabadola or Zobrach#t_footnote(<nt1722>, "nr1722")[31]—that is, the Swallowing—it is used for separation, for the liberation of prisoners, and the healing of the ill.
  ]
  #p_normal[
    The 24th is called Sadabath or Chadezoad#t_footnote(<nt1723>, "nr1723")[32]—that is, the Star of Fortune—it is strong for benevolent marriage, for the victory of soldiers, for harming and impeding officials so that their orders are not completed.
  ]
  #p_normal[
    The 25th is called Sadalabra or Sadalachia#t_footnote(<nt1724>, "nr1724")[33]—that is, the Butterfly or the Expanding—it is used for sieging and vengeance, destroying enemies, making separations, strengthening prisons and buildings, accelerating messengers, is made for spells against marriage, and for binding whichever members of man, so that it is not possible to accomplish their duties.
  ]
  #p_normal[
    The 26th is called Alpharg or Phtagal Mocaden#t_footnote(<nt1725>, "nr1725")[34]—that is, the First Drinking—it is used for the union and delight of men, for the health of prisoners, and for destroying prisons and buildings.
  ]
  #p_normal[
    The 27th is called Alcharya or Alhalgalmoad#t_footnote(<nt1726>, "nr1726")[35]—that is, the Second Drinking—it increases harvests, trade, gain, cures illnesses, but impedes buildings, prolongs prisons, makes sailing risky, and helps to bring whatever evil you wish.
  ]
  #p_normal[
    The 28th and last is called Albotham or Alchalh#t_footnote(<nt1727>, "nr1727")[36]—that is, Pisces—it increases harvests and merchandise, secures travelers through dangerous places, is used for the joy of marriage, but strengthens prisons, and causes the ruin of treasures.
  ]
  #p_normal[
...
#character[
  ...
  #p_normal[
    Whoever works for a suitable celestial, must observe one or both—that is, the motions or times of the stars: I say motion when they are in their dignities or debilities,#t_footnote(<nt1728>, "nr1728")[1] either essential or accidental;#t_footnote(<nt1729>, "nr1729")[2] but I say time when they are distributed in the days and hours of their rulership. All of these things are taught abundantly enough in books of astrologers, but we will especially consider and observe two such considerations here. The first is that as we observe the motions of the stars, their ascensions, and angles,#t_footnote(<nt1730>, "nr1730")[3] as they are in truth located in the eighth sphere. Because of the neglect of this fact, many people err in their fabrication of celestial images and are defrauded of desired effects.
  ]
  #p_normal[
    The other thing we must observe concerns the times for finding planetary hours; indeed, almost all astrologers divide the time interval from the rising of the Sun to the setting into 12 equal parts and called them the 12 hours of the day. Then in a similar rationale, they shared in 12 equal portions the time following from setting to rising, and they called them the 12 hours of night. They then distributed those hours to each single planet according to their order of succession, always giving the first hour of the day to the planet ruling the day, then each in order to the end of 24 hours.#t_footnote(<nt1731>, "nr1731")[4]
  ]
  #p_normal[
...
#character[
  ...
  #p_normal[
    So great is the magnitude, strength, and power of the celestials that not only natural things but also artificial things, when duly exposed to the superiors, suddenly experience a most powerful agent and wonderful life from above,#t_footnote(<nt1732>, "nr1732")[1] which often gives them a wonderful celestial virtue.#t_footnote(<nt1733>, "nr1733")[2] The divine teacher Saint Thomas Aquinas confirmed this in his book 
#emph[On Fate,] where he said that even garments and any artificial works accept certain qualities from the stars.#t_footnote(<nt1734>, "nr1734")[3]
  ]
  #p_normal[
...
#character[
  ...
  #p_normal[
    Moreover, there are many celestial images in the heavens for whose likenesses these images are configured: some are visible and conspicuous, and others are observed and designated as imaginable by the Egyptians, Indians, and Chaldeans;#t_footnote(<nt1737>, "nr1737")[1] and their parts are thus so that even some of their figures are distinct from the others.#t_footnote(<nt1738>, "nr1738")[2] For this reason, they placed twelve universal images around the zodiac for the number of signs.
  ]
  #p_normal[
    Aries, Leo, and Sagittarius constitute the fiery triplicity, are oriental, and are useful against fever, paralysis,#t_footnote(<nt1739>, "nr1739")[3] dropsy, gout, and against all cold and phlegmatic illnesses. They bring the bearer [of their engraved image] grace, eloquence, cleverness, and honor, because they are the domiciles of Mars, the Sun, and Jupiter.#t_footnote(<nt1740>, "nr1740")[4] They likewise made an image of a lion against melancholic fantasies, fevers, and for expelling illnesses in the hour of the Sun in the first degree of the second face#t_footnote(<nt1741>, "nr1741")[5] of Leo rising,#t_footnote(<nt1742>, "nr1742")[6] which indeed is the face and decanate of Jupiter. But against stones and illnesses of the kidney, and against injuries from beasts, they made the same [image] when the Sun is in the heart of Leo placed in the midheaven.
  ]
  #p_normal[
...
#character[
  ...
  #p_normal[
    There are also thirty-six images in the zodiac that are according to the number of faces [of the zodiac], of which Porphyry said were once written by the ancient mathematician Teucer the Babylonian,#t_footnote(<nt1747>, "nr1747")[1] and later also written about by the Arabs.
  ]
  #p_normal[
    Therefore, it is said#t_footnote(<nt1748>, "nr1748")[2] that in the first face of Aries rises the likeness of a black man, standing dressed in white and girded. [He has] a large body, red eyes, and great strength, and [appears] as if angry; this image signifies and is made for boldness, strength, loftiness, and immodesty.
  ]
  #p_normal[
  ...
  #p_normal[
    In the second face of Taurus rises a nude man, holding a key in his hand; this brings power, nobility, and authority#t_footnote(<nt1749>, "nr1749")[3] over people.
  ]
  #p_normal[
...
#character[
  ...
  #p_normal[
    Likewise, for the operations of Saturn, they made images while Saturn was rising in Capricorn to be used for increasing power. The form [of such images] is an old man leaning on a staff, holding in his hand a crooked sickle, dressed in black clothes.#t_footnote(<nt1757>, "nr1757")[4]
  ]
  #p_normal[
...
#character[
  ...
  #p_normal[
    They made another image for Jupiter for a religious and glorious life, and for dexterity of fortune, whose figure is of a man with a head of a lion or ram and feet of an eagle, dressed in yellow garments,#t_footnote(<nt1759>, "nr1759")[1] and he was called the son of Jupiter.
  ]
]
...
#character[
  ...
  #p_normal[
    They also made images of Mars for bringing boldness, animosity, and fortune in war and quarrels, whose form is of an armed and crowned soldier, girded with a sword. In his right hand he holds a long lance, and [this image] is made in the hour of Mars, rising in the first face of Scorpio.#t_footnote(<nt1760>, "nr1760")[1]
  ]
]
...
#character[
  ...
  #p_normal[
    They made other images of Mercury, [with Mercury] rising in Virgo, for benevolence, cleverness, and memory. [Their] form is of a man sitting on a chair or riding on a peacock, having the feet of an eagle. On his head he has a crest, and in his left hand he holds a rooster or fire.#t_footnote(<nt1764>, "nr1764")[1]
  ]
]
...
#character[
  ...
  #p_normal[
    They made other images of the Moon in the hour of the Moon, [with the Moon] rising in the first face of Cancer. [These were] for increasing plants on the earth, and against poisons and illnesses of children. Their figure is a horned woman. [She is] riding a bull, a sevenheaded dragon, or a crab, and has an arrow in her right hand, and a mirror in her left. [She is] wearing white or green garments, having around her head a crown of two serpents. Around each arm she has a serpent, and her feet the same.#t_footnote(<nt1765>, "nr1765")[1] This is enough said of the figures of the planets.
  ]
]
...
#character[
  ...
  #p_normal[
    In the 3rd [mansion], they made an image in a silver ring, whose table#t_footnote(<nt1769>, "nr1769")[1] was square and whose figure was a well-dressed woman sitting in a chair with her right hand raised over her head. They sealed and fumigated [the ring] with musk, camphor, and aromatic oils#t_footnote(<nt1770>, "nr1770")[2]; they asserted that this is for prosperity of fortune and bestowing all good things.
  ]
  #p_normal[
  ...
  #p_normal[
    In the 11th, for fear, reverence, and veneration, they sealed in a golden plate the image of a man riding on a lion, who holds its ear in his left hand, and with in his right holds out a lance.#t_footnote(<nt1771>, "nr1771")[3] They fumigated with good scents and saffron.
  ]
  #p_normal[
  ...
  #p_normal[
    In the 21st, for the destruction of someone, they made images of a man with two faces: one in front and one behind. They fumigated with sulfur and yellow amber#t_footnote(<nt1772>, "nr1772")[4] and placed it in a copper box with sulfur, amber, and the hairs of the person whom they wished to harm.
  ]
  #p_normal[
  ...
  #p_normal[
    In the 28th, for gathering fish, they sealed in copper an image of a fish and fumigated it with the skin of a fish. [Then they] threw it in the water wherever they wished fish to gather.#t_footnote(<nt1773>, "nr1773")[5]
  ]
  #p_normal[
...
#character[
  ...
  #p_normal[
    Under Canis Major#t_footnote(<nt1774>, "nr1774")[1] they made images of a dog,#t_footnote(<nt1775>, "nr1775")[2] hare, or virgin girl: these bring honor, benevolence, and grace from men and airy spirits, and give the power to pacify and harmonize with kings and princes and other men.
  ]
  #p_normal[
    Under Canis Minor,#t_footnote(<nt1776>, "nr1776")[3] they made an image of a rooster or three girls: these bring the grace of God, spirits and men, grant the ability to counter sorceries, and preserve health.
  ]
  #p_normal[
    Under Cor Leonis,#t_footnote(<nt1777>, "nr1777")[4] they made an image of a lion, cat, or the figure of a respected man sitting in a chair: these make a man temperate, keep anger away, and give grace.
  ]
  #p_normal[
    Under the Tail of Ursa Major,#t_footnote(<nt1778>, "nr1778")[5] they made an image of a man wrapped in thought or a bull or the figure of a calf: these help against incantations and makes the bearer secure in their travels.
  ]
  #p_normal[
    Under the Wing of the Raven#t_footnote(<nt1779>, "nr1779")[6] they made images of a raven, serpent, or a black man dressed in black garments: these make men angry, bold, courageous, thoughtful, a slanderer, and give evil dreams. They also give the ability to make daemons flee and gather. They are useful against wicked men, daemons, and winds.
  ]
  #p_normal[
  ...
  #p_normal[
    Under Alchameth#t_footnote(<nt1780>, "nr1780")[7] they made an image of a horse, wolf, or the figure of a man dancing: these help against fevers. [They] also astringe and restrain blood.
  ]
  #p_normal[
    Under Elpheia#t_footnote(<nt1781>, "nr1781")[8] they made an image of a hen, or a crowned and raised man: these give benevolence, the love of men, and chastity.
  ]
  #p_normal[
    Under the Heart of Scorpio,#t_footnote(<nt1782>, "nr1782")[9] they made an image of an armed man with a breastplate or the figure of a scorpion: these give intellect and memory, as well as causing good color. They help against evil daemons, make them flee, and confine them.
  ]
  #p_normal[
    Under the Vulture#t_footnote(<nt1783>, "nr1783")[10] they made an image of a vulture, hen, or traveling man: these make men magnanimous and haughty, and give power over daemons and beasts.
  ]
  #p_normal[
    Under the Tail of Capricorn,#t_footnote(<nt1784>, "nr1784")[11] they made an image of a stag, male goat, or an angry man:#t_footnote(<nt1785>, "nr1785")[12] these give prosperity and increase wealth.
  ]
  #p_normal[
...
#character[
  ...
  #p_normal[
    There are yet other kinds of images that are not according to the likeness of a celestial figure but according to the likeness of that which the operator desires, which are effigies and impressions.#t_footnote(<nt1787>, "nr1787")[1]
  ]
  #p_normal[
    Thus, for love, we make images embracing each other, and for discord beating each other.#t_footnote(<nt1788>, "nr1788")[2] For bringing disaster or destruction or hindrance either to a man, home, city, or another thing, we make distorted images, with members broken and in parts, according to the likeness and figure for that thing that we wish to destroy or hinder.
  ]
  #p_normal[
    And magicians command that when casting or sculpting images, to inscribe the name of their effect: this [name] on the back when evil, such as for destruction, and on the stomach when good, such as for love#t_footnote(<nt1789>, "nr1789")[3]; additionally, on the forehead of the image, the name of the type or individual that the image describes, or for whom or against that for which it is made; and again [inscribe] the name of the sign or the face rising and its lord in the breast, also their characters and names of their angels. They also command that when making images, prayers for those effects for which the images are made must not be silent; indeed, Albertus Magnus affirms all of this in his book #emph[Speculum].#t_footnote(<nt1790>, "nr1790")[4]
  ]
  #p_normal[
  ...
  #p_normal[
    Indeed, they said that as much that the operator of the images affects the image itself, so far as the likeness of his passions are brought into that which ascribed, is exactly dictated by the mind of the operator:#t_footnote(<nt1791>, "nr1791")[5] just as we read the magician Nectanabus made images of ships in wax according to this manner and skill, he sunk these images in water, and in a similar manner the ships of his enemies sunk into the sea and were destroyed.#t_footnote(<nt1792>, "nr1792")[6] However, we must observe the constellations for these kinds of images and the like, as we are taught by those parts of astrology that are written about elections.
  ]
]
...
#character[
  #p_title[
    Chapter 52. Of characters that are derived from things themselves with a certain similarity.#t_footnote(<nt1808>, "nr1808")[1]
  ]
  #p_normal[
...
#t_img("./images/00125.jpeg"), Virgo from a spike#t_footnote(<nt1809>, "nr1809")[2]#t_img("./images/00126.jpeg"), 
...
#character[
  ...
  #p_normal[
    But also if some portent appears in the sky, the celestial figure must be built. Also scrutinize the preceding revolutions of the years, great conjunctions,#t_footnote(<nt1811>, "nr1811")[1] and eclipses. Consider the nativity of the prince, nation, region, and city where [the portent] appeared, beginnings, coronations,#t_footnote(<nt1812>, "nr1812")[2] foundations, revolutions, profections,#t_footnote(<nt1813>, "nr1813")[3] directions, and that which is from them, and to which place the celestial figure falls. From all of these, we may finally find a rational and true signification of these things. With this same sequence, yet with less work, we can also explain dreams. Indeed, those who are entranced#t_footnote(<nt1814>, "nr1814")[4] in a frenzy do not predict the future unless agitated by the stars or inferior instruments of these; from where in the end, their predictions can be adapted by the celestials, just as we read in Lucan of the Etruscan prophet:
  ]
  #p_poetry[
    #emph[Is well-taught in the motions of lightning and of warm pulsing]
  ]
  #p_poetry[
    #emph[Entrails and the wandering motions of birds in the air],#t_footnote(<nt1815>, "nr1815")[5]
  ]
  #p_normal[
  ...
  #p_normal[
    Geomancy, the most accurate of lots, [is performed] by marking the earth or another surface, through divination by chance,#t_footnote(<nt1816>, "nr1816")[6] or by the power from certain inscriptions. [All of these processes] are first reduced from celestial figures—that is, to those sixteen [figures] named above. A judgment is formed in an astrological manner from those qualities and methods. Hence, they observed any of the more divine natural lots, whose power can be from no [other source] but from heaven and the mind of the operator. Accordingly, whatever is moved in these inferiors is moved, agitated and produced, by the movements of the superior influences, and necessarily imitates these. They are reduced from the roots, causes, and signs, just as [with geomancy, and thus] our opinions are likewise indicated from astrological rules.
  ]
  #p_normal[
    Hence, tetrahedron, hexahedron, octahedron, dodecahedron, and icosahedron dice made and inscribed with certain numbers, signs, and stars at opportune times under the celestial influences, obtain a wonderful divining virtue and predictions from throwing them, such as the Praenestian dice, in which were read the fates of the Romans.#t_footnote(<nt1817>, "nr1817")[7]
  ]
]
...
#character[
  ...
  #p_poetry[
    #emph[And carries the sacred vessel, I recognize his hair and chin quite gray#t_footnote(<nt1824>, "nr1824")[7]]
  ]
  #p_poetry[
  ...
  #p_normal[
    With these verses, his hope of acquiring the Empire was not in vain.#t_footnote(<nt1825>, "nr1825")[8]
  ]
  #p_normal[
    Likewise, among the Hebrews and us Christians, and not disapproved of by certain theologians, are lots taken from verses of Psalms. There are many more kinds of lots: there are human lots, which predict nothing, that are observed by the ancients and us and are also entrusted by laws in choosing magistrates to avoid causing envy.#t_footnote(<nt1826>, "nr1826")[9] Cicero also makes mention in 
#emph[In Verrem],#t_footnote(<nt1827>, "nr1827")[10] but this is not our intention.
  ]
  #p_normal[
...
#character[
  ...
  #p_poetry[
    #emph[Sacred movements, and steers with a silent reason.#t_footnote(<nt1828>, "nr1828")[1]]
  ]
  #p_normal[
    Likewise, Lucan:
  ]
  ...
  #p_poetry[
    #emph[Shared by the great Jove.#t_footnote(<nt1829>, "nr1829")[2]]
  ]
  #p_normal[
    And Boethius:
  ]
  ...
  #p_poetry[
    #emph[And changing the heavens with a like image.#t_footnote(<nt1830>, "nr1830")[3]]
  ]
  #p_normal[
  ...
  #p_poetry[
    #emph[As great harmful bodies do not hinder them.#t_footnote(<nt1831>, "nr1831")[4]]
  ]
  #p_normal[
    Indeed, why do these verses seem to refer to other wills, as the world not only has a spirit and soul, but also sharing the divine mind and the origin, virtue, and vigor of all inferiors, that depend on the World Soul?#t_footnote(<nt1832>, "nr1832")[5] All Platonists, Pythagoreans, Orpheus, Trismegistus, Aristotle, Theophrastus, Avicenna, Algazeles,#t_footnote(<nt1833>, "nr1833")[6] and all Paripatetics acknowledge and confirm this.#t_footnote(<nt1834>, "nr1834")[7]
  ]
]
...
#character[
  ...
  #p_normal[
    Perhaps they might say that life of this kind is not produced from the souls of earth or water, but from the influence of celestial spirits; Platonists answer to this that accident cannot generate a substance#t_footnote(<nt1836>, "nr1836")[2] unless by chance, such as with an instrument that is exposed near the substances—but they say “near the substances,” because an instrument apart from the artist cannot be moved according to the effect of the art.
  ]
  #p_normal[
    Thus also those celestial influences, since they are certain accidents far removed from their vital substances or from life itself, they will not generate vital substances in these inferiors.#t_footnote(<nt1837>, "nr1837")[3] Hermes [Trismegistus] wrote in his treatise #emph[Of the Common,] saying: “Everything that is in the world moves by increase or decrease.” Moreover, that which moves, therefore, lives. Since everything moves, also the earth—especially through generative and alterative motion—likewise lives. If one doubts the celestials live, Theophrastus said, they should not be thought as a philosopher,#t_footnote(<nt1838>, "nr1838")[4] and those who deny that the celestials are animated, therefore as a mover and not a form of it, destroys the foundations of all philosophy.#t_footnote(<nt1839>, "nr1839")[5] Therefore, the world lives, has a soul, and has perception. It accordingly gives life to [those] plants which are not generated from seed, and provides soul to [those] animals which are not born from intercourse.#t_footnote(<nt1840>, "nr1840")[6]
  ]
]
...
#character[
  ...
  #p_normal[
    That souls have reason, as we have said, is well known. The universal works of the souls, as we mentioned, conspire among themselves in a certain perpetual order. By necessity, they are not ruled by chance but by reason. According to that reason they direct and lead their operations toward certainties. Indeed, it is necessary that earth has reason of earthy things and water of watery things, and likewise in other things with each begetting in their time, place, and order, and often restoring injuries.#t_footnote(<nt1841>, "nr1841")[1]
  ]
  #p_normal[
    Therefore, philosophers do not think that the Earth Soul is like a soul of some mere body, but rational, intelligent, and additionally a goddess.#t_footnote(<nt1842>, "nr1842")[2] Besides, it is absurd if we have reasons for our operations, and celestial souls and the Universal Soul do not have reasons for theirs.#t_footnote(<nt1843>, "nr1843")[3] If, as Plato said, the world is made from the Good itself, then it is made as well as it can be. It surely shares not only life, perception, and reason, but also intelligence and mind.#t_footnote(<nt1844>, "nr1844")[4]
  ]
  #p_normal[
    Since the perfection of the body is the soul, and a more perfect body has a more perfect soul, it is therefore necessary that a celestial body—which is most perfect—also has the most perfect soul.#t_footnote(<nt1845>, "nr1845")[5] Therefore, they share an intellect and mind, which Platonists also prove by the persistence of [the celestials’] order and direction, because motion by their nature is free and easily able to be crooked, and in turn wander, unless regulated by an intelligence and mind. Indeed, that [mind] being perfect, it foresees from the beginning by the most chosen path, and the best ending. That perfect mind is the most powerful [attribute] of the soul. The World Soul, and the souls of the bodies of the celestials and elements, are as such without a doubt the most ordered and perfect for governing work appointed to them, since bodies do not resist more powerful souls, and perfect minds do not vary their deliberation.#t_footnote(<nt1846>, "nr1846")[6]
  ]
  #p_normal[
    Therefore, the World Soul is a certain single life filling everything, spreading over all, binding and connecting everything so that the whole world becomes one machine and as one instrument resounding from three kinds of creatures, intellectual, celestial and incorruptible,#t_footnote(<nt1847>, "nr1847")[7] with only one breath and one life.
  ]
]

#character[
  #p_title[
    Chapter 58. Of the names of the celestial souls and their lordship in this inferior world—namely man.#t_footnote(<nt1848>, "nr1848")[1]
  ]
  #p_normal[
  ...
  #p_normal[
    Likewise, in the elemental spheres, the souls are named in this way: in fire is placed Phanes and Aurora;#t_footnote(<nt1849>, "nr1849")[2] in air Jove, lord of lightning, and Juno; in water Oceanus and Thetys; in earth Pluto and Proserpina.#t_footnote(<nt1850>, "nr1850")[3]
  ]
  #p_normal[
    However, magicians call the World Soul or entire universe Jupiter of the World, the mind of the world is called Apollo, and the nature of the world is called Minerva; also, in fire Vulcan, in water Neptune:#t_footnote(<nt1851>, "nr1851")[4] and they named them with various names.
  ]
  #p_normal[
    Likewise in each of the twelve constellations of the zodiac, Pythagoreans placed particular gods or souls in the hearts of those constellations, and thus ruled the entire constellation—that is, in the heart of Aries a particular Pallas; in the heart of Taurus a particular Venus; in Gemini a particular Phoebus; in Cancer Mercury; in Leo Jupiter; in Virgo Ceres; in Libra Vulcan; in Scorpio Mars; in Sagittarius Diana; in Capricorn Vesta; in Aquarius a particular Juno; in the heart of Pisces a particular Neptune.#t_footnote(<nt1852>, "nr1852")[5] Thus, Manilius listed in his verses: #emph[Manilius.]
  ]
  #p_poetry[
  ...
  #p_poetry[
    #emph[And Jupiter faces Juno in Aquarius,]#t_footnote(<nt1853>, "nr1853")[6]
  ]
  #p_poetry[
    #emph[And Neptune in the sea recognizes his Pisces.]#t_footnote(<nt1854>, "nr1854")[7]
  ]
  #p_normal[
    The most ancient Orpheus writing to the most distinguished Musaeus enumerated these heavenly gods and their various names, considerations, and duties assigned to them and made individual appeals to them with hymns. Therefore, no one should think that these are the names of evil and deceptive daemons but rather natural and divine virtues distributed to the world by God for the ministry and usefulness of man who knows their usefulness.#t_footnote(<nt1855>, "nr1855")[8]
  ]
  #p_normal[
    And the ancients themselves appointed each of these deities to each of the members of man, for example, the ear to Memoriae,#t_footnote(<nt1856>, "nr1856")[9] and which Virgil dedicated to Phoebus saying: #emph[. . . My ear Cynthius,]
  ]
  #p_poetry[
    #emph[Pulled and warned me.]
  ]
  #p_normal[
    Thus, the right hand signifies strength and makes oaths, which Numa Pompilius said (as narrated by Livy) is consecrated to Faith. The fingers are under the tutelage of Minerva and the knees are given to Misericordia:#t_footnote(<nt1857>, "nr1857")[10] because those who come to pray bend them. Some dedicated the navel to Venus as the seat of luxury; others refer to it because it is the center to all the members, dedicate it to Jupiter; hence the effigy of an umbilicus is celebrated in the temple of Jupiter Ammon.#t_footnote(<nt1858>, "nr1858")[11] The ancients described many others, likewise their names are ascribed to each of the smallest members and joints; which if they are rightly understood and the true gods presiding over them recognized, nothing will alienate them from their loyal duty, since sacred speech testifies that all of our members are ruled by heavenly virtues,#t_footnote(<nt1859>, "nr1859")[12] of which more will be said in the following book.
  ]
  #p_normal[
  ...
  #p_poetry[
    #emph[Her faithful husband in the banks of the wide Nile.]#t_footnote(<nt1860>, "nr1860")[13]
  ]
]
...
#character[
  ...
  #p_normal[
    Additionally, there are seven governors of the world.#t_footnote(<nt1861>, "nr1861")[1] As Hermes said, they are Saturn, Jupiter, Mars, the Sun, Venus, Mercury, and the Moon—and these are called and invoked with various names and epithets.
  ]
  #p_quote[
    #emph[Saturn.]
  ]
  #p_normal[
    Saturn is called Coelius,#t_footnote(<nt1862>, "nr1862")[2] the scythe-bearer, father of the gods, lord of time, the lofty lord, the great, the wise, the intelligent, the ingenious, the orbiter#t_footnote(<nt1863>, "nr1863")[3] of a long space, old man of great profundity, author of secret contemplation, impressing or suppressing great thoughts in the hearts of men, destroying and preserving all, subverting and establishing strength and power, guard and revealer of the hidden, causer of loss and discovery, and author of life and death.
  ]
  #p_quote[
    #emph[Jupiter.]
  ]
  ...
  #p_normal[
    The Sun is called Phoebus, Diespiter,#t_footnote(<nt1864>, "nr1864")[4] Apollo, Titan, Pean, Phanes, Horus, Osiris,#t_footnote(<nt1865>, "nr1865")[5] as in that oracle:
  ]
  #p_poetry[
  ...
  #p_poetry[
    #emph[Highest king of the stars, and immortal fire.]#t_footnote(<nt1866>, "nr1866")[6]
  ]
  #p_normal[
    It is also called bow-carrier,#t_footnote(<nt1867>, "nr1867")[7] burning, fiery, golden, flame-bearing, radiant, fiery-haired, golden-haired, eye of the world, light-bringer,#t_footnote(<nt1868>, "nr1868")[8] seeing much, holding all, creator of light, king of the stars, the great lord, good, fortunate, distinguished, the world, aware, understanding, wise, glowing over the entire world, governing and vivifying all bodies that have a soul, prince of the world, keeping all of the stars under him, lighting all of the stars and obscuring their virtues by its nearness, burning and overcoming them,#t_footnote(<nt1869>, "nr1869")[9] yet by its light and splendor, it gives light and splendor to all.#t_footnote(<nt1870>, "nr1870")[10] At night he is called Dionysus, but in the day Apollo as if driving away evil; therefore, the Athenians called it Alexicacon#t_footnote(<nt1871>, "nr1871")[11] and Homer called it “Ulion”—that is, expeller of evil. However, it is called Phoebus because of its splendor and brightness, and Vulcan from its violent fire, because that power depends much on fire. But it is called the Sun because it contains the light of all the stars; hence, the Assyrians call it #t_img("./images/00158.jpeg") Adad, which signifies “alone” and from the Hebrews #t_img("./images/00159.jpeg") Schemesch, which is interpreted as “individual.”#t_footnote(<nt1872>, "nr1872")[12]
  ]
  #p_quote[
    #emph[Venus.]
  ]
  #p_normal[
    Venus is called the lady, nourishing, beautiful, starry, glittering, pretty, gentle, very powerful, fertile lady of love and beauty, original parent of the races of the world and men, who in the first beginning of things united the two different sexes in love, and with the eternal offspring of men and species of animals propagate daily, the queen of all delights, lady of joy, lady#t_footnote(<nt1873>, "nr1873")[13] of the friendly, female friend, merciful and receiving good, always perpetually beneficent to the mortal, mother of sweet affection, granting chance mercy, safeguarder#t_footnote(<nt1874>, "nr1874")[14] of the human species, allowing no moment of time pass empty of beneficence nor idle,#t_footnote(<nt1875>, "nr1875")[15] promising all of her virtues, humbling the high to the low, strengthening the weak, the noble to the mean, rectifying and equalizing all. She is also called Aphrodite because, in all sexes, she is found in every mind. She is named Lucifera, as it were, a bringer of the light of the Sun, or leading us to the light.#t_footnote(<nt1876>, "nr1876")[16] She is called Hesperus when she follows the Sun, and she is called Phosphorus, by uniting everything however difficult.#t_footnote(<nt1877>, "nr1877")[17]
  ]
  #p_quote[
    #emph[Mercury.]
  ]
  #p_normal[
    Mercury is called the son of Jupiter, herald of the gods, interpreter of heaven, Stilbon,#t_footnote(<nt1878>, "nr1878")[18] the serpent-bearer, the staff-bearer, the wingfooted, eloquent, bringer of wealth, wise, rational, valiant, strenuous, powerful in good and evil, notary to the Sun, messenger of Jupiter, communicator between the gods above and below, male with men, female with women, fertile with both sexes#t_footnote(<nt1879>, "nr1879")[19]; and Lucan called him the arbiter of the gods. He is also called Hermes—that is, the interpreter, enlightening all that is dark and uncovering all that is hidden in inner places.#t_footnote(<nt1880>, "nr1880")[20]
  ]
  #p_quote[
    #emph[The Moon.]
  ]
  #p_normal[
    The Moon is called Phoebe, Diana, Lucina, Proserpina, Hecate, menstrua, a semi-form, evening light,#t_footnote(<nt1881>, "nr1881")[21] wandering, silent, two-horned, safeguarder, night-wanderer, horn-bearer, queen of heaven, the highest of gods, first of the heavenly gods and goddesses, queen of the underworld, lady of all of the elements, she whom the stars answer, returning times, serving elements, with whose nod lightnings breathe forth, sprouting seeds, growing buds, original parent of crops, sister of Phoebus, shining and brilliant, carrying light from one planet to the rest, illuminating all of the deities with her light, confining the various movements of the stars, dispensing ever-changing lights by the circuit of the Sun, lady of great beauty, lady of rain and waters, giver of wealth, nurse of men, governor of all positions, pious and merciful, protecting men at land and sea, mitigating tempests with fortune, dispensing with fate, nurturing all that is born on the earth, wandering through various sacred groves, confining attacks from larvae, holding fast the gates of the earth, the culminating brilliance of heaven, the healthful winds#t_footnote(<nt1882>, "nr1882")[22] of the sea, her nod managing the deplorable silence of hell, ruling the world, treading upon Tartarus, whose majesty makes the birds flying in the sky, beasts wandering in the mountains, serpents hiding alone, and beasts swimming in the sea all shudder.#t_footnote(<nt1883>, "nr1883")[23]
  ]
  #p_normal[
...
#character[
  ...
  #p_normal[
    For example: the Sun, the king of the stars, most full of light, receives from the intelligible world over all other stars, because its soul is more capable of intelligible splendor; for which reason, if one wishes to attract the Sun’s influences, they must contemplate the Sun not only by speculating its outer light, but also its inner light. No one can do this, unless they return themselves to the intellect of the Sun and avoid that which is not similar, seeing the intellectual, and comprehending that intelligible light, as with the corporeal eye with sensible light. In this way he will be filled with that splendor and light, which is a hypotype,#t_footnote(<nt1887>, "nr1887")[4] impressing from the heavenly orb, receiving into itself. He is endowed with this enlightenment, truly they are equal and as if being helped by it. On behalf of the vow, his intellect will follow that supreme brightness and all forms participating with it.#t_footnote(<nt1888>, "nr1888")[5] When he has drawn from the light of the supreme degree, then his soul approaches that perfection, and assimilates the spirits of the Sun, and reaches the virtues and enlightenments of the supernatural virtue and profits by their power, if he has obtained faith in the First Author.
  ]
  ...
  #p_normal(center: true)[
    because of our bodies.#t_footnote(<nt1889>, "nr1889")[6]
  ]
]
