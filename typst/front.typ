...
#emph[Three Books of Occult Philosophy] contains the concentrated essence of the wisdom of myriad esoteric traditions. As Agrippa says in his letter of dedication to Book Three:
  ...
  #p_quote[
    I am also indebted to the divine and ceremonial mysteries of magic . . . of those ancient Isiac priests of the Egyptians, the ancient Chaldean prophets of the Babylonians, and divine wise Hebrew kabbalists. I am also [indebted to] the Orphics, Pythagoreans, and Platonists, profound Greek philosophers, Indian Brahmans, Ethiopian Gymnosophists, and our undefiled religious theologians.#t_footnote(<nt2>, "nr2")[2]
  ]
  #p_normal[
...
#emph[Three Books of Occult Philosophy] is; the title itself and organization into three books reveals Agrippa’s vision of the threefold manifestation of reality.
  ...
  #p_quote[
    There is a threefold world—that is, the elemental, celestial, and intellectual. Each inferior is ruled by its superior, accepting virtues flowing from the Archetype and highest Maker through angels, the heavens, stars, elements, animals, plants, metals, and stones.#t_footnote(<nt4>, "nr4")[4]
  ]
  #p_normal[
  ...
  #p_quote[
    Therefore, the elements are found everywhere and in everything, and no man can deny their manner. First, in the inferiors, they are feculent and dense, and in the heavens, they are pure and clear, and in the super-celestials, they are truly living and in all parts blessed.#t_footnote(<nt5>, "nr5")[5]
  ]
  #p_normal[
