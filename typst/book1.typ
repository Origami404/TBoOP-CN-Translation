...
#character[
  ...
  #p_normal(italic: true)[
    R.P.D.#t_footnote(<nt18>, "nr18")[1] Johannes Trithemius, abbot of Saint James in the suburbs of Wurzburg,#t_footnote(<nt19>, "nr19")[2] Heinrich Cornelius Agrippa of Nettesheim sends greetings.
  ]
  #p_normal[
...
#character[
  ...
  #p_normal[
    #emph[Then, so that you will go on even higher than where you began, and so that you will not allow your excellent talents to grow tepid from leisure, we earnestly advise, beg, and ask you that you always work toward improvement and the true light of wisdom, so that you are illuminated powerfully and divinely, and that you will demonstrate this to the ignorant. Nor shall you withdraw your intentions from the gaze of worthless people, of whom the true saying is “The tired ox stamps his foot strongly”]#t_footnote(<nt30>, "nr30")[1] #emph[since no wise man can truly be judged as learned who is sworn only to the rudiments of one skill.]
  ]
  #p_normal[
...
#character[
  ...
  #p_normal(italic: true)[
    Venerable father in Christ, and illustrious Count Hermann#t_footnote(<nt32>, "nr32")[1] of Weid,#t_footnote(<nt33>, "nr33")[2] by the grace of God archbishop of the holy Church of Cologne, prince elector of the Holy Roman Empire and chief chancellor of Italy, and servant of the Duke of Westphalia,#t_footnote(<nt34>, "nr34")[3] etc., born legate of the Holy Roman Church and pontiff of the vicar general, Heinrich Cornelius Agrippa sends greetings.
  ]
  #p_normal[
  ...
  #p_normal(center: true)[
    #emph[Mechlin#t_footnote(<nt35>, "nr35")[4]] 1531, January.
  ]
]
...
#character[
  ...
  #p_normal[
    There is a threefold world—that is, the elemental, celestial, and intellectual. Each inferior is ruled by its superior,#t_footnote(<nt36>, "nr36")[1] accepting virtues flowing from the Archetype and highest Maker through angels, the heavens, stars, elements, animals, plants, metals, and stones. The Maker transfers His omnipotent virtue into us, for whose service He placed and created all of these. Wise men do not find it irrational that we can rise by these same degrees, through each world, toward the same archetypal world, the Maker of all and the First Cause, from which everything exists and all proceeds. Not only can more noble things profit from these virtues, but they can also attract new virtues from above.#t_footnote(<nt37>, "nr37")[2]
  ]
  #p_normal[
...
#character[
  ...
  #p_normal[
    Magical ability possesses great power,#t_footnote(<nt38>, "nr38")[1] full of the highest mysteries, contemplating profound secret things, natures, powers, qualities, substances, and virtues, combined with the understanding of all of nature. It instructs us on how things are different from each other and how they agree. Wonderful effects are produced from magic, uniting virtues by applying things with each other and by accepting their congruity,#t_footnote(<nt39>, "nr39")[2] and everywhere binds and marries inferior and superior gifts and virtues. This is the most perfect and highest science, the highest and most sacred philosophy. Finally, it is the absolute consummation of the noblest philosophy, for all regulative philosophy is divided into natural science, mathematics, and theology.
  ]
  #p_normal[
    Natural science teaches about the nature of the world#t_footnote(<nt40>, "nr40")[3] and its causes, investigating and probing its effects, times, places, manner, events, its whole, and its parts.#t_footnote(<nt41>, "nr41")[4]
  ]
  #p_poetry[
  ...
  #p_normal[
    Natural science, the watcher of nature, embraces all of these.#t_footnote(<nt42>, "nr42")[5] Virgil sings: #emph[From where do the kinds of men and animals, and rain and fire come,]#t_footnote(<nt43>, "nr43")[6]
  ]
  #p_poetry[
    #emph[From where does the earth tremble, why the strong sea swells high]
  ]
  #p_poetry[
    #emph[Breaking its barriers and subsiding again.]#t_footnote(<nt44>, "nr44")[7]
  ]
  #p_poetry[
    #emph[The power of herbs, the angry soul of beasts,]
  ]
  #p_poetry[
    #emph[All kinds of fruit, stones, and reptiles.]#t_footnote(<nt45>, "nr45")[8]
  ]
  #p_normal[
    Mathematics teaches us of planes and the understanding of nature’s movements—projecting it in three dimensions—and also the admiration of celestial progressions.#t_footnote(<nt46>, "nr46")[9]
  ]
  #p_poetry[
  ...
  #p_poetry[
    #emph[And suffer eclipses, blocking the light of the Sun . . .]#t_footnote(<nt47>, "nr47")[10]
  ]
  #p_normal[
    And Virgil sings:
  ]
  ...
  #p_poetry[
    #emph[Through the twelve, the golden Sun rules the stars]#t_footnote(<nt48>, "nr48")[11]
  ]
  #p_poetry[
    #emph[It shows the heavenly road and the stars]
  ]
  #p_poetry[
    #emph[The Solar eclipses and various labors of the Moon,]#t_footnote(<nt49>, "nr49")[12]
  ]
  #p_poetry[
    #emph[Arcturus and Pleiades, the Hyades and twin bears;]#t_footnote(<nt50>, "nr50")[13]
  ]
  #p_poetry[
    #emph[Why the winter Sun hurries to sink into the great sea]
  ]
  #p_poetry[
    #emph[Or what makes the nights long]#t_footnote(<nt51>, "nr51")[14]
  ]
  #p_normal[
  ...
  #p_poetry[
    #emph[Or the time to overturn the pines in the woods.]#t_footnote(<nt52>, "nr52")[15]
  ]
  #p_normal[
    But theology teaches about God Himself, what is Mind, what are the intelligences, what are angels, what are daemons,#t_footnote(<nt53>, "nr53")[16] what is the soul, what is religion, what are sacred institutions, rites, sanctuaries, observations, and sacred mysteries. In addition, it instructs us about faith, miracles, the virtues of words and figures, about secret operations and mysteries of seals, and as Apuleius said, teaches us to “duly know and understand ceremonial law, sacred divine will, and even binding religious law.”#t_footnote(<nt54>, "nr54")[17]
  ]
  #p_normal[
    But now I have to collect myself. These three powerful faculties of magic embrace, unite, and actuate.#t_footnote(<nt55>, "nr55")[18] Therefore, the ancients valued magic as the highest and most sacred science.#t_footnote(<nt56>, "nr56")[19] It is found illuminated clearly in the writings of these important writers, especially Zalmoxis and Zoroaster, who shined forth to such an extent that many believed that they were the inventors of this science.
  ]
  #p_normal[
    These writers followed in their footsteps: Abaris the Hyperborean, Charmondas, Damigeron, Eudoxus, Hermippus. Other authors clearly stand out, such as Hermes Trismegistus, Porphyry, Iamblichus, Plotinus, Proclus, Dardanus, Orpheus the Thracian, Gog the Greek, Germa the Babylonian, and Apollonius of Tyana.#t_footnote(<nt57>, "nr57")[20] Osthanes, whose books Democritus of Abdera plucked out of the grave and embellished with commentaries, is also an exceptional writer in this art.#t_footnote(<nt58>, "nr58")[21]
  ]
  #p_normal[
    In addition, Pythagoras, Empedocles, Democritus, and Plato traveled to learn this noble philosophy, and they returned proclaiming that its teachings held the highest sanctity and secrets.#t_footnote(<nt59>, "nr59")[22] In fact, Pythagoras and Plato approached Memphite prophets to acquire knowledge and traveled through almost all of Syria, Egypt, Judea, and the Chaldean schools so that they would be instructed in the sacred magical records and divine things.#t_footnote(<nt60>, "nr60")[23]
  ]
  #p_normal[
    Therefore, whoever means to study these faculties, if they are not educated in natural philosophy—in which the qualities of things are declared and in which one can reveal hidden qualities of anything that exists—and if they are not a worker in mathematics and in the aspects and figures of the stars, from which anything with a sublime virtue and quality depends, and if they are not skilled in theology, where immaterial substances are shown, which all are dispensed and administered, they cannot understand the rationale of magic.#t_footnote(<nt61>, "nr61")[24] Indeed, there is no perfect work in magic or any work that is truly magical that does not embrace these three faculties.
  ]
]
...
#character[
  ...
  #p_normal[
    There are four elements as we have said, without perfect notice of which we can effectively produce nothing perfect in magic. Each of the elements is threefold. As such, four of each becomes twelve, through seven into the number ten, and they proceed to supreme unity.#t_footnote(<nt69>, "nr69")[1] All virtues and wonderful operations depend on the elements, and progressions happen from them.
  ]
  #p_normal[
...
will easily possess the knowledge of all natural things and perfect operation of celestial secrets.#t_footnote(<nt70>, "nr70")[2]
  ]
]
...
#character[
  ...
  #p_normal[
    But Boreas the north wind is opposite to Notus, violent and noisy, who shatters the clouds, then becomes serene air, and binds water with frost.#t_footnote(<nt102>, "nr102")[22] Ovid introduced him thus: #emph[With ready strength, I drive away the gloomy clouds,]
  ]
  #p_poetry[
  ...
  #p_poetry[
    #emph[Globe . . .]#t_footnote(<nt103>, "nr103")[23]
  ]
  #p_normal[
  ...
  #p_normal[
    To the opposite is Eurus, who is also Subsolanus and Apeliotes, from the east, a humid wind, cloudy and rapidly voracious;#t_footnote(<nt104>, "nr104")[24] of this Ovid sang: #emph[At dawn, Eurus recedes from the kingdoms of Nabatea]
  ]
  #p_poetry[
  ...
  #p_poetry[
    #emph[Are closest to Zephyrus; Scythia and the seven plow oxen]#t_footnote(<nt105>, "nr105")[25]
  ]
  #p_poetry[
    #emph[The frightful Boreas invades, against the earth]
  ]
  #p_poetry[
    #emph[With constant clouds becoming wet with rain from the south.]#t_footnote(<nt106>, "nr106")[26]
  ]
]
...
#character[
  ...
  #p_normal[
    Among animals, there are some earthly ones that stand out from the others, because they live in the heart of the earth, such as vermin, worms, moles, and many reptiles. Others are watery, such as fish. Others are airy and are unable to live outside of the air. Some are fiery, inhabiting fire, such as the salamander and some cicadas (which are called 
		#emph[pyraustae]),#t_footnote(<nt111>, "nr111")[5] and others who boil with a certain heat, such as pigeons, ostriches, and lions,#t_footnote(<nt112>, "nr112")[6] which the #emph[Book of Wisdom] calls “beasts that breathe with a fiery vapor.”#t_footnote(<nt113>, "nr113")[7] Additionally, in animals, bones refer to earth, flesh to air, the vital spirit to fire, and the humors to water. These also share from the elements: for red#t_footnote(<nt114>, "nr114")[8] cholera belongs to fire, blood is air, phlegm is water, and black bile is earth. Finally, in the soul itself, as Augustine testified, the intellect refers to fire, reason to air, imagination to water, and indeed the senses to earth. Also [the senses] are distributed together among the elements: for vision is fiery, for it cannot perceive without fire and light. Hearing is airy, for sound is made from striking the air. Smell and taste refer to water, for without moisture neither smell nor taste happens. Finally, touch is entirely earthy, as it receives dense bodies for itself.#t_footnote(<nt115>, "nr115")[9] Likewise, the elements guide the actions and operations of man. Indeed, slow and dense motion is signified by earth; fear, ignorance, and relaxed operations by water; a cheerful and friendly character by air; sharp impetuosity and anger by fire.#t_footnote(<nt116>, "nr116")[10]
  ]
  #p_normal[
...
#character[
  ...
  #p_normal[
    It is the unanimous opinion of all Platonists that, as in the archetype of the world all things are in all,#t_footnote(<nt117>, "nr117")[1] so also all things in the corporeal world are in all. Yet it is thus in different ways—that is, by according to the natures of these things.#t_footnote(<nt118>, "nr118")[2] Thus, the elements are not only in these inferior [bodies] but also in the heavens, in the stars, in daemons, in angels, and finally in the Maker and Originator of all.
  ]
  #p_normal[
    In these inferior [bodies], the elements are of certain dense forms: heavy matter and the material elements.
  ]
  #p_normal[
    In the heavens, the elements have their [own] natures and virtues—that is, with a heavenly and more excellent manner than the sublunary. Heavenly earth has solidity without density; water and air have agility and flow from a distance; fire has heat without burning, but it illuminates everything, and its heat gives life.#t_footnote(<nt119>, "nr119")[3]
  ]
  #p_normal[
    Of the stars, Mars and the Sun are fiery, Jupiter and Venus are airy, and Saturn and Mercury are watery. The Earth inhabits the eighth sphere with the Moon, which is thought of by most as watery. Clearly, the earthly image is attracted to the celestial waters. [The Moon] drinks from [these waters] and by its close proximity [they] flow onto us and are shared with us.#t_footnote(<nt120>, "nr120")[4]
  ]
  #p_normal[
    Among the signs, some are fiery, some are earthy, some are airy, some are watery. The four elements rule the triplicities of the heavens, distributing each element to the first, the middle, and end. Thus, the first for the fiery [triplicity] is Aries, progressing and increasing to Leo, and finally to Sagittarius. The first earthy [triplicity] is Taurus, progressing to Virgo, and last to Capricorn. The first airy [triplicity] is Gemini, progressing to Libra, and ending in Aquarius. The first watery [triplicity] is Cancer, the middle is Scorpio, and Pisces has the end.#t_footnote(<nt121>, "nr121")[5]
  ]
  #p_normal[
    Therefore, all bodies are made from the mixtures of the planets and signs together with the elements.
  ]
  #p_normal[
    According to this reasoning, daemons are distinguished from each other. As such, some are called fiery, others earthy, others airy, and others watery.#t_footnote(<nt122>, "nr122")[6] Hence there are the four infernal rivers: fiery Phlegethon, airy Cocytus, watery Styx, and earthy Acheron.#t_footnote(<nt123>, "nr123")[7]
  ]
  #p_normal[
    We read in the Gospels of the “fire of hell”#t_footnote(<nt124>, "nr124")[8] and “the eternal fire where the cursed are ordered to go.”#t_footnote(<nt125>, "nr125")[9] We also read in Revelation about the “lake of fire,”#t_footnote(<nt126>, "nr126")[10] and Isaiah spoke of the damned, saying that: “The Lord will strike you with corrupt air.”#t_footnote(<nt127>, "nr127")[11] In Job [we read]: “They will jump from extreme heat to snowy waters.”#t_footnote(<nt128>, "nr128")[12] We also read [in Job] “the land of darkness and covered with the mist of death, the land of misery and darkness.”#t_footnote(<nt129>, "nr129")[13]
  ]
  #p_normal[
    Also, the elements are placed over the angels of the universe and the blessed intelligences. Indeed, the essence of stability is in them—an earthy virtue, in which is the firm seat of God; also their pious mercy, a [kind of] watery cleansing virtue.#t_footnote(<nt130>, "nr130")[14] Hence the Psalms spoke of water, where it says of the heavens: “you cover its heights with water.”#t_footnote(<nt131>, "nr131")[15] Also in them is air, the subtle spirit, love, and a shining fire.
  ]
  #p_normal[
    Hence, they are called in the sacred scriptures “the wings of the wind,”#t_footnote(<nt132>, "nr132")[16] and elsewhere in the Psalms it says: “Makes your angels spirits, and your ministers a burning fire.”#t_footnote(<nt133>, "nr133")[17]
  ]
  #p_normal[
    Likewise, of the angelic orders, fire is the Seraphim, Virtues, and Powers; earth the Cherubim; water the Thrones and Archangels; air the Dominations and Principalities.#t_footnote(<nt134>, "nr134")[18]
  ]
  #p_normal[
    Do we not also read about the Archetype, the Maker of all things: “Let the earth open and bring forth a savior”?#t_footnote(<nt135>, "nr135")[19] Surely [the Scriptures speak of a]: “fountain of living water, cleansing and regenerating.”#t_footnote(<nt136>, "nr136")[20] And is not the spirit breathing the same breath of life#t_footnote(<nt137>, "nr137")[21] and which also, as Moses and Paul testify, is a “consuming fire”?#t_footnote(<nt138>, "nr138")[22]
  ]
  #p_normal[
    Therefore, the elements are found everywhere and in everything, and no man can deny their manner. First, in the inferiors, they are feculent and dense, and in the heavens, they are pure and clear, and in the super-celestials, they are truly living and in all parts blessed.#t_footnote(<nt139>, "nr139")[23] Therefore, the elements are produced in the Archetypal Idea, are distributed powers in the intelligences, are virtues in the heavens, and are dense forms in the inferiors.
  ]
  #p_quote[
...
#character[
  ...
  #p_normal[
    There are also other virtues in things that are not from any element, such as driving away poison, driving away open sores,#t_footnote(<nt144>, "nr144")[1] attracting iron, or other things. These virtues are the result of the appearance and form of this or that thing,#t_footnote(<nt145>, "nr145")[2] and though being small in quantity, they are not small in conducting their effects, which are not given to any elemental quality. These virtues, because they have many forms, can therefore do much with little matter. But an elemental virtue, because it is material, uses more to act, and also needs more matter.#t_footnote(<nt146>, "nr146")[3]
  ]
  #p_normal[
    They are called occult qualities, because their causes are hidden, and because human intellect cannot entirely investigate them—whereby the greater number of philosophers attained this from very long experience rather than from searching by reason.#t_footnote(<nt147>, "nr147")[4]
  ]
  #p_normal[
  ...
  #p_normal[
    There are, in things we recognize, certain other innate virtues beyond the elemental qualities created by nature, which we admire and often amaze us, though we may not know or rarely see [such things], such as the phoenix,#t_footnote(<nt148>, "nr148")[5] the only bird that renews itself, of which we read in Ovid:
  ]
  #p_poetry[
    #emph[There is one bird that renews and reproduces itself]
  ]
  #p_poetry[
    #emph[Which the Assyrians call the phoenix . . .]#t_footnote(<nt149>, "nr149")[6]
  ]
  #p_normal[
    And elsewhere:
  ]
  ...
  #p_poetry[
    #emph[And the crowd rejoiced to greet this rare bird.]#t_footnote(<nt150>, "nr150")[7]
  ]
  #p_normal[
    Matreas once brought a great wonder to the Greeks and the Romans. He said he nourished the beast before him, who swallowed itself, and to this day many [people] anxiously search for the beast of Matreas.#t_footnote(<nt151>, "nr151")[8] Who would not marvel at the fishes dug from the earth, which Aristotle,#t_footnote(<nt152>, "nr152")[9] Theophrastus,#t_footnote(<nt153>, "nr153")[10] and Polybius#t_footnote(<nt154>, "nr154")[11] the historian mention? Also [wonderful are] the singing stones about which Pausanias#t_footnote(<nt155>, "nr155")[12] wrote. All of these works are occult virtues. The ostrich digests and distributes cold and hard iron into nourishment for its body, whose stomach it is said is not hurt by red-hot iron.#t_footnote(<nt156>, "nr156")[13] The small fish known as the echeneis stops the impetuous wind and subdues the rage of the sea. However great, commanding, raging, and boundless these storms may be, stretching the sails of ships from the wind, the touch of that fish restrains and forces ships to stand, so that they are unable to move in any way.#t_footnote(<nt157>, "nr157")[14]
  ]
  #p_normal[
    Thus, of small creatures, salamanders and pyraustae live in fire, and though they seem to burn, they are not harmed. Similarly, there is a certain bitumen, which is said to have been smeared all over the armor of the Amazons, that neither iron nor fire would loosen. [This bitumen] was also said to have been smeared over the bronze gates of Caspia by Alexander the Great.#t_footnote(<nt158>, "nr158")[15] It is also said that Noah sealed the Ark with bitumen and that it endured more than a thousand years on the mountains of Armenia.#t_footnote(<nt159>, "nr159")[16]
  ]
  #p_normal[
    There are many others of these [sorts of things] that are scarcely credible, yet from experience are recognized. [For example] the ancients mention satyrs, which are animals with a figure half human and half brute yet are capable of speech and reasoning. One of these spoke to Saint Anthony the hermit and condemned the error of the gentiles for worshipping common animals as he begged him to pray to God on his behalf. Saint Jerome recorded this, and he affirms that one was once seen alive in public and was chosen to be sent to the emperor Constantine.#t_footnote(<nt160>, "nr160")[17]
  ]
]
...
#character[
  ...
  #p_normal[
    According to Platonists, all inferior ideas come from superior Ideas.#t_footnote(<nt161>, "nr161")[1] 
They define an Idea as a form above bodies, souls, minds; singular, simple, pure; unchangeable, indivisible, incorporeal, and eternal. The nature of all Ideas is the same.
  ...
  #p_normal[
    Thus, all Ideas in God are indeed one form, but in the World Soul, they are many. They are then placed in minds (or connected with bodies, or separate from bodies) with a certain participation, and by degrees, they are distinguished more and more. They are placed in nature as a certain inferior seed of forms infused by Ideas, and they are finally placed in matter as shadows.#t_footnote(<nt162>, "nr162")[2] In addition to this, there are as many seminal reasons of things in the World Soul as there are ideas in the Divine Mind. For this reason, it built figures in the heavens above the stars and impressed into them all of its qualities.#t_footnote(<nt163>, "nr163")[3] Therefore these figures, qualities, and all inferior kinds of virtues depend upon these stars. Thus, as every species has a celestial figure appropriate to it, from which comes a wonderful power of operation,#t_footnote(<nt164>, "nr164")[4] and through the seminal method of the World Soul, it receives a gift from its own Idea.#t_footnote(<nt165>, "nr165")[5]
  ]
  #p_normal[
  ...
  #p_normal[
    Indeed, these virtues, which are the operations of Ideas, do not err unless by accident—that is, from impurities and the inequality of matter. In this way, things are found more or less powerful in the same species according to the purity or confusion of matter. Indeed, all celestial influences can hinder through the confusion and unfitness of matter.#t_footnote(<nt166>, "nr166")[6] About this, there is a Platonic proverb [that says]: the merits of matter are infused by the celestial virtues, and which Virgil remembered in his poem:
  ]
  #p_poetry[
    #emph[Fire is their power and their heavenly source]
  ]
  #p_poetry[
    #emph[As great harmful bodies do not hinder them.#t_footnote(<nt167>, "nr167")[7]]
  ]
  #p_normal[
    Whereby those things that are less immersed in the material Idea—that is, taking a greater similarity with [things] that are separate—have powerful virtues in operating, like an operation of a separated Idea. Therefore, we know that the placement and figure of the celestials are the cause of all noble virtues that are in more inferior species.#t_footnote(<nt168>, "nr168")[8]
  ]
]
...
#character[
  ...
  #p_normal[
    There are singular individuals and many gifts that are as remarkable as in the [entire] species, which are also from the figures of the heavens and stars.#t_footnote(<nt169>, "nr169")[1] Indeed all individuals, when they start [life] under a determined horoscope#t_footnote(<nt170>, "nr170")[2] and celestial constellation,#t_footnote(<nt171>, "nr171")[3] assemble with certain extraordinary virtues of labor and suffering, a wondrous thing. And they also receive [virtues] from their species, through celestial influences,#t_footnote(<nt172>, "nr172")[4] and then through the obedience of generated matter and from the World Soul. Such is the quality of the obedience of our bodies and souls. Indeed, we see this in ourselves, because to whatever form we conceive, we move our body with delight, horror, or fear; then frequently heavenly souls, when diversely conceived, matter obediently moves toward them.
  ]
  #p_normal[
    Also, many prodigies appear in nature from the imagination of superior motions; and likewise, different virtues that are in no way natural things, but are conceived artificial things, especially if the soul of the operator strives to the same. About this, Avicenna said: “Whatever is made must preexist before the motion and conception of the stars and orbs.”#t_footnote(<nt173>, "nr173")[5]
  ]
  #p_normal[
    Thus, the various effects of things, inclinations, and customs are not only disposed from various materials, as most suppose, but also from the influence of various and diverse forms—indeed not specific differences, but particular and individual. And these degrees are variously distributed by God the First Cause, “who distributes the rest to each as He wishes.” Yet He cooperates with the second causes, the angelic, and celestial, disposing corporeal matter and connecting all other things.#t_footnote(<nt174>, "nr174")[6] Therefore, God infuses all virtues through the World Soul, yet by a particular virtue of images and presiding intelligences, the coursing rays and the aspects of the stars, and a certain agreeing harmony.#t_footnote(<nt175>, "nr175")[7]
  ]
]
...
#character[
  ...
  #p_normal[
    It is well known to all that there is a certain virtue in lodestones#t_footnote(<nt176>, "nr176")[1] that attracts iron and that the presence of a diamond destroys that virtue.#t_footnote(<nt177>, "nr177")[2] Additionally, amber and the balas ruby#t_footnote(<nt178>, "nr178")[3] draw chaff when rubbed. The stone asbestos once kindled cannot be or can hardly be extinguished. The carbuncle#t_footnote(<nt179>, "nr179")[4] shines in darkness. The stone aetite#t_footnote(<nt180>, "nr180")[5] placed above a pregnant woman or [fruit from a] plant strengthens them; if under [the woman or fruit], destroys#t_footnote(<nt181>, "nr181")[6] them. Jasper#t_footnote(<nt182>, "nr182")[7] stops bleeding. The echeneis#t_footnote(<nt183>, "nr183")[8] stops ships. Rhubarb expels choler.#t_footnote(<nt184>, "nr184")[9] A chameleon’s liver burned on the top of a roof raises rain and thunder.#t_footnote(<nt185>, "nr185")[10] The stone heliotrope blinds#t_footnote(<nt186>, "nr186")[11] the eyes and makes the wearer invisible. The stone #emph[lyncurius] removes deceptions from the eye.#t_footnote(<nt187>, "nr187")[12] A fumigation of liparis summons all beasts.#t_footnote(<nt188>, "nr188")[13]#emph[Synochitides] summon infernal shades, but #emph[anachitides] makes the images of gods appear.#t_footnote(<nt189>, "nr189")[14] The 
#emph[ennectis]#t_footnote(<nt190>, "nr190")[15] placed under someone causes oracular dreams.#t_footnote(<nt191>, "nr191")[16]
  ]
  #p_normal[
    There is an Ethiopian herb that dries pools and causes everything to be uncovered; and there is an herb called #emph[latacem]#t_footnote(<nt192>, "nr192")[17] that Persian kings gave to their legates so that wherever they go they will have an abundance of things.#t_footnote(<nt193>, "nr193")[18] There is a Spartan#t_footnote(<nt194>, "nr194")[19] or Scythian herb, that when tasted or even held to the mouth, will allow the Scythians to endure twelve days of hunger and thirst.#t_footnote(<nt195>, "nr195")[20] Apuleius said that he was taught well by God#t_footnote(<nt196>, "nr196")[21] that there were many kinds of herbs and stones, which can give perpetual life to men: but could not speak of this knowledge for men to understand it, since men have a short time to live, eagerly desire evil, and do nothing that is not wicked. If their time is extended, the gods themselves would not be spared.#t_footnote(<nt197>, "nr197")[22]
  ]
  #p_normal[
  ...
  #p_normal[
    Consequently, the Academy together with Plato attributed these virtues to Ideas, the fashioner#t_footnote(<nt198>, "nr198")[23] of things. But Avicenna reduced these operations to intelligences, Hermes to the stars, and Albertus to the specific forms of things. Although these authorities saw each other as adversaries, none of them—if correctly understood—departed from the truth, since all spoke to the same effect in most respects.
  ]
  #p_normal[
...
#emph[Timaeus]) and are carried by the stars. Then the Giver of Forms distributes them through the ministry of his intelligences, which He placed as rulers and guardians over his works to whom he entrusted the faculty in things, such as the virtue of all stones, herbs, metals and all other things that are from the presiding intelligences.
  ...
  #p_normal[
    Thus, the fire in the Chaldean’s furnace did not consume the children; thus, by Joshua’s command the Sun receded from its course for the space of one day; thus, from the petition of Hezekiah it receded for ten degrees, or ten hours; and thus from the suffering of Christ the full Moon darkened the Sun.#t_footnote(<nt201>, "nr201")[26] In the accounts of these operations, no rational discourse, no magic, no great occult or profound science can investigate or attain. They are only learned about and inquired into by divine oracles.
  ]
]
...
#character[
  ...
  #p_normal[
    Democritus, Orpheus, and many Pythagoreans carefully studied the celestial virtues and inferior natures, saying that all things are full of gods:#t_footnote(<nt202>, "nr202")[1] not without cause, since there is nothing that is of such excellent virtue and devoid of divine assistance that it is content with its own nature.#t_footnote(<nt203>, "nr203")[2] But they called divine virtues in a variety of things “gods,” which Zoroaster called “false gods” and Synesius called “symbolic allurements.”#t_footnote(<nt204>, "nr204")[3] Others called them “living,” and still others called them “souls.” The qualities of things were said to depend on these virtues, because it is only the soul that operates by extending from one matter out to many things around it, as in man who extends his intellect to the intelligible, and his imagination to the imaginable.
  ]
  #p_normal[
  ...
  #p_normal[
    It is true that the soul is the #emph[Primum Mobile,]#t_footnote(<nt205>, "nr205")[4] moving by its own will.#t_footnote(<nt206>, "nr206")[5] However, the body or matter is unable to move by itself, and if separated from the soul will degenerate. Therefore, they consider the operation more excellent with a medium (such as something that was almost not a body but now almost a soul, or something that is almost not a soul but now almost a body) so that clearly the soul is connected to the body.#t_footnote(<nt207>, "nr207")[6]
  ]
  #p_normal[
    They imagine that such a medium is the World Spirit, which is what we call the quintessence,#t_footnote(<nt208>, "nr208")[7] because it is not from the four elements but is a certain fifth, subsisting above and beyond them. Therefore, in such a spirit, it is necessary to require a medium for celestial souls to belong to dense bodies and grant wonderful gifts.
  ]
  #p_normal[
    Indeed, this spirit is close to what is in the body of the world, as is what is in our human bodies. In the same way as the virtues of our souls are applied to the members [of our bodies], the virtues of the World Soul are extended to everything by the quintessence. Nothing is found in the entire universe that is without a spark of its virtue. It is greatly, and indeed most greatly, infused into those things that have drawn the most from the spirit;#t_footnote(<nt209>, "nr209")[8] drawing from the stellar rays, inasmuch as things make themselves conform to them.
  ]
  #p_normal[
  ...
  #p_normal[
    For this reason, alchemists try to separate spirit from gold and silver. When they are duly removed and extracted, if afterward there was any matter of the same kind, this was added to any metal. [By doing this,] gold and silver were immediately made.#t_footnote(<nt210>, "nr210")[9] We have learned how to make this and have sometimes seen it but were not able to make more gold, unless it was the same weight as that from which the spirit was extracted. Since spirit is an extending form and not contracting,#t_footnote(<nt211>, "nr211")[10] it cannot change an imperfect body into a perfect one beyond its measure. I will not deny this, yet it might be possible by a different art.
  ]
]
...
#character[
  ...
  #p_normal[
    It is well known that the qualities of occult things are not from elemental natures but are engrafted by the heavens, hidden from our senses, and in fact, scarcely understood by our reason.#t_footnote(<nt212>, "nr212")[1] Indeed, these [qualities] are from the World Spirit through the stellar rays, which we cannot investigate except by experience and conjecture. From where, you who are anxious to feign effort into this study must consider this because each thing moves and turns to its like and inclines according to all of its abilities and qualities; that is, in occult virtue, as well as in quality, and of course, elemental virtue. It is also always in the substance itself, as we see in salt: for whatever stands for long in salt, becomes salt.#t_footnote(<nt213>, "nr213")[2]
  ]
  #p_normal[
    Indeed, every agent when it begins to act does not move towards an inferior of itself, but as long as it can, [the inferior] will be made equal and agreeable to it. We also clearly see this in sensible animals, in which the nutritive virtue of food does not change into herbs or plants but into sensible flesh.#t_footnote(<nt214>, "nr214")[3]
  ]
  #p_normal[
  ...
  #p_normal[
    It is well known by physicians that the brain helps the brain and the lungs help the lungs.#t_footnote(<nt215>, "nr215")[4] They say that if the eye of a frog is suspended from around the neck in a cloth in the original color it will cure eye inflammations: the right eye for the right, and the left for the left.#t_footnote(<nt216>, "nr216")[5] The same is said about crabs for the eyes. Likewise, the feet of a tortoise were collected for gout and bound suspended [upon the body of the afflicted individual] feet to feet, hand to hand, right to right, left to left. They said in the same way that all barren animals#t_footnote(<nt217>, "nr217")[6] provoke sterility, and to especially use their testicles and womb or urine. If [these are] given to a woman and she takes it or if something is infused with it, she will not conceive for an entire month.
  ]
  #p_normal[
    Therefore, if we wish to work with some quality or virtue, we must search for an animal or other thing that belongs to such an excellent quality and from this take the part in which such a quality or virtue especially thrives. For instance, if we wish to promote love, we search for some animal that especially loves, which are pigeons, turtledoves,#t_footnote(<nt218>, "nr218")[7] sparrows, swallows, and wagtails. From these, we take the members or parts whose strength has the greatest venereal appetite, which are the heart, testicles, womb, penis, sperm, and menses. This must happen at a time when that animal is most affected by captivation and intensity;#t_footnote(<nt219>, "nr219")[8] indeed, then they greatly provoke and draw love. Likewise, for increasing boldness, we must search for a lion or rooster from whom we take the heart, eyes, or forehead.#t_footnote(<nt220>, "nr220")[9]
  ]
  #p_normal[
    Thus, we must understand what Psellus the Platonist said, that dogs, ravens,#t_footnote(<nt221>, "nr221")[10] and roosters are good for watching. Also, nightingales, bats, and owls have the best heads, hearts, and eyes.#t_footnote(<nt222>, "nr222")[11]
  ]
  #p_normal[
    Therefore, they said, “If you carry the heart of a raven or a bat about you, you will not feel sleepy until it is discarded.” The same is true of the head of a bat that is dried and bound to the right arm of someone who is awake: for if it was placed while sleeping, they will not wake until it is discarded.#t_footnote(<nt223>, "nr223")[12]
  ]
  #p_normal[
    In the same way, frogs and horned owls make one talkative, and of these especially is the tongue and the heart. Thus, the tongue of a water frog placed under the head makes one talk in their sleep.#t_footnote(<nt224>, "nr224")[13] The heart of a horned owl placed under the left breast of a sleeping woman will cause the effect of pronouncing all secrets. Also, the same effect happens when the heart of a small owl and the fat of a hare are placed over the breast of someone sleeping.#t_footnote(<nt225>, "nr225")[14]
  ]
  #p_normal[
    In the same way, all animals who are long-lived confer long life, and whatever can renew their life grants renewal of life to our bodies and restores youth, which physicians have shown to accept many times, and is shown in vipers and serpents. It is well known that stags renew their old age by consuming serpents.#t_footnote(<nt226>, "nr226")[15] In the same way, the phoenix renews by a fire that it makes for itself.#t_footnote(<nt227>, "nr227")[16] And a similar virtue is in the pelican, whose right foot if placed under warm dung, a pelican will be born from it after three months.#t_footnote(<nt228>, "nr228")[17]
  ]
  #p_normal[
    Therefore, some physicians made confections out of vipers and hellebore and certain animals’ flesh, which promise to renew youth. Sometimes they do restore,#t_footnote(<nt229>, "nr229")[18] just as Medea promised to restore the aged Peliae.#t_footnote(<nt230>, "nr230")[19] It is likewise believed that the blood of a bear, if drawn by the mouth from a fresh wound, is a potion that will increase strength in the body. [This is] because that animal is the strongest.#t_footnote(<nt231>, "nr231")[20]
  ]
]
...
#character[
  ...
  #p_normal[
    You must know about the great power of natural things that not only affect things brought near to them but also infuse into them a like power, [causing them to] affect other things through the same virtue, such as we see in lodestones. Indeed, this stone not only draws iron rings but also infuses a power into the ring where the same effect becomes possible,#t_footnote(<nt232>, "nr232")[1] which Augustine#t_footnote(<nt233>, "nr233")[2] and Albertus#t_footnote(<nt234>, "nr234")[3] report they saw themselves.
  ]
  #p_normal[
    According to this, it is said that a public prostitute, who exudes boldness and shamelessness, affects everything near her with these qualities, which are then transferred to others. Therefore, they say, that if one dresses in the garments or shirt of a prostitute, or if one has a mirror into which a prostitute gazes daily, they will become bold, intimidating, shameless, and extravagant.#t_footnote(<nt235>, "nr235")[4]
  ]
  #p_normal[
    They say in a similar manner that cloth [that was used] in a burial will contain some quality of sadness and Saturn. Likewise, a hanging noose has some wondrous qualities.#t_footnote(<nt236>, "nr236")[5]
  ]
  #p_normal[
    The same is written by Pliny: that if you place earth under a blinded green lizard in a glass vase, [you should] include rings of solid iron or gold. When, looking through the glass, the vision of the lizard appears to have returned, take out the rings. They will relieve inflammation from the eyes. The same is also said with weasels and rings, [because] it is agreed that if weasels’ eyes are plucked out with a point their vision will be restored again.#t_footnote(<nt237>, "nr237")[6] In the same manner, rings are placed at certain times in the nests of sparrows or swallows, which afterward are used for love or favor.
  ]
]
...
#character[
  ...
  #p_normal[
    There is another enmity among the stars—that is, when they have opposite houses, such as Saturn toward the luminaries, Jupiter toward Mercury, and Mars toward Venus. That enmity is stronger in [those planets] whose exaltations are opposite to theirs, such as Saturn with the Sun, Jupiter with Mars, and Venus with Mercury. However, the strongest friendships are those of a harmonious nature, quality, substance, and power, such as Mars with the Sun and Venus with the Moon, likewise Jupiter with Venus. It is also friendly when one’s exaltation is in the house of another, such as Saturn with Venus, Jupiter with the Moon, Mars with Saturn, the Sun with Mars, Venus with Jupiter, and the Moon with Venus.#t_footnote(<nt238>, "nr238")[1]
  ]
  #p_normal[
    Whatever has friendly or unfriendly inclinations in the superior realm [will exhibit] these same tendencies [among] subordinate things in the inferior. Therefore, the conditions in friendliness or unfriendliness are nothing else than certain inclinations of things toward each other—desiring various things if absent; moving toward them unless impeded; resting when acquired; fleeing [what] opposes them, dreading their approach, and not resting.#t_footnote(<nt239>, "nr239")[2] Therefore, Heraclitus professed his opinion that everything happens through hatred and friendship.#t_footnote(<nt240>, "nr240")[3]
  ]
  #p_normal[
    However, inclinations of friendship in vegetables and minerals are such that magnets attract iron, emeralds attract wealth and favor,#t_footnote(<nt241>, "nr241")[4] jasper in childbirth,#t_footnote(<nt242>, "nr242")[5] and agate in eloquence.#t_footnote(<nt243>, "nr243")[6] In a similar manner naphtha draws fire and leaps into whatever direction it sees;#t_footnote(<nt244>, "nr244")[7] similarly, the herb#emph[ aproxis] draws fire from afar like naphtha.#t_footnote(<nt245>, "nr245")[8]
  ]
  #p_normal[
    There is the same inclination in the masculine and feminine palm tree, that when one branch touches the branch of the other, they embrace each other in mutual affection,#t_footnote(<nt246>, "nr246")[9] and the female will not bring fruit without the male. The solitary almond tree is less fertile. Vines love elm trees, and opium, olives, and myrtles love each other. Olive and fig trees are similar.
  ]
  #p_normal[
    In animals, there is true friendship between blackbirds and thrushes, crows and herons, between peacocks and pigeons, and turtledoves and parrots.#t_footnote(<nt247>, "nr247")[10] About this, Sappho wrote to Phaon:
  ]
  #p_poetry[
    #emph[Often white pigeons are joined with [birds of] different colors]
  ]
  #p_normal[
    #emph[And black turtledoves are loved by green birds.]#t_footnote(<nt248>, "nr248")[11]
  ]
  #p_normal[
    Again, small fish and whales are friends.#t_footnote(<nt249>, "nr249")[12] Friendship is not only among animals but also with other things such as with metals and stones and with vegetables. Thus, felines and cats delight in the herb catnip, which they rub, surrendering themselves to conception, and with the lack of a male.#t_footnote(<nt250>, "nr250")[13] Mares in Cappadocia expose themselves to the blowing wind, and from that force conceive.#t_footnote(<nt251>, "nr251")[14] Thus, frogs, toads, serpents, and other poisonous reptiles delight in the plant that is called “laughing parsley,”#t_footnote(<nt252>, "nr252")[15] which physicians say if one consumes it, they will die laughing.
  ]
  #p_quote[
    #emph[Friendships of animals with other things.]
  ]
  #p_normal[
    Again tortoises, when poisoned by a serpent, eat wild marjoram#t_footnote(<nt253>, "nr253")[16] and they are cured. A stork when it has eaten a serpent seeks to heal itself from wild marjoram.#t_footnote(<nt254>, "nr254")[17] A weasel when fighting a basilisk#t_footnote(<nt255>, "nr255")[18] eats the herb rue: from which we recognize that wild marjoram and rue possess a virtue against poisons.#t_footnote(<nt256>, "nr256")[19] Thus, in some animals, there are natural skills and innate medicinal arts. For toads, when bitten by another animal and wounded by poison, customarily search for rue or sage. They rub the place of the wound with this and cure themselves of the danger of the poison.#t_footnote(<nt257>, "nr257")[20]
  ]
  #p_quote[
    #emph[What men have learned from beasts.]
  ]
  #p_normal[
    Thus, beasts have taught men very well about many remedies from sickness and the virtues of things. For instance, swallows have shown us that celandine#t_footnote(<nt258>, "nr258")[21] is helpful for sight, with which they heal the eyes of their chicks.#t_footnote(<nt259>, "nr259")[22] Magpies when sick bring a laurel leaf into their nest and then grow stronger. Likewise [with laurel], wood pigeons,#t_footnote(<nt260>, "nr260")[23] jackdaws, partridges, and blackbirds purge their nauseous stomachs. Similarly, ravens#t_footnote(<nt261>, "nr261")[24] and chameleons also extinguish poison [with that plant].#t_footnote(<nt262>, "nr262")[25] Lions, if feverish, will grow stronger if they eat an ape.#t_footnote(<nt263>, "nr263")[26] Hoopoes,#t_footnote(<nt264>, "nr264")[27] if injured by eating a grape, are healed by maidenhair.#t_footnote(<nt265>, "nr265")[28]
  ]
  #p_normal[
    Thus, stags have taught us that dittany is a useful herb for extracting arrows since they eject the piercing dart by eating that herb.#t_footnote(<nt266>, "nr266")[29] It is the same for Cretan goats.#t_footnote(<nt267>, "nr267")[30] Deer, somewhat before they give birth, purge themselves with a certain herb that is called hartwort.#t_footnote(<nt268>, "nr268")[31] Likewise, when venomous spiders wound deer they [the deer] eat crabs to restore their health.#t_footnote(<nt269>, "nr269")[32] Also, pigs, when serpents bite them, cure themselves by eating [crabs].#t_footnote(<nt270>, "nr270")[33] Ravens, when they feel that they are poisoned by a 
#emph[toxico gallico,]#t_footnote(<nt271>, "nr271")[34] use an oak, or others say the #emph[corvativam,]#t_footnote(<nt272>, "nr272")[35] to seek a cure.#t_footnote(<nt273>, "nr273")[36] Elephants, when they devour a chameleon, help themselves with the wild olive. Bears, when hurt by the mandrake, escape [danger] by eating ants. Geese, ducks and other aquatic birds heal themselves with the herb ironwort.#t_footnote(<nt274>, "nr274")[37] Pigeons, turtledoves, and hens [heal themselves] with the herb 
#emph[helxine,]#t_footnote(<nt275>, "nr275")[38] and cranes [heal themselves] with rushes. Leopards heal themselves against wolfsbane with human feces, boars with ivy, and deer with the herb artichoke.#t_footnote(<nt276>, "nr276")[39]
  ]
]
...
#character[
  ...
  #p_normal[
    Examples of these kinds of inclinations are: rhubarb against cholera;#t_footnote(<nt277>, "nr277")[1] theriacs#t_footnote(<nt278>, "nr278")[2] against poison; sapphires against anthrax, fiery fevers, and afflictions of the eyes; amethyst against drunkenness; jasper against flowing blood#t_footnote(<nt279>, "nr279")[3] and harmful phantoms; emerald and chaste tree against lust;#t_footnote(<nt280>, "nr280")[4] agate against poisons; peony against falling sickness;#t_footnote(<nt281>, "nr281")[5] coral against the delusions of black bile#t_footnote(<nt282>, "nr282")[6] and stomach pain;#t_footnote(<nt283>, "nr283")[7] topaz against spiritual fires such as greed, extravagance, and all excessive love.#t_footnote(<nt284>, "nr284")[8]
  ]
  #p_normal[
    Likewise, is the inclination of ants against wild marjoram#t_footnote(<nt285>, "nr285")[9] and a bat’s wing#t_footnote(<nt286>, "nr286")[10] against the heart of a hoopoe, which if present, will flee. There is a poisonous ant#t_footnote(<nt287>, "nr287")[11] that is opposed to wild marjoram#t_footnote(<nt288>, "nr288")[12] and resists salamanders, and the ants have such an enduring hatred of cabbage that they destroy each other in turn. Thus, cucumbers hate oil to such an extent that they will bend themselves into a hook so that they do not touch it.
  ]
  #p_normal[
    It is said that a raven’s gall, with certain other things, chases away and frightens men from the place where it is hidden. Likewise, a diamond disagrees with the lodestone to such an extent that if [a diamond] is placed near [the stone], iron will not be attracted to that lodestone. Sheep flee frog-parsley#t_footnote(<nt289>, "nr289")[13] as if it were deadly. What is more wondrous, nature has painted this sign of death on the livers of sheep, where the figure of the frog-parsley we described naturally appears.#t_footnote(<nt290>, "nr290")[14] Goats also hate basil#t_footnote(<nt291>, "nr291")[15] as if nothing was more destructive.#t_footnote(<nt292>, "nr292")[16]
  ]
  #p_quote[
    #emph[Antipathy and disagreement of animals.]
  ]
  #p_normal[
    Again, among animals, mice and weasels disagree: so that with cheese, if the brains of a weasel are added to the rennet, mice will not touch it, and [the cheese] will not spoil with age.#t_footnote(<nt293>, "nr293")[17] Scorpions so oppose lizards that even the sight of them causes fear and freezes them in a cold sweat. Therefore, they putrefy [the lizard] in oil, and with it, kill them and also anoint scorpion stings.#t_footnote(<nt294>, "nr294")[18] There is also an enmity between scorpions and mice. We read that if a mouse is placed under a scorpion sting it will be cured.#t_footnote(<nt295>, "nr295")[19] There is an enmity between scorpions and 
	#emph[stalabores,]#t_footnote(<nt296>, "nr296")[20] asps, and ichneumons.#t_footnote(<nt297>, "nr297")[21] It is also said that there are no such adversaries as serpents against crabs, and if a pig is stung they will eat [a crab] and be healed; also, when the Sun is in Cancer, serpents are tormented.#t_footnote(<nt298>, "nr298")[22] Scorpions and crocodiles destroy each other.#t_footnote(<nt299>, "nr299")[23] If the feather of an ibis touches a crocodile, he will be immobilized.#t_footnote(<nt300>, "nr300")[24] The bird [called a] bustard flies away when it sees a horse.#t_footnote(<nt301>, "nr301")[25] A stag will flee when it sees a ram#t_footnote(<nt302>, "nr302")[26] and also flee when it sees a viper.#t_footnote(<nt303>, "nr303")[27] Elephants react with fear at sound of a grunting pig,#t_footnote(<nt304>, "nr304")[28] just as lions do when they see a rooster.#t_footnote(<nt305>, "nr305")[29] Leopards will not touch something that is anointed with the broth of a hen, especially if garlic is boiled in it.#t_footnote(<nt306>, "nr306")[30] There is also an enmity between foxes, swans, bulls, and crows.#t_footnote(<nt307>, "nr307")[31]
  ]
  #p_normal[
    Likewise, among birds, there is a perpetual battle between crows and owls, kites and ravens, 
#emph[pitalles]#t_footnote(<nt308>, "nr308")[32] and turtledoves, #emph[bicuthus] and #emph[pagrus,]#t_footnote(<nt309>, "nr309")[33] yellow thrush and turtledoves,#t_footnote(<nt310>, "nr310")[34]#emph[Aegepii]#t_footnote(<nt311>, "nr311")[35] and eagles, stags and dragons.#t_footnote(<nt312>, "nr312")[36]
  ]
  #p_normal[
    Among the aquatics, there are also enmities such as between dolphins and whales, 
#emph[cestris] and the wolf-fish,#t_footnote(<nt313>, "nr313")[37] and eels and congers. Likewise, crustaceans frighten polyps to such an extent that when they see one nearby, they suddenly die. Crustaceans [are against] congers, and again the congers destroy polyps.#t_footnote(<nt314>, "nr314")[38]
  ]
  #p_normal[
    Likewise, leopards are said to be in fear of hyenas to such an extent that they cannot withstand it, and in any way touch [the hyena’s] skin. If the skins of each are hanged one against the other, the hairs of the leopard skin will drop off;#t_footnote(<nt315>, "nr315")[39] as Horapollo#t_footnote(<nt316>, "nr316")[40] said in the 
#emph[Hieroglyphics:] “If one is girded with the pelt of a hyena and walks in the midst of his enemies, he will not be hurt and will calmly pass.”#t_footnote(<nt317>, "nr317")[41] Likewise, lambs have an enmity with wolves (which offend them) and flee from them in dread.#t_footnote(<nt318>, "nr318")[42] 
...
#emph[esalon]#t_footnote(<nt319>, "nr319")[43] breaks the eggs of ravens whose chicks are antagonized by the fox and that she will, in turn, pluck the fox’s young. If a raven sees [an 
#emph[esalon]] it will help [the fox] as they are facing a common enemy. The #emph[acanthus,]#t_footnote(<nt320>, "nr320")[44] a small bird living among thorn bushes, hates asses because they eat the flowers of its thorn bushes. However, the small bird 
#emph[egithus]#t_footnote(<nt321>, "nr321")[45] has such a great dissent with asses that their blood cannot be mixed together, and the bellowing [of an ass] will kill the eggs and young of an 
#emph[egithus].#t_footnote(<nt322>, "nr322")[46]
  ]
  #p_normal[
    Likewise, there is such a great dissent between olives and prostitutes that, if she plants it, [the olive] will either perpetually be unfruitful or it will wither up entirely.#t_footnote(<nt323>, "nr323")[47] Lions fear nothing more than burning torches nor is anything believed to subdue them more than this.#t_footnote(<nt324>, "nr324")[48] A wolf fears neither iron nor spear, yet when stones are thrown, [they] cause wounds that beget worms.#t_footnote(<nt325>, "nr325")[49] Horses fear camels#t_footnote(<nt326>, "nr326")[50] to such an extent that they cannot endure to see a camel’s appearance or perceive it. A raging elephant, when seeing a ram,#t_footnote(<nt327>, "nr327")[51] is subdued. A snake fears a nude man, but when a man is clothed the snake attacks. A raging bull, if bound to a fig tree, weakens its attack. Amber draws everything to it except basil and that which is smeared with oil,#t_footnote(<nt328>, "nr328")[52] with which it naturally disagrees.
  ]
]
...
#character[
  ...
  #p_normal[
    You must also consider the virtues belonging to things according to certain species, such as boldness and courage in lions and roosters, timidity in hares and lambs, greed or voracity in wolves, craftiness and fraud in foxes, flattery in dogs, greed in ravens and crows, arrogance in horses, anger in tigers and boars, sadness and melancholy in cats, desire in sparrows,#t_footnote(<nt329>, "nr329")[1] and the like. Indeed, the greatest part of natural virtues accompanies the species.
  ]
  #p_quote[
    #emph[There are dual virtues in things.]
  ]
  #p_normal[
    However, some things belong according to the individual, such as some men vehemently abhor the sight of a cat and are therefore unable to see them without heavy shivering;#t_footnote(<nt330>, "nr330")[2] for indeed the shivering does not belong to them according to the human species, because that is obvious. Avicenna wrote of a man who lived in his time whom all poisonous things avoided, killing anything that by chance seized and bit him, but he was entirely uninjured.#t_footnote(<nt331>, "nr331")[3] Albertus referred to a girl he saw in Cologne,#t_footnote(<nt332>, "nr332")[4] who hunted spiders for food, which she delightedly ate.#t_footnote(<nt333>, "nr333")[5]
  ]
  #p_normal[
    Likewise is the boldness of a prostitute, and the timidity of a thief. About this, philosophers said that some individuals, who never suffered sickness, oppose all sicknesses. Therefore, they say that suspending the bone of a dead man who never had a fever over a patient cures quartan.#t_footnote(<nt334>, "nr334")[6] There are also many virtues belonging to singular individuals infused by the celestial bodies, as we have shown above.
  ]
]
...
#character[
  ...
  #p_normal[
    Again, you must consider that the virtues of some things belong to the whole—that is, according to their entire substance even all of its parts:#t_footnote(<nt335>, "nr335")[1] for example, the small fish echeneis, by only its touch, brings a ship to a stop.#t_footnote(<nt336>, "nr336")[2] This happens not because of any particular part but because of its entire substance. Also, the hyena,#t_footnote(<nt337>, "nr337")[3] because of its entire substance, its shadow touching dogs will cause them to lose their speech.#t_footnote(<nt338>, "nr338")[4] Likewise, the celandine#t_footnote(<nt339>, "nr339")[5] restores sight,#t_footnote(<nt340>, "nr340")[6] not according to any [particular part] but according to all of its parts—no less in the root than the leaves and seeds, and so on.
  ]
  #p_normal[
    However, some virtues belong to things according to some of its parts; for example, only the tongue, eyes, or other members or parts. Thus, the eyes of a basilisk#t_footnote(<nt341>, "nr341")[7] and #emph[catoblepas]#t_footnote(<nt342>, "nr342")[8] have the most violent virtue to kill men when they see them.#t_footnote(<nt343>, "nr343")[9] Likewise, the virtue of the eyes of a hyena is that whenever an animal hesitates its step and investigates it, [the animal] will be stupefied and will not be able to move.#t_footnote(<nt344>, "nr344")[10] A similar virtue is in the eyes of some wolves, that if they first see [a man], they become stupefied and hoarse as if trying to shout without having a voice.#t_footnote(<nt345>, "nr345")[11] Of this Virgil recalled in his song:
  ]
  #p_poetry[
    #emph[. . . likewise the voice of Moeris]
  ]
  #p_poetry[
    #emph[The wolves now flee, seeing Moeris first.#t_footnote(<nt346>, "nr346")[12]]
  ]
  #p_quote[
    #emph[Why enchanters chiefly use the eyes and not other parts.]
  ]
  #p_normal[
    Also, some women in Scythia, Illyria, and Triballia,#t_footnote(<nt347>, "nr347")[13] often killed people by angrily looking at them.#t_footnote(<nt348>, "nr348")[14] Likewise, the Telchian people of Rhodes extremely corrupted all who saw them. For this reason, Jupiter drowned them.#t_footnote(<nt349>, "nr349")[15] Therefore, enchanters, for this reason, use the eyes of animals for eye-salves and for similar sufferings operating through enchantments.
  ]
  #p_normal[
    In a similar manner, ants flee from the heart of a hoopoe,#t_footnote(<nt350>, "nr350")[16] and not from the head, feet, or eyes. Thus, a lizard’s gall rubbed in water is used to gather weasels,#t_footnote(<nt351>, "nr351")[17] and not the tail or the head. Also, a goat’s gall enclosed in a bronze vessel buried under the earth gathers frogs. A goat’s liver repels butterflies and all moths.#t_footnote(<nt352>, "nr352")[18] A dog’s heart makes [other] dogs flee.#t_footnote(<nt353>, "nr353")[19] Likewise, foxes will not touch chickens that have eaten the liver of a fox.#t_footnote(<nt354>, "nr354")[20]
  ]
  #p_normal[
    Thus, many things have different virtues dispersed throughout their various parts, as they receive according to different celestial influences: just as in the human body, bones receive nothing but life, the eyes sight, and the ears hearing.#t_footnote(<nt355>, "nr355")[21] In the human body, there is a certain small bone, which the Hebrews call LVZ,#t_footnote(<nt356>, "nr356")[22] that is the size of a cleaned chickpea and cannot be corrupted or be conquered by fire but is always preserved uninjured. From [this bone], it is said, just as plants resurrect from seeds, our animal bodies sprout from the dead.#t_footnote(<nt357>, "nr357")[23] These virtues are not declared by reason but by experience.
  ]
]
...
#character[
  ...
  #p_normal[
    Thus, they say that with colic if a live duck is placed near the stomach, it repels the illness and the duck will die.#t_footnote(<nt358>, "nr358")[1] Similarly, Archytas said: “If you take a heart, freshly extracted from an animal still warm and living, and suspend it over a patient with quartan fever, [the fever] will lift.”#t_footnote(<nt359>, "nr359")[2] Also, if you swallow the heart of a hoopoe, swallow, weasel, or a mole that is living and beating, it helps with memory, recollection, understanding, and divination.#t_footnote(<nt360>, "nr360")[3]
  ]
  #p_quote[
    #emph[[Parts] must be taken from animals while still living.]
  ]
  #p_normal[
    Hence, from this, there is a general precept, that whatever is collected from animals (or stones, members, or waste such as hair, dung, or hooves), that these should be taken from animals that are still living and, if possible, remain alive afterward.#t_footnote(<nt361>, "nr361")[4] From this, it is taught: “If you collect the tongue of a frog, then throw the frog alive back into the water; if you collect the tooth or eye#t_footnote(<nt362>, "nr362")[5] of a wolf, do not kill the wolf,” and so on.
  ]
  #p_normal[
    Thus, Democritus wrote that if the tongue of a living sea-frog is removed with no other part of the body attached to it, [and the frog] dropped into the sea, and [the tongue] then placed over the beating heart of a sleeping woman, she will respond truthfully to whatever is asked.#t_footnote(<nt363>, "nr363")[6] In a similar way, if a frog’s eyes are bound to a sick person before the Sun rises, and [the frog] thus blinded be released in the water, it promises to cure tertian#t_footnote(<nt364>, "nr364")[7] fever. Also, a nightingale’s flesh bound in the skin of a deer is excellent for staying awake and keeping sleep away.#t_footnote(<nt365>, "nr365")[8] Similarly, the ray of a stingray#t_footnote(<nt366>, "nr366")[9] bound to the navel makes easier childbirths. If [the ray is] taken while living, [the stingray] must be thrown in the sea again.#t_footnote(<nt367>, "nr367")[10] It is said that the right eye of a serpent bound [to a patient] is useful against watering [of the eyes]. If the serpent lives, then release it.#t_footnote(<nt368>, "nr368")[11] There is a certain fish or great serpent called 
	#emph[myrus,]#t_footnote(<nt369>, "nr369")[12] whose eye, if it is plucked out and bound to the forehead of the patient, is said to cure inflammation of the eyes. However, the fish’s eye will be born again, but the other eye should be taken if it cannot be released alive.#t_footnote(<nt370>, "nr370")[13] Likewise, the teeth of all serpents, when removed while they are living and suspended above the patient, are said to cure quartan fever.#t_footnote(<nt371>, "nr371")[14] Also, the teeth removed from a live mole, which is then released, cure toothaches.#t_footnote(<nt372>, "nr372")[15] Dogs will not bark at those having a tail of a weasel that was released.#t_footnote(<nt373>, "nr373")[16] Democritus said that a chameleon’s tail, if taken while living, is good for exerting influence on the outcome of judgments and also for healthy childbirth near the home. However, beware that it not be brought inside the home, because it might be destructive.#t_footnote(<nt374>, "nr374")[17]
  ]
  #p_quote[
    #emph[Things after death may retain their powers.]
  ]
  #p_normal[
    There are also qualities that remain after death. Platonists say that in things that are less immersed in material Ideas, [those qualities] that are still immortal after they are dead and finished do not cease to operate wonders.#t_footnote(<nt375>, "nr375")[18]
  ]
  #p_normal[
    Thus, in herbs and plants when torn and dried, thrive and operate their virtues previously infused by Ideas. Because of this, an eagle in life surpasses and conquers all other birds, and also when dead, its feathers destroy and corrode all other feathers and plumes.#t_footnote(<nt376>, "nr376")[19] For the same reason, the pelt of a lion consumes all other pelts, and the pelt of a hyena destroys the pelt of a leopard, and the pelt of a wolf corrodes the pelt of a lamb.#t_footnote(<nt377>, "nr377")[20]
  ]
  #p_quote[
    #emph[Drums made from different skins have different effects.]
  ]
  #p_normal[
    Some of these act not only by corporeal contact but also by vocal harmony. For instance, a drum made from the skin of an #emph[adib]—that is, a wolf—will silence a drum made from the skin of a lamb.#t_footnote(<nt378>, "nr378")[21] Likewise, a drum made from the skin of #emph[ericii marini]#t_footnote(<nt379>, "nr379")[22] chases away all reptiles, from whatever distance a sound of this sort is heard. Also, nothing will be heard in harmony from a lyre or cithara made with strings tensed from the intestines of a wolf, if also tensed with [strings] made from a sheep.#t_footnote(<nt380>, "nr380")[23]
  ]
]
...
#character[
  ...
  #p_normal[
    It is undoubted that all of the inferior are beneath the superior. In a certain way (as Proclus said) they belong to each other—that is, the lowest supreme and the highest inferior.#t_footnote(<nt381>, "nr381")[1] Thus, in the heavens there are earthly [things] that have their causes as if in a celestial manner; likewise on earth there are celestial [things] exisiting in a terrestrial manner—that is, by effect.
  ]
  #p_normal[
  ...
  #p_normal[
    Mercury, however, rules#t_footnote(<nt382>, "nr382")[2] the tongue, and other sensory instruments or organs interior or exterior, and also the hands, feet, legs, nerves, and imaginative virtues.
  ]
  #p_quote[
  ...
  #p_normal[
    Moreover, Mars rules the blood, veins, kidneys, gallbladder, nostrils,#t_footnote(<nt383>, "nr383")[3] back, the descent of sperm, and irascible strength.
  ]
  #p_normal[
    Venus rules the kidneys, vulva, womb, genitals, and the virtue of desire. [Venus] additionally rules the flesh and fat, stomach, breasts, navel, that which services Venusian operations, as the sacrum bone,#t_footnote(<nt384>, "nr384")[4] backbone, and loins, and also, she is accurately said [to rule] the head and lips where one kisses as a symbol of love.
  ]
  #p_normal[
    The Moon, however, although claiming the entire body and individual members through the different signs, is yet personally appointed the brain, lungs, marrow of the backbone, stomach, menstrua, all excrements, the left eye, and the power of increase.#t_footnote(<nt385>, "nr385")[5]
  ]
  #p_normal[
    Indeed, Hermes said that there are seven holes in the head of an animal distributed to the seven planets. These are, the right ear to Saturn, the left to Jupiter, the right nostril to Mars, Venus the left, the right eye to the Sun, the left to the Moon, and the mouth to Mercury.#t_footnote(<nt386>, "nr386")[6]
  ]
  #p_quote[
    #emph[Which parts of the human body are under the planets and signs of the zodiac.]
  ]
  #p_normal[
    Likewise, the individual signs of the zodiac attend to the members. Thus, Aries rules the head and face; Taurus the neck; Gemini the forearms and shoulders; Cancer the breasts, lungs, stomach and upper arms; Leo governs the heart, stomach, liver, and back; Virgo cares for the intestines and the bottom of the stomach; Libra governs the kidneys, thighs, and buttocks; Scorpio the genitals and vulva and womb; Sagittarius rules the thighs and groin; Capricorn rules the knees; Aquarius the legs and shins; and Pisces rules the feet.#t_footnote(<nt387>, "nr387")[7]
  ]
  #p_normal[
    Also, as the triplicities#t_footnote(<nt388>, "nr388")[8] of the signs correspond and agree in the celestials, thus they also agree in the members—which is agreed enough by experience, because if cold inflicts the feet, stomach, and breasts, these members respond to the same triplicity. Accordingly, if a medicine is appointed to one, it is useful to the others, such as if heat is added to the feet, pain in the stomach ceases.#t_footnote(<nt389>, "nr389")[9]
  ]
  #p_normal[
    Remember and know this succession, because things that are under any of the planets have a certain singular appearance or inclination attributed to that same planet, and especially its domicile or exaltation. The remaining dignities are less than these—that is, the triplicities, terms,#t_footnote(<nt390>, "nr390")[10] and decans.#t_footnote(<nt391>, "nr391")[11]
  ]
  #p_normal[
    Therefore, according to this rationale, peony, citron, clove,#t_footnote(<nt392>, "nr392")[12] citrus peel, marjoram, 
#emph[doronicum,]#t_footnote(<nt393>, "nr393")[13] cinnamon, saffron, lignum aloe, frankincense, amber, musk, and partially myrrh cure the head and heart#t_footnote(<nt394>, "nr394")[14] because of the Sun, Aries, and Leo. Thus, the greater plantago,#t_footnote(<nt395>, "nr395")[15] a Martial herb, heals the head and testicles#t_footnote(<nt396>, "nr396")[16] according to Aries and Scorpio and so on.
  ]
  #p_normal[
...
[understood] by colors and scents, some also through the effects of their operations agreeing with certain stars.#t_footnote(<nt398>, "nr398")[1]
  ]
  #p_normal[
    Thus, among Solar [things] are elemental fire and bright flame; in humors, pure blood and vital spirit; among tastes, mixed sharp and sweet.#t_footnote(<nt399>, "nr399")[2]
  ]
  #p_normal[
    Among metals, [the Sun has] gold because of its splendor and because [gold] has its strengthening heart from the Sun.#t_footnote(<nt400>, "nr400")[3]
  ]
  #p_normal[
    Among stones, however, are those with golden drops that imitate the Sun’s rays, such as the stone aetite, which has a virtue against falling sickness and poison. Also, the stone that is called the “eye of the Sun”#t_footnote(<nt401>, "nr401")[4] has a figure similar to the pupil of an eye, and from its center, it emits a ray#t_footnote(<nt402>, "nr402")[5] that strengthens the brain and sharpens#t_footnote(<nt403>, "nr403")[6] the eye. The carbuncle shines at night and has a virtue against all airy and vaporous poisons. The stone chrysolite is weak in color and a clear green. When placed opposite the Sun, it emits a golden star. It strengthens the spirit and helps asthma; when [chrysolite is] pierced, the hole being filled with the hairs of an ass and bound to the left arm, it chases away phantasms and melancholy terrors as well as repels follies.#t_footnote(<nt404>, "nr404")[7] The stone iris, similar in color to the crystal, is frequently found as a hexagon. When under a roof, and part of it placed opposite the rays of the Sun, and the other part held in the shadow, it collects the Sun’s rays into itself. It then projects the reflection, making a rainbow appear on the opposite wall.#t_footnote(<nt405>, "nr405")[8] Likewise, the stone heliotrope, green in the manner of a jasper or emerald with starry red drops, makes one constant, glorious, and famous and brings long life. It also has a wondrous virtue that if it is in the Sun’s rays, it is said to change into blood—that is, it appears to be like blood as if the Sun suffered an eclipse; evidently when it is anointed with the juice of the herb of the same name and placed in a vessel filled with water. There is another more wondrous virtue in the eyes of men, which offends the sight and blinds the vision so that it will not permit men to see those who bear it;#t_footnote(<nt406>, "nr406")[9] 
yet it does not happen without the help of the herb of the same name, which is 
also called heliotrope—that is, following the Sun. These virtues were confirmed in the writings of Albertus Magnus and William of Auvergne.#t_footnote(<nt407>, "nr407")[10]
  ]
  #p_quote[
  ...
  #p_normal[
    Hyacinth#t_footnote(<nt408>, "nr408")[11] also has a Solar virtue against poisons and pestilential vapors. When carried, [the person carrying it] is rendered safe and acceptable. It brings wealth and talent, as well as strengthing the heart. When held in the mouth, [hyacinths] exceedingly cheer the mind.#t_footnote(<nt409>, "nr409")[12] There is also the 
...
#emph[pyrophilos:] “from fire.” It has a wonderful virtue against poison, and it renders the bearer ambitious and formidable against adversaries.#t_footnote(<nt411>, "nr411")[14] But above everything that is Solar is the stone called the 
#emph[pantaura,] which is said to have been found by Apollonius.#t_footnote(<nt412>, "nr412")[15] It draws other stones to itself, like lodestones with iron, and is effective against all poisons.#t_footnote(<nt413>, "nr413")[16] Others call it 
#emph[pantherus] because it has spots like the leopard.#t_footnote(<nt414>, "nr414")[17] Likewise is the [stone] called 
#emph[panthocras,]#t_footnote(<nt415>, "nr415")[18] which contains all colors. Aaron called this #emph[evanthum].#t_footnote(<nt416>, "nr416")[19] Other Solar [stones] are the topaz, chrysoprase, ruby, and balas ruby.#t_footnote(<nt417>, "nr417")[20] Likewise solar are the orpiment and things goldencolored and very bright.#t_footnote(<nt418>, "nr418")[21]
  ]
  #p_normal[
    Among Solar trees and plants there are those that turn to the Sun, such as the heliotrope.#t_footnote(<nt419>, "nr419")[22] There are others that interweave their leaves at the setting Sun and when it rises again unfold their leaves gradually: the lotus,#t_footnote(<nt420>, "nr420")[23] which is a small Solar tree as testified by its fruit and leaves, is one such plant. Also, the peony, swallow-wort, citrus, ginger, gentian, dittany, and verbena are likewise excellent for prophecy, atonement, and chasing away evil daemons.#t_footnote(<nt421>, "nr421")[24] The laurel is sacred to Phoebus,#t_footnote(<nt422>, "nr422")[25] as are the cedar, palm, ash tree, ivy, and vine—and this goes for any plant that repels poison and lightning, is ever-green, and does not fear the cold of winter. Also Solar are mint, mastic, zedoary,#t_footnote(<nt423>, "nr423")[26] saffron, balsam, amber, musk, yellow honey, lignum aloe, clove, cinnamon, aromatic calamus, pepper, frankincense, marjoram, and rosemary,#t_footnote(<nt424>, "nr424")[27] which Orpheus calls the incense of the Sun.#t_footnote(<nt425>, "nr425")[28]
  ]
  #p_quote[
    #emph[Why the Egyptians painted baboons on their fountains.]
  ]
  #p_normal[
    Among animals are those that are noble, courageous, eager for victory, and ambitious, such as the lion (king of beasts), crocodile, lynx, ram, male goat, and bull#t_footnote(<nt426>, "nr426")[29] (king of herds, which to the Egyptians at Heliopolis was sacred to the Sun). They called [the bull]
#emph[Veritem,] in Memphis the Apis bull, and in Hermonthis a bull was called #emph[Pathim].#t_footnote(<nt427>, "nr427")[30] Wolves are sacred to Apollo and Latona.#t_footnote(<nt428>, "nr428")[31] Also Solar are baboons, which through each of the twelve hours of the day bark and during the equinox urinate at each of the twelve hours, even at night, which is why the Egyptians sculpted them on their fountains.
  ]
  #p_normal[
    Likewise, Solar among birds are the phoenix—a one of a kind bird#t_footnote(<nt429>, "nr429")[32]—and the eagle, queen of birds. Also [Solar] are vultures; 
#emph[alar,]#t_footnote(<nt430>, "nr430")[33] or swan; and those that applaud or call a hymn at the rising of the Sun, such as roosters and ravens.#t_footnote(<nt431>, "nr431")[34] Also [Solar] are hawks, which in Egyptian theology are the symbol of spirit and light and counted by Porphyry as among the Solar.#t_footnote(<nt432>, "nr432")[35]
  ]
  #p_normal[
    Moreover, whatever is collected as Solar, has a likeness to an operation of the Sun, such as worms shining at night. For instance, there is the scarab, which is called a cat.#t_footnote(<nt433>, "nr433")[36] It has a bright form that is also said to be a vessel, and it rolls little balls. It incubates and generates others from above.#t_footnote(<nt434>, "nr434")[37] According to Apion’s interpretation, these [qualities] are similar to the operations of the Sun, and come from it; [animals] whose eyes vary according to the course of the Sun are judged Solar.#t_footnote(<nt435>, "nr435")[38]
  ]
  #p_normal[
    Fish that are especially Solar are sea-calves. These resist lightning.#t_footnote(<nt436>, "nr436")[39] Likewise [Solar] are mollusks and jellyfish, which shine at night; starfish, because of their scorching heat;#t_footnote(<nt437>, "nr437")[40]#emph[strombi,]#t_footnote(<nt438>, "nr438")[41] who follow their king; and #emph[margari,]#t_footnote(<nt439>, "nr439")[42] who also have a king, are dried and hardened into stone and have a golden color.
  ]
]
...
#character[
  ...
  #p_normal[
    The Lunar among elements is earth;#t_footnote(<nt440>, "nr440")[1] also water such as the sea and rivers, all humid [things], moist trees and animals, and especially white [things] such as egg whites, fat, sweat, phlegm, and excess flesh. For tastes, [the Moon has] the salty and tasteless.#t_footnote(<nt441>, "nr441")[2]
  ]
  #p_normal[
    Among the metals, silver is Lunar. Among stones are the crystal, silver marcasite, and all that is white and green.#t_footnote(<nt442>, "nr442")[3] Other stones are selenites, which are Lunar because they are translucent and bright with a honey brightness. They imitate the changing phases of the Moon: having the figure of the Moon in themselves, they reflect that [figure] by waxing and waning each day.#t_footnote(<nt443>, "nr443")[4] Likewise are pearls, which are generated from mollusks from drops of water, and similarly with crystal and beryl.#t_footnote(<nt444>, "nr444")[5]
  ]
  #p_quote[
    #emph[Lunar plants and trees.]
  ]
  #p_normal[
    Among Lunar plants and trees are the #emph[selenotropion,]#t_footnote(<nt445>, "nr445")[6] which turns toward the Moon just as heliotropes turn toward the Sun.#t_footnote(<nt446>, "nr446")[7] Also palm trees, which send out a single branch with each moonrise,#t_footnote(<nt447>, "nr447")[8] as well as the hyssop, rosemary, small trees, and large plants, sharing from each.#t_footnote(<nt448>, "nr448")[9] Also Lunar is the chaste lamb, or chaste tree, and olive. Similarly the herb 
#emph[chinosates,]#t_footnote(<nt449>, "nr449")[10] which increases and decreases with the Moon#t_footnote(<nt450>, "nr450")[11]—that is, in substance and number of leaves, not only in moisture and virtue, which is in a certain way common to each planet except the Martial#t_footnote(<nt451>, "nr451")[12] onion, which is uniquely contrary to the Moon, increasing when the Moon is decreasing and decreasing when the Moon increases,#t_footnote(<nt452>, "nr452")[13] just as among flying things is the quail, a Saturnine bird, which is unfriendly to the Moon and Sun.#t_footnote(<nt453>, "nr453")[14]
  ]
  #p_quote[
    #emph[Lunar animals.]
  ]
  #p_normal[
    Among Lunar animals are those that rejoice in human company and those that naturally excel equally varying in love and hatred, such as all kinds of dogs. Also Lunar are chameleons, who always dress in colors in front of the various colors of objects, just as the Moon shows its various natures on behalf of the various signs.#t_footnote(<nt454>, "nr454")[15] Also Lunar are pigs, deer, female goats, and any animal that observes and imitates the motion of the Moon, such as baboons#t_footnote(<nt455>, "nr455")[16] and leopards. Indeed, there is a spot on [a leopard’s] shoulder similar to the Moon, visible as a circle bearing horns but curved. Cats, whose eyes become larger or smaller with the Moon, are Lunar.#t_footnote(<nt456>, "nr456")[17] Of this kind are the many wondrous and strange things that are made with menstrual blood by magicians. Also, hyenas, who change gender,#t_footnote(<nt457>, "nr457")[18] and are guilty of various enchantments, and all animals that are called amphibious who live on land as well as water, such as beavers, otters,#t_footnote(<nt458>, "nr458")[19] and those that hunt fish. Additionally, are all strange animals, and those without obvious seed or ambiguous generation, such as mice, who [generate] from coition and from the decaying earth.#t_footnote(<nt459>, "nr459")[20]
  ]
  #p_quote[
    #emph[Lunar birds.]
  ]
  #p_normal[
    Among Lunar birds are geese, ducks, grebes,#t_footnote(<nt460>, "nr460")[21] and all aquatics and hunters of fish, and those that equivocally produce, such as wasps from out of the cadavers of horses, bees from a rotting cow, small flies from corrupted wine,#t_footnote(<nt461>, "nr461")[22] and scarabs from an ass’s flesh.
  ]
  #p_normal[
    However, especially Lunar is the two-horned beetle, which is called bull-like, who buries the little balls and leaves them there for twenty-eight days, which is the total measure of the Lunar zodiac. But on the twenty-ninth day, which it thinks will be a conjunction of the luminaries,#t_footnote(<nt462>, "nr462")[23] it uncovers [the balls] and throws them in the water, from which then scarabs emerge.#t_footnote(<nt463>, "nr463")[24]
  ]
  #p_quote[
    #emph[Lunar fish.]
  ]
  #p_normal[
    Among Lunar fish are the #emph[aelurus,]#t_footnote(<nt464>, "nr464")[25] whose eyes turn according to the Moon’s changes, and whatever [aquatic animal that] watches the movement of the Moon, including electric rays,#t_footnote(<nt465>, "nr465")[26] echeneis, crabs, oysters,#t_footnote(<nt466>, "nr466")[27] shellfish, and frogs.
  ]
]
...
#character[
  ...
  #p_normal[
    Saturnine things among elements are earth and water; among humors are black bile, which is moist, and of tastes the acidic, sharp, and heavy.#t_footnote(<nt467>, "nr467")[1]
  ]
  #p_normal[
    Among metals is lead (because of its weight), and among stones are gold marcasite, onyx,
#emph[ziazaa],#t_footnote(<nt468>, "nr468")[2]#emph[camoinus],#t_footnote(<nt469>, "nr469")[3] sapphire, smoky jasper, chalcedony, lodestone, and all [stones] earthy, dark, and heavy.#t_footnote(<nt470>, "nr470")[4]
  ]
  #p_normal[
    Among plants and trees are the asphodel,#t_footnote(<nt471>, "nr471")[5]#emph[serpentaria,]#t_footnote(<nt472>, "nr472")[6] rue, cumin, hellebore, #emph[silphium,]#t_footnote(<nt473>, "nr473")[7] mandrake, and opium. [Any botanical] that stupefies,#t_footnote(<nt474>, "nr474")[8] does not sow, does not bring fruit, has black berries, or produces black fruit (such as the black fig#t_footnote(<nt475>, "nr475")[9] or pine) is under Saturn. Cypress, a funerary tree#t_footnote(<nt476>, "nr476")[10] that does not grow berries, is also of this kind. Again, anything that is grim, bitter tasting, has a violent odor, is colored an unpleasant shade with a bitter resin, bears unnecessary fruit, and/or is incorruptibly hard is similarly presided over by that planet. Also [plants that are associated with] death and sacred to Dis,#t_footnote(<nt477>, "nr477")[11] such as parsley#t_footnote(<nt478>, "nr478")[12] with which the ancients covered tombs before corpses were placed into them. This is why, in festivals, it was lawful to tie all herbs and flowers to garlands except parsley, because parsley was mournful and did not bring cheer.
  ]
  #p_quote[
  ...
  #p_normal[
    Among Saturnine birds are those that have long necks and coarse voices, such as cranes and ostriches. Peacocks#t_footnote(<nt479>, "nr479")[13] are sacred to both Saturn and Juno. Also [Saturnine] are screech owls, small owls, bats, hoopoes, ravens, and quails—the most envious of birds.#t_footnote(<nt480>, "nr480")[14]
  ]
  #p_normal[
    Among fish are eels, which live separately from other fish,#t_footnote(<nt481>, "nr481")[15]#emph[musipulas,]#t_footnote(<nt482>, "nr482")[16] and dogfish, who devour their young. Also [Saturnine] are tortoises, oysters, conchs, sea sponges, and those that are from them.#t_footnote(<nt483>, "nr483")[17]
  ]
]
...
#character[
  ...
  #p_normal[
    Jupiter has among the elements air. Among the humors [Jupiter has] blood and vital spirit, and also that which augments and nourishes life and vegetation. Of tastes, [he has] the sweet and agreeable.#t_footnote(<nt484>, "nr484")[1]
  ]
  #p_normal[
    [The metals under Jupiter are] tin, silver, and gold, because of its temperament.#t_footnote(<nt485>, "nr485")[2] Among stones the hyacinth, beryl, sapphire, #emph[tuthia],#t_footnote(<nt486>, "nr486")[3] emerald, green jasper, and perpetually green and airy colors.#t_footnote(<nt487>, "nr487")[4]
  ]
  #p_normal[
    Among plants and trees are Jove’s beard,#t_footnote(<nt488>, "nr488")[5] basil, prickly ox tongue,#t_footnote(<nt489>, "nr489")[6] mace, spikenard,#t_footnote(<nt490>, "nr490")[7] mint, mastic, elecampane, violet, lily,#t_footnote(<nt491>, "nr491")[8] and henbane.#t_footnote(<nt492>, "nr492")[9] Also poplar and those trees that are happy,#t_footnote(<nt493>, "nr493")[10] such as the aesculus,#t_footnote(<nt494>, "nr494")[11] oak, holm-oak,#t_footnote(<nt495>, "nr495")[12] beech tree, hazel tree, poplar,#t_footnote(<nt496>, "nr496")[13] service tree, white fig, pear tree, apple tree, vine, plum tree, dogwood,#t_footnote(<nt497>, "nr497")[14] and also olives and their oil. [He] also [has] grain, barley, wheat, raisin, licorice, sugar, and all that is sweet, clear, and subtle. Jupiter shares anything that tastes astringent and sharp, such as nuts, almond, pine, filbert, pistachio, peony root, myrobalan, rhubarb, and manna. Orpheus likewise assigns the styrax.#t_footnote(<nt498>, "nr498")[15]
  ]
  #p_normal[
  ...
  #p_normal[
    Among birds are those with temperate complexions, such as hens and their egg yolks. Likewise [are] partridges, pheasants,#t_footnote(<nt499>, "nr499")[16] swallows, and pelicans. Also [are] the 
#emph[cucupha]#t_footnote(<nt500>, "nr500")[17] and stork, which signify affection and gratitude. The eagle is sacred to [Jupiter]. It is the insignia of emperors and a symbol of justice and mercy.#t_footnote(<nt501>, "nr501")[18]
  ]
  #p_quote[
    #emph[The eagle was the insignia of emperors and symbol of justice.]
  ]
  #p_normal[
    Among fish are the dolphin, #emph[anchia,]#t_footnote(<nt502>, "nr502")[19] and sheatfish because of their loyalty.
  ]
]
...
#character[
  ...
  #p_normal[
    The Martial element is fire, and in an equal manner all scorching and sharp [things]. Among humors [he has] choler. Among tastes, [he has] bitter, sharp and burning the tongue, and that which is said to cause tears.#t_footnote(<nt503>, "nr503")[1]
  ]
  #p_normal[
    Among metals, iron, red brass, and all things fiery, red, and sulfurous [are Martial]; for stones [Mars has] the diamond, lodestone, bloodstone,#t_footnote(<nt504>, "nr504")[2] many kinds of jasper, and amethyst.
  ]
  #p_normal[
    The plants and trees [are] the hellebore, garlic, euphorbium, #emph[cartabana,]#t_footnote(<nt505>, "nr505")[3] ammoniac, radish, laurel, wolfsbane, scammony, and all that are poisonous and abundantly hot.#t_footnote(<nt506>, "nr506")[4] Those plants protected by pointed spines, or which burn, prick, or cause swelling when touching the skin [are Martial], such as the thistle and stinging nettle. [Mars also rules] that which, when eaten, causes tears. This includes onion, shallot,#t_footnote(<nt507>, "nr507")[5] leek, mustard, and castor. [It presides over] all trees that are thorny and horned.#t_footnote(<nt508>, "nr508")[6]
  ]
  #p_normal[
    Of animals, [Mars has] those that are warlike, grabbing, bold, and of a transparent imagination—such as horses, mules, male goats, kids, wolves, panthers,#t_footnote(<nt509>, "nr509")[7] wild asses, and likewise serpents and dragons, which are poisonous and hostile. In addition, whatever disturbs men, such as fleas, and gadflies,#t_footnote(<nt510>, "nr510")[8] and baboons because of their anger.#t_footnote(<nt511>, "nr511")[9]
  ]
  #p_normal[
    [Mars has] all grasping birds, carnivorous, and breakers of bones. These include eagles, falcons, and those birds that are said to be dreadful and deadly, small owls, tawny owls, kestrels,#t_footnote(<nt512>, "nr512")[10] kites, and those that are always hungry, grasping, and emit a strangling voice when swallowing, such as ravens and crows.#t_footnote(<nt513>, "nr513")[11] Magpies among the others are most sacred to Mars.
  ]
  #p_normal[
    Of fish [are] pikes, red mullets, stingrays, #emph[aries],#t_footnote(<nt514>, "nr514")[12]#emph[hircum],#t_footnote(<nt515>, "nr515")[13]#emph[lupum],#t_footnote(<nt516>, "nr516")[14]#emph[glaucum],#t_footnote(<nt517>, "nr517")[15] and those that are likewise voracious and grasping.
  ]
]
...
#character[
  ...
  #p_normal[
    Venus has among the elements air and water.#t_footnote(<nt518>, "nr518")[1] Among humors, [she has] phlegm with blood, spirit, and seed. Among tastes, she has the sweet, oily, and delectable.
  ]
  #p_normal[
    Among metals are silver and both the yellow and red types of brass;#t_footnote(<nt519>, "nr519")[2] for the stones are those that are agreeable such as beryl, chrysolite, emerald, sapphire, green jasper, cornelian, aetite, lapis lazuli, coral, and all [minerals that are] beautiful, multicolored, and colored white or green.#t_footnote(<nt520>, "nr520")[3]
  ]
  #p_normal[
    For plants and trees there are verbena,#t_footnote(<nt521>, "nr521")[4] violet, maidenhair, and the herb #emph[lucia,] or valerian, which the Arabs call #emph[phu,] and thyme, labdanum, amber, musk, sandalwood, coriander, all incenses, and delectable and agreeable fruit, such as the sweet pear, fig, and pomegranate, which poets say was first sown by Venus in Cyprus. Also dedicated to her are the rose of Lucifer#t_footnote(<nt522>, "nr522")[5] and myrtle of Hesperus.#t_footnote(<nt523>, "nr523")[6]
  ]
  #p_normal[
    Among animals [Venus] has the luxurious, delicate, and strongly amorous, such as dogs, rabbits, young sheep, the female and male goats, and other animals who breed quickly, who it is said, couple again seven days after begetting.#t_footnote(<nt524>, "nr524")[7] Also Venusian are bulls because of their contempt and calves because of their playfulness.
  ]
  #p_quote[
    #emph[Male goats are lustful.]
  ]
  #p_normal[
    Among birds are swans, wagtails, swallows,#t_footnote(<nt525>, "nr525")[8] pelicans, and Egyptian geese,#t_footnote(<nt526>, "nr526")[9] who especially love their chicks.#t_footnote(<nt527>, "nr527")[10] Ravens and pigeons are sacred to Venus, as are turtledoves. These birds were used in offerings for purifications for birth. Sparrows are also sacred to Venus and were appointed by law to be used in purifications for leprosy, a Martial disease, which resists nothing else beneficial.#t_footnote(<nt528>, "nr528")[11] Also, the Egyptians called eagles Venereal because they are prone to be Venusian: for if the female is conquered thirty#t_footnote(<nt529>, "nr529")[12] times a day, and if a male calls, she charges again.#t_footnote(<nt530>, "nr530")[13]
  ]
  #p_normal[
    The Venusian fish are the libidinous #emph[grues;]#t_footnote(<nt531>, "nr531")[14] the salacious 
#emph[scari;]#t_footnote(<nt532>, "nr532")[15] the #emph[merulae;]#t_footnote(<nt533>, "nr533")[16] because they love their young; the crab because it fights for its mate; and the spurge because of its fragrant and sweet scent.
  ]
]
...
#character[
  ...
  #p_normal[
    Of elements Mercury has water, although it surreptitiously moves among all [elements].#t_footnote(<nt534>, "nr534")[1] Among humors, it is especially mixed. [Mercury] also regulates the animal spirit, and among tastes, the various, exotic, and mixed.#t_footnote(<nt535>, "nr535")[2]
  ]
  #p_normal[
    Of metals, he has quicksilver, tin, and silver marcasite; for stones [Mercury has] emerald, agate, porphyrite, topaz, and all with many colors and many shapes engrafted by nature, or an artificial art, such as glass, and those that are a mixed yellow and green.#t_footnote(<nt536>, "nr536")[3]
  ]
  #p_normal[
    Among plants and trees [that belong to Mercury, are] hazel, cinquefoil, dog’s mercury,#t_footnote(<nt537>, "nr537")[4] fumitory, burnet saxifrage,#t_footnote(<nt538>, "nr538")[5] marjoram, parsley, and those that have shorter and smaller leaves, mixed natures, and are composed of varying colors.#t_footnote(<nt539>, "nr539")[6]
  ]
  #p_normal[
    Of animals, [Mercury has] the sagacious, clever, active, and those of a versatile nature, running swiftly, and having an easy manner with men. These are dogs, apes, foxes, weasels, stags,#t_footnote(<nt540>, "nr540")[7] mules, hermaphroditic animals, and those who change sex in turn, such as hares, hyenas,#t_footnote(<nt541>, "nr541")[8] and the like.
  ]
  #p_normal[
    Among birds are those who are naturally clever, melodious, musical, and versatile, such as the goldfinch, #emph[ficedulae,]#t_footnote(<nt542>, "nr542")[9] blackbird, thrush, lark, nightingale, #emph[calandris,]#t_footnote(<nt543>, "nr543")[10] parrot, magpie, ibis,#t_footnote(<nt544>, "nr544")[11] porphyrio,#t_footnote(<nt545>, "nr545")[12] and onehorned scarab.#t_footnote(<nt546>, "nr546")[13]
  ]
  #p_normal[
    [The Mercurial] fish are the trochus, which enters into himself and who is said to be male and female,#t_footnote(<nt547>, "nr547")[14] the octopus because he is deceitful and changes colors,#t_footnote(<nt548>, "nr548")[15] and the stingray because of its skill.#t_footnote(<nt549>, "nr549")[16] The gray mullet, who discards bait off the hook with its tail,#t_footnote(<nt550>, "nr550")[17] [is likewise Mercurial in nature].
  ]
]
...
#character[
  ...
  #p_normal[
    In a similar way, natural active causes follow the Sun; however, matter is with the Moon, fertile active causes [follow] Jupiter, material fertility is Venus, sudden expeditious effects are with Mars and Mercury—[Mars] for his vehemence, and [Mercury] for his dexterity and his many-faceted virtues—but Saturn is dedicated to the permanent continuation of all.#t_footnote(<nt551>, "nr551")[1]
  ]
  #p_normal[
    In vegetation, we consider all fruit as belonging to Jupiter, all flowers as belonging to Venus, all seeds and bark to Mercury, all roots with Saturn, all wood with Mars, and leaves with the Moon.#t_footnote(<nt552>, "nr552")[2]
  ]
  #p_normal[
  ...
  #p_normal[
    Similarly, in stones, their heaviness, adhesiveness, and constrictiveness are with Saturn; kindness and temperateness with Jupiter; hardness with Mars; life with the Sun; grace and beauty with Venus; occult virtue with Mercury; and common kindness with the Moon.#t_footnote(<nt553>, "nr553")[3]
  ]
]
...
#character[
  ...
  #p_normal[
    The kingdoms and provinces of the orb of the world are distributed among the planets and signs. For instance, Saturn with Capricorn is over Macedonia, Thrace, Illyria, India, Arriana,#t_footnote(<nt554>, "nr554")[1] Gordiana,#t_footnote(<nt555>, "nr555")[2] and much of the area of Asia Minor. [Saturn] with Aquarius rules over the kingdom of Sauromatia,#t_footnote(<nt556>, "nr556")[3] Oxiana,#t_footnote(<nt557>, "nr557")[4] Sogdiana,#t_footnote(<nt558>, "nr558")[5] Arabia, Azania,#t_footnote(<nt559>, "nr559")[6] Media,#t_footnote(<nt560>, "nr560")[7] Ethiopia, and the regions concerning the greater part of inland Asia.
  ]
  #p_normal[
    Jupiter with Sagittarius has Tuscia,#t_footnote(<nt561>, "nr561")[8] Celtica,#t_footnote(<nt562>, "nr562")[9] Spain, and Arabia Felix.#t_footnote(<nt563>, "nr563")[10] [Jupiter] with Pisces [has] Lycia,#t_footnote(<nt564>, "nr564")[11] Lydia,#t_footnote(<nt565>, "nr565")[12] Cilicia,#t_footnote(<nt566>, "nr566")[13] Pamphylia,#t_footnote(<nt567>, "nr567")[14] Nasamonia,#t_footnote(<nt568>, "nr568")[15] and Garamantica.#t_footnote(<nt569>, "nr569")[16]
  ]
  #p_normal[
    Mars with Aries rules Britain, Gaul, Germany, Barstania,#t_footnote(<nt570>, "nr570")[17] the round part of Syria, Idumaeam,#t_footnote(<nt571>, "nr571")[18] and Judea. However [Mars] with Scorpio [has] Syria, Comagenem,#t_footnote(<nt572>, "nr572")[19] Cappadocia, Metagonitidem,#t_footnote(<nt573>, "nr573")[20] Mauritania, and Getuliam.#t_footnote(<nt574>, "nr574")[21]
  ]
  #p_normal[
    The Sun with Leo has Italy, Apulia,#t_footnote(<nt575>, "nr575")[22] Sicily, Phoenicia, Chaldea, Orsenii, or Orchenii.#t_footnote(<nt576>, "nr576")[23]
  ]
  #p_normal[
    Venus with Taurus has the Cyclades, the sea of Asia Minor, Cyprus, Parthia, Media, and Persia. With Libra, she rules Bactria, Caspia, Sericae,#t_footnote(<nt577>, "nr577")[24] Thebais, Oasis,#t_footnote(<nt578>, "nr578")[25] and Troglodytis.#t_footnote(<nt579>, "nr579")[26]
  ]
  #p_normal[
    Mercury with Gemini has Hyrcania,#t_footnote(<nt580>, "nr580")[27] Armenia, Matianam,#t_footnote(<nt581>, "nr581")[28] Cyrenaicam,#t_footnote(<nt582>, "nr582")[29] Marmaricam,#t_footnote(<nt583>, "nr583")[30] and lower Egypt. However, with Virgo, [Mercury has] Greece, Achaea, Crete, Babylon, Mesopotamia, Assyria, and Elam,#t_footnote(<nt584>, "nr584")[31] which is what is called Elamites in the Scriptures.
  ]
  #p_normal[
    The Moon with Cancer follows Bithynia,#t_footnote(<nt585>, "nr585")[32] Phrygia, Cholchis,#t_footnote(<nt586>, "nr586")[33] Numidia, Africa, Carthage and the entire [region] of Carthage.
  ]
  #p_normal[
    We collected these from the opinion of Ptolemy, which, according to the writings of other astrologers, many others can be added.#t_footnote(<nt587>, "nr587")[34]
  ]
  #p_normal[
    However, those who have the divisions of the provinces according to the distributions of the stars, with the ministry of the ruling intelligences, and the blessings of the tribes of Israel and the lots of the apostles,#t_footnote(<nt588>, "nr588")[35] and accept the typical seals of sacred scripture, obtain great and prophetic oracles over each region and are able to foretell the future.
  ]
]
...
#character[
  ...
  #p_normal[
    Apuleius distributed particular signs and planets among certain herbs, such as Aries with sage,#t_footnote(<nt589>, "nr589")[1] Taurus with straight vervain,#t_footnote(<nt590>, "nr590")[2] Gemini with bent vervain,#t_footnote(<nt591>, "nr591")[3] Cancer with comfrey, Leo with cyclamen, Virgo with calamint, Libra with scorpionweed,#t_footnote(<nt592>, "nr592")[4] Scorpio with mugwort,#t_footnote(<nt593>, "nr593")[5] Sagittarius with pimpernel, Capricorn with sorrel,#t_footnote(<nt594>, "nr594")[6] Aquarius with dragonwort, and Pisces with aristolochia. Of planets, Saturn the houseleek, Jupiter agrimony, Mars hogsfennel, the Sun heliotrope, Venus
#emph[callitrichum,]#t_footnote(<nt595>, "nr595")[7] Mercury #emph[phlomum,]#t_footnote(<nt596>, "nr596")[8] the Moon peony.#t_footnote(<nt597>, "nr597")[9]
  ]
  #p_normal[
    However, Hermes [Trismegistus], whom Albertus followed, said the plant of Saturn is asphodel, Jupiter henbane, Mars greater plantain, the Sun knotgrass, Venus verbena, Mercury cinquefoil, and the Moon #emph[chenostacen].#t_footnote(<nt598>, "nr598")[10] I also know by experience that asparagus is under Aries and basil under Scorpio: for, where the shavings of a ram’s horn are planted, asparagus and basil grow, and when bruised between two stones, scorpions are born.
  ]
  #p_quote[
  ...
  #p_normal[
    In addition, I will point out some of the insignias of the stars according to the writings of Hermes and Thabit. The first [star] is called Caput Algol. Among stones it presides over diamonds, and among plants black hellebore and mugwort. Second are the Pleiades. Among stones they preside over crystals and #emph[diodoeo;]#t_footnote(<nt599>, "nr599")[11] among plants #emph[diacedon],#t_footnote(<nt600>, "nr600")[12] frankincense, and fennel; and over metals quicksilver. Third, Aldebaran has among stones carbuncles and rubies, and among planets spurge and woodruff.#t_footnote(<nt601>, "nr601")[13] Fourth is called the Goat.#t_footnote(<nt602>, "nr602")[14] It has among stones sapphire; among plants horehound—[also called] #emph[prasium]—mint, mugwort, and mandrake. Fifth is Canis Major. It has among stones beryl, [among plants] savin juniper, mugwort, and dragonwort and among animals the serpent’s tongue. Sixth, Canis Minor, has among stones agates, and among plants is heliotrope flowers and pennyroyal. Seventh, the Heart of the Lion,#t_footnote(<nt603>, "nr603")[15] has among stones garnet#t_footnote(<nt604>, "nr604")[16] and among plants swallow-wort with mugwort and mastic. Eighth is the tail of Ursa Minor, and it has among stones the magnetic lodestone; among plants chicory, the leaves and flowers of which turn toward the north, mugwort, and periwinkle flower; and among animals the tooth of a wolf. The ninth is called Raven’s Wing,#t_footnote(<nt605>, "nr605")[17] who has among stones onyx (black); among plants the greater burdock (the four-cornered kind),#t_footnote(<nt606>, "nr606")[18] henbane, and comfrey; and among animals the tongue of a frog. The tenth, Spica, has among stones emeralds; among plants sage, trefoil, periwinkle or #emph[promarullam,]#t_footnote(<nt607>, "nr607")[19] mugwort, and mandrake. The eleventh is called Alchameth,#t_footnote(<nt608>, "nr608")[20] who has among stones the jasper and among plants the greater plantain. The twelfth is Elpheia.#t_footnote(<nt609>, "nr609")[21] It has among stones the topaz, and among plants it presides over rosemary, trefoil, and ivy. The thirteenth is called the Heart of the Scorpion.#t_footnote(<nt610>, "nr610")[22] Among stones, it is over the sardonyx and amethyst, among plants the long aristolochia and saffron. The fourteenth is called the Falling Vulture,#t_footnote(<nt611>, "nr611")[23] and it has among stones the chrysolite and among plants savory and fumitory. The fifteenth is called the Tail of Capricorn.#t_footnote(<nt612>, "nr612")[24] It has among stones chalcedony, among plants marjoram, mugwort, catnip, and that which is called calamint (similar to fleabane), as well as mandrake root.#t_footnote(<nt613>, "nr613")[25]
  ]
  #p_normal[
    However, besides these, we must know that no stone, plant, animal, or other thing is ruled by only one star, but many. They also receive many influences, not separate, but together. For example, among stones, chalcedony is under Saturn and Mercury with the Tail of the Scorpion#t_footnote(<nt614>, "nr614")[26] and Capricorn; however, sapphire is with Jupiter and Saturn and the star Alhayoth,#t_footnote(<nt615>, "nr615")[27] and tuthia#t_footnote(<nt616>, "nr616")[28] with Jupiter and the luminaries. Emeralds are with Jupiter, Venus, Mercury, and Spica. Amethyst, according to Hermes, is under Mars with Jupiter and the Heart of the Scorpion. The many kinds of Jasper are under Mars, Jupiter, and the star Alchameth. Chrysolite is with the Sun, Venus, and Mercury, and the star that is called the Falling Vulture. Topaz is with the Sun and Elpheia. Diamond is with Mars and Caput Algol.
  ]
  #p_normal[
    Similarly, among vegetation, the herb #emph[serpentaria] is under Saturn and the celestial Serpent.#t_footnote(<nt617>, "nr617")[29] Mastic and mint are under Jupiter and the Sun, but mastic is also under the Heart of the Lion, and mint under the Goat. Also, the hellebore is with Mars and Caput Algol, musk and sandalwood under the Sun and Venus, and coriander under Venus and Saturn.
  ]
  #p_normal[
    Among animals, the sea-calf is under the Sun and Jupiter. Foxes and apes are under Saturn and Mercury, and domestic dogs are under Mercury and the Moon#t_footnote(<nt618>, "nr618")[30] as we have taught above.
  ]
]
...
#character[
  ...
  #p_img[
    #emph[The letters or characters of the Moon]#t_footnote(<nt623>, "nr623")[5]
  ]
  #p_normal[
...
#character[
  ...
  #p_normal[
    However there is a twofold virtue in mixtures: one in which its parts were previously engrafted and is celestial, and the other is through specific and artificial combinations of many things mixed together according to certain proportions, such as with heavenly agreement, acquired under certain constellations.#t_footnote(<nt626>, "nr626")[1] These virtues descend through the similarities and conditions of certain things toward each other with their superiors, inasmuch as following the preceding corresponding virtues by degree, where the receiver especially accommodates its giver above him.#t_footnote(<nt627>, "nr627")[2]
  ]
  #p_normal[
    Thus, from certain compositions of herbs, vapors, and the like, made with natural philosophy and then astronomy, results a common form endowed with the many gifts of the stars.#t_footnote(<nt628>, "nr628")[3] This is similar to the honey of bees who remove the juice from innumerable flowers and reduce them into one form containing all of their virtues by a divine and admirable art. What is no less wonderful is the artificial honey reported by Eudoxus Gnidius, in which a certain tribe of giants in Libya learned how to make honey from flowers, which was very good and was seen as not very different from the honey from bees.#t_footnote(<nt629>, "nr629")[4]
  ]
  #p_normal[
...
#emph[Kyranides];#t_footnote(<nt630>, "nr630")[5] Archytas, Democritus, and Hermes, who wrote the [the book of]
...
#character[
  ...
  #p_normal[
    Know that the nobler a form something is, that thing is more prepared and more ready for receiving [influences] and also more power for acting.#t_footnote(<nt631>, "nr631")[1] Therefore, incomprehensible things become wonderful#t_footnote(<nt632>, "nr632")[2]—that is, when materials are mixed and prepared at appropriate times, to make them alive, acquiring life from the stars, a sensible soul, and a nobler form.#t_footnote(<nt633>, "nr633")[3]
  ]
  #p_normal[
    Such is the great power of prepared matter, which we then see gain life when a perfect mixture of qualities seems to break the previous contrariety. However, the more perfect takes life, but by as much as their complexion is removed from contrariety. Indeed, the heavens are a very powerful cause from which each thing is initiated into generation, by the concoction and perfect coming together of matter.#t_footnote(<nt634>, "nr634")[4] It grants celestial influences and wonderful gifts with life,#t_footnote(<nt635>, "nr635")[5] as much as is contained in life itself and in the sensible soul, [these qualities being present] according to more noble virtues and sublime conceptions.
  ]
  #p_normal[
    Additionally, celestial virtue often lies asleep elsewhere. For example, sulfur is far from f lame, but in living bodies it is often inflamed as kindled sulfur. Then its vapor fills all that is near it.#t_footnote(<nt636>, "nr636")[6] Thus, certain wonderful works are produced, as is compiled in the book 
#emph[Nemith] and written in the book #emph[The Laws of Plato]. Generations of this sort are monstrous, unless they are produced according to the laws of nature.#t_footnote(<nt637>, "nr637")[7]
  ]
  #p_quote[
    #emph[The procreation of various animals.]
  ]
  #p_normal[
    Indeed, we know that gnats are generated from worms.#t_footnote(<nt638>, "nr638")[8] Wasps [are generated] from horses,#t_footnote(<nt639>, "nr639")[9] and from calves and cows [come] bees. Scorpions [are generated] from a crab, if its feet are removed and buried. Frogs are generated from a dried duck when ground into powder and thrown into water, but if baked into a cake, cut into pieces, and left in a damp and underground place, it will generate toads. Scorpions are generated from the herb basil if rubbed between two stones. If the hair of a menstruating woman is placed under dung, it will produce serpents. If the hair from the tail of a horse is thrown into water, it will conceive life and will turn into dangerous worms. There is an art in which an egg generates a form similar to a man, of which I have seen and learned to compose, and magicians say holds wonderful virtues,#t_footnote(<nt640>, "nr640")[10] and they also say this is true of the mandrake.
  ]
  #p_normal[
    Therefore, you must recognize which and what kinds of materials, either by nature or art, begun or completed, or collected from many [things], which celestial influences they are able to receive.#t_footnote(<nt641>, "nr641")[11] Indeed, the agreement of natural things is sufficient for drawing from celestial influences: because nothing hinders the celestials from pouring down their light toward the inferiors, and they permit no matter from being void of their virtues.#t_footnote(<nt642>, "nr642")[12]
  ]
  #p_normal[
    Wherever as much matter is perfect and pure, it is not unfit for receiving celestial influences.#t_footnote(<nt643>, "nr643")[13] Indeed, there are connections and continuities between matter and the World Soul, which f low daily over natural things, and all things prepared by nature, as it is impossible for a prepared material to not influence life or a certain nobler form.
  ]
  #p_quote[
...
#character[
  ...
  #p_normal[
    From these examples, we see how certain reliable natural and artificial preparations can accept certain celestial gifts from above.#t_footnote(<nt650>, "nr650")[7] Indeed, stones and metals agree with herbs, herbs with animals, and truly [animals] with the heavens, [the heavens] with the intelligences, and [the intelligences] with divine qualities and attributes together with God, to whom all likenesses and images are created. But the first likeness of God is the universe, man of the universe, animal of man, zoophytum of animals, [zoophytum] with plants, but plants of metals, and of [metals] stones represent similar images.#t_footnote(<nt651>, "nr651")[8] Again in spirituality, plants agree with beasts in vegetation, beasts with man in senses, man with daemons in intellect, and [daemons] with God in immortality.#t_footnote(<nt652>, "nr652")[9] 
Divinity is connected with mind, mind with intellect, intellect with intention, intention with imagination, imagination with senses, and finally the senses with things.#t_footnote(<nt653>, "nr653")[10]
  ]
  #p_quote[
...
#character[
  ...
  #p_normal[
    Magicians teach that by inferiors conforming to superiors, [inferiors] can draw appropriate celestial influences from the heavens. Thus, likewise through these, celestials and celestial daemons, as they are the attendants of the stars, can be acquired and insinuate [themselves into] us. Whereby certain reliable materials have a natural power of divinity and a natural harmony with the superiors, rightly collected, partially with natural science, partially with astronomy, are suitably aroused on all sides. The gifts are not only celestial or vital but certain intellectual, daemonic, and divine gifts are received from above as well. This is confirmed by Iamblichus, Proclus, Synesius, and the whole Platonic school.#t_footnote(<nt655>, "nr655")[1] Hermes Trismegistus wrote of certain special things about a particular appropriate daemon—that is, where an appropriate image is composed and animated by the appropriate daemon.#t_footnote(<nt656>, "nr656")[2] Augustine also remembers this in the eighth book of 
#emph[City of God].#t_footnote(<nt657>, "nr657")[3]
  ]
  #p_normal[
    Indeed, this is the harmony of the universe: as the super-celestial can be drawn down by the celestial, so the supernatural can be drawn down by the natural. This is because one operative virtue is diffused through all kinds of participating things.#t_footnote(<nt658>, "nr658")[4] Indeed, this virtue is produced by occult reasons. Thus, the magician takes these manifestations so that he attracts occult things; for example, [one may attract] the rays of the stars through fumigations, lights, sounds, and natural things that agree with the celestials. Besides their corporeal qualities, [these things] also belong to incorporeal and divine reason: senses, number, and measurements.
  ]
  #p_quote[
    #emph[Magicians attract occult things from manifestations.]
  ]
  #p_normal[
    Thus, we read that the ancients often accepted something divine and wonderful through certain natural things.#t_footnote(<nt659>, "nr659")[5] For example, a stone that is produced in the pupil of a hyena’s eye, if held under the tongue, excels in allowing one to speak predictions.#t_footnote(<nt660>, "nr660")[6] The same effect is said of selenites, a Lunar stone.#t_footnote(<nt661>, "nr661")[7] Also, the stone 
#emph[anchitide]#t_footnote(<nt662>, "nr662")[8] is said to summon images of the gods, and the #emph[synochitide] when held summons inferior shades.#t_footnote(<nt663>, "nr663")[9] Similarly, the herb 
#emph[aglaopotis,] which is also called #emph[marmoritides] and grows on the side of marble in Arabia and Persia, is also effective, as Pliny said, and “magicians use this when they wish to summon the gods.”#t_footnote(<nt664>, "nr664")[10] As well, magicians can prophesy with the herb called 
#emph[theangelidam] when it is drunk.#t_footnote(<nt665>, "nr665")[11] Besides these, there are also herbs with which the dead can come back to life. The historian Xanthus wrote that with a certain herb called #emph[bali] a young dragon that was killed was brought back to life, and a certain man [named] Tillon who was killed by a dragon was brought back to life.#t_footnote(<nt666>, "nr666")[12] Juba reported that in Arabia a man was brought back to life with a certain herb.
  ]
  #p_quote[
    #emph[Tillon restored to life by an herb.]
  ]
  #p_normal[
    However, whether such things are possible to men from the power of herbs or any other natural thing will be discussed later, but if they are possible in other animals, it is certain and known. Thus, if a drowned fly is placed in warm ash, it will come back to life,#t_footnote(<nt667>, "nr667")[13] and drowned bees will likewise revive in the juice of catnip.#t_footnote(<nt668>, "nr668")[14] Eels that are dead from not enough water, if their entire bodies are placed under dung, and vinegar and the blood of a vulture is added, will revive after a few days.#t_footnote(<nt669>, "nr669")[15] It is said that if an echeneis is cut into small pieces and thrown into the sea, after a while the parts will come together and come to life again. Likewise, we know that a pelican, when killed, can restore its chicks to life with its own blood.#t_footnote(<nt670>, "nr670")[16]
  ]
  #p_quote[
...
#character[
  ...
  #p_normal[
    No one ignores that evil daemons can be drawn with evil and profane arts, as Psellus said. Gnostic magicians customarily performed powerful curses and abominable disgraces#t_footnote(<nt671>, "nr671")[1] in the past, such as sacrifices to Priapus, and served idols named Panor, to whom they sacrificed with their genitals uncovered. This is not unlike (if this is true and not a fable) what we read about the Templars’ detestable heresy,#t_footnote(<nt672>, "nr672")[2] and there are similar heresies of female witches, where indeed demented old women are often shamefully apprehended in error.
  ]
  #p_quote[
    #emph[Evil daemons are easily drawn by evil arts.]
  ]
  #p_normal[
    Therefore from these and the like, evil daemons are drawn and conspire, just as the malignant daemon said to John about the magician Cynops: “All the power of Satan inhabits that place, and he enters into a conspiracy with all principalities and we with him; Cynops obeys us and we obey him.”#t_footnote(<nt673>, "nr673")[3] Again, no one ignores the opposite that super-celestial angels can be received by us through good operations with a pure mind, mysterious orations, devoted supplications, and the like.
  ]
  #p_quote[
    #emph[Good angels are received by good operations.]
  ]
  #p_normal[
    Therefore, no one can doubt that in a similar way and with certain reliable materials of the world, we can likewise draw gods of the world, or as many daemons, the ministers or footmen of these gods—as Hermes [Trismegistus] said, daemons of the air, not super-celestial and less high.#t_footnote(<nt674>, "nr674")[4]
  ]
  #p_normal[
    Thus we read that ancient priests made statues and images that predicted the future and infused them with the spirits of the stars. These spirits were not confined in such material but were happy there; they found that material agreeable to them, always and willingly inhabiting there. While there, they spoke and brought about miracles. Nothing other than daemons#t_footnote(<nt675>, "nr675")[5] can inhabit human bodies.
  ]
]
...
#character[
  ...
  #p_normal[
    The power of sorceries is said to be so great that they are believed to subvert, dry, and change all inferiors,#t_footnote(<nt679>, "nr679")[1] as Virgil sang: #emph[These herbs and poisons gathered in Pontus]
  ]
  #p_poetry[
  ...
  #p_poetry[
    #emph[And seen him sow crops in other’s fields.]#t_footnote(<nt680>, "nr680")[2]
  ]
  #p_normal[
  ...
  #p_poetry[
    #emph[Circe changed into shapes and forms of wild beasts.]#t_footnote(<nt681>, "nr681")[3]
  ]
  #p_normal[
    And later:
  ]
  ...
  #p_poetry[
    #emph[Into a bird, and Circe sprinkled his wings with colors.]#t_footnote(<nt682>, "nr682")[4]
  ]
  #p_normal[
  ...
  #p_poetry[
    #emph[The entrails of a lynx, nor the hard knot]#t_footnote(<nt683>, "nr683")[5]#emph[of the hyena]
  ]
  #p_poetry[
...
#character[
  ...
  #p_poetry[
    #emph[And mix with herbs and harmful words.]#t_footnote(<nt696>, "nr696")[10]
  ]
  #p_normal[
  ...
  #p_poetry[
    #emph[Given to stepsons . . .]#t_footnote(<nt697>, "nr697")[11]
  ]
  #p_normal[
    Apollonius wrote in his #emph[Argonautica] about the herb Prometheus, which he said grows from the gore and blood dripping onto the earth from Prometheus’s liver when the vulture lacerated and devoured it in the Caucasus mountains: “which flower, it is said, is similar to saffron, colored yellow, double-stemmed, and measuring a cubit high. The roots are underground and its freshly cut flesh and juice coming from it is black as if it were beech.”#t_footnote(<nt698>, "nr698")[12] [This herb], if they were able, before completing their devotions to Proserpina, should be smeared on the body, so that they will not be harmed by either weapon or fire. Saxo Grammaticus wrote of the garment of a certain man named Frode,#t_footnote(<nt699>, "nr699")[13] which while on, could not be pierced by any spear or anything sharp.#t_footnote(<nt700>, "nr700")[14]
  ]
  #p_quote[
    #emph[Sorcery of hyenas.]
  ]
  #p_normal[
    Hyenas also inflict many sorceries: for instance, as referred by Pliny, its blood applied to doorposts, damages the skills of magic, so that one will neither be able to elicit or talk to the gods, in any way.#t_footnote(<nt701>, "nr701")[15] Likewise, the ashes of [a hyena’s] left ankle boiled with the blood of a weasel and smeared all over causes hatred. This also happens with a boiled eye. Additionally, the tube of the outer intestine counteracts powerful iniquities from leaders and administrators, for successful petitions, and for influencing the judgments of lawsuits, if anyone has a small amount [of the intestines] with them. Likewise, if [the intestine] is bound to the left arm, it will prompt love when they see a woman, and she will follow him.#t_footnote(<nt702>, "nr702")[16] The skin of the forehead resists bewitchings.#t_footnote(<nt703>, "nr703")[17]
  ]
  #p_quote[
    #emph[Sorcery of basilisks and their blood.]
  ]
  #p_normal[
    Likewise, the blood of a basilisk, which they call the blood of Saturn, is said to be such a powerful sorcery that bearing it is powerful for granting success in petitions, praying to gods, curing sickness, and favor in appointments.#t_footnote(<nt704>, "nr704")[18]
  ]
  #p_normal[
    Likewise, they say that if a tick is pulled from a dog’s left ear, and that tick only be the color black, it augurs great strength in life. For instance, if a person brings such a tick to a sick person, stands at their feet, asks about his illness, and the sick person responds, it is a certain hope for life.#t_footnote(<nt705>, "nr705")[19]
  ]
  #p_normal[
    It is likewise said that a stone bitten by a rabid dog has the power of discord if it is placed in a drink.#t_footnote(<nt706>, "nr706")[20] One will not be barked at by dogs if a dog’s tongue is placed in the shoe or under the big toe,#t_footnote(<nt707>, "nr707")[21] especially if joined with the herb of the same name—that is, hound’s tongue.#t_footnote(<nt708>, "nr708")[22] The same happens with the membrane of a dog’s afterbirth,#t_footnote(<nt709>, "nr709")[23] but dogs flee from those carrying a dog’s heart.#t_footnote(<nt710>, "nr710")[24]
  ]
  #p_normal[
    Pliny wrote about frogs called #emph[rubetarum,]#t_footnote(<nt711>, "nr711")[25] which are only found in thorn bushes, are full of sorceries, and make wonderful things happen. For instance, the small bone that is on its left side will immediately boil cold water if thrown into it. It will restrain attacking dogs and stir up love and quarrels if added to potions. If bound to someone, it will incite lust. The opposite bone, because it is on the right side, will cool boiling water, and [the water] will not boil afterward unless removed. It will cure quartan fevers if bound in fresh lamb’s#t_footnote(<nt712>, "nr712")[26] skin, and it inhibits other fevers, love, and lust. However, the spleen and heart from this frog helps against sorceries which come from it.#t_footnote(<nt713>, "nr713")[27] Pliny wrote this.
  ]
  #p_normal[
...
#character[
  ...
  #p_normal[
    Certain fumigations are also suitable for many of the stars, inasmuch as air and spirit#t_footnote(<nt715>, "nr715")[1] can exceedingly affect [things] by grasping appropriate celestial gifts under the rays of the stars. Indeed, our spirits are very much changed by these vapors because each is a vapor similar to the other. Also, air through these vapors is easily affected by inferior and celestial qualities, continuously and suddenly entering our breasts, bringing us wonderful qualities.#t_footnote(<nt716>, "nr716")[2] This is why fumigations are used to summon mental images for prophecies, which are suitable for certain divinities for conforming us to accept divine inspiration.#t_footnote(<nt717>, "nr717")[3] Thus it is said that fumigations made from flax and psyllium#t_footnote(<nt718>, "nr718")[4] seeds, violet roots, and parsley cause visions of future things and bring prophecy.#t_footnote(<nt719>, "nr719")[5]
  ]
  #p_quote[
    #emph[Fumigations conducive for prophecy.]
  ]
  #p_normal[
    No one can truly wonder how great fumigations are in air. Porphyry believed that certain reliable vapors exhaling from special fumigations immediately draw and introduce airy daemons,#t_footnote(<nt720>, "nr720")[6] inducing thunder and lightning, and the like. For example, burning a chameleon’s liver on the top of a roof arouses rain and thunder; similarly, [a chameleon’s] head and throat, if burned with oak wood, also makes violent rain and thunder.#t_footnote(<nt721>, "nr721")[7]
  ]
  #p_normal[
...
#emph[ferulae]#t_footnote(<nt722>, "nr722")[8] with hemlock juice, henbane, #emph[tassi barbassi,]#t_footnote(<nt723>, "nr723")[9] red sandalwood, and black poppyseed causes daemons and unusual figures to appear. If parsley#t_footnote(<nt724>, "nr724")[10] is added to this, daemons will flee from all places and destroy the images. In a similar way a fumigation made from calamint, peony, mint, and the castor oil plant#t_footnote(<nt725>, "nr725")[11] drives away all evil spirits and harmful phantoms.#t_footnote(<nt726>, "nr726")[12]
  ]
  #p_quote[
...
#emph[liparis]#t_footnote(<nt727>, "nr727")[13] mentioned by Pliny summons all beasts.#t_footnote(<nt728>, "nr728")[14] Thus, the bones at the top of the throat of a stag gather serpents, but a fumigation of a deer’s antler chases them away.#t_footnote(<nt729>, "nr729")[15] The same [effect] happens [with serpents] with a fumigation of peacock feathers.#t_footnote(<nt730>, "nr730")[16] Similarly, burning an ass’s lung chases away all venomous things. A fumigation of a horse’s hoof chases away mice from the house. The same happens with the hooves of a she-mule, and flies are likewise chased away if the left hoof is [burned].#t_footnote(<nt731>, "nr731")[17] It is said that if a house is fumigated from any place with the gall of a cuttlefish mixed with 
	#emph[thymiamate,]#t_footnote(<nt732>, "nr732")[18] roses, and lignum aloe, and then if seawater or blood is left in that place, the entire house will be seen as full of [water] or blood. If [the fumigation mixture] is left there with plowed earth, the earth will be seen as quaking.#t_footnote(<nt733>, "nr733")[19]
  ]
  #p_normal[
    But vapors of this kind will affect any body (although these virtues influence and persist daily) as can be observed, [in the same way as] any contagion or poisonous pestilent vapor. If they are kept in the walls of a house beyond two years, [the vapors] inflict the inhabitants, and with epidemics or leprosy hidden in clothes when worn daily, will infect the wearer.#t_footnote(<nt734>, "nr734")[20]
  ]
  #p_normal[
    Images and rings and the like are magical instruments, and certain fumigations summon hidden treasures, of which no less than Porphyry testified.#t_footnote(<nt735>, "nr735")[21] Thus it is said: “If one can bury gold, silver, or any other valuable with the Sun and Moon conjunct the 
	#emph[Imum coeli,]#t_footnote(<nt736>, "nr736")[22] then fumigate that place with coriander, saffron, henbane, parsley, and black poppyseed in equal weights, bruised and steeped in hemlock juice. At no time will this be discovered or stolen, because thus hidden, it is always guarded by daemons. If anyone attempts to steal from there, they will be vexed and fall into madness.”#t_footnote(<nt737>, "nr737")[23]
  ]
  #p_normal[
    Hermes said that there is nothing equal to a fumigation of spermaceti#t_footnote(<nt738>, "nr738")[24] for drawing daemons: if [it is] steeped with lignum aloe, costus, musk, saffron, and
#emph[thymiamate,] with the blood of a hoopoe, and made into a fumigation, it gathers airy spirits very quickly. If it is fumigated around the graves of the dead, it gathers shades of the underworld and shades of the dead.#t_footnote(<nt739>, "nr739")[25]
  ]
  #p_normal[
    Thus, often when we direct operations for the Sun, we use Solar fumigations; for the Moon, Lunar fumigations, and similarly for the rest. And you must know that, as there are oppositions and enmity in the stars and spirits, it is also the case in the fumigations for them. For example, lignum aloe and sulfur are contrary to each other, as are frankincense and quicksilver; and spirits induced by burning lignum aloe and sulfur will flee.#t_footnote(<nt740>, "nr740")[26] Proclus gives an example of a spirit who usually appeared in the form of a lion, but by throwing a rooster before it, it soon disappeared, because roosters are contrary to lions.#t_footnote(<nt741>, "nr741")[27] Thus, consider and practice this in a like fashion.
  ]
]
...
#character[
  ...
  #p_normal[
    For Mars, we take euphorbium, bdellium, ammoniac,#t_footnote(<nt742>, "nr742")[1] the roots of each [black and white] hellebore, lodestone, and a little sulfur. Incorporate everything with the blood of a raven,#t_footnote(<nt743>, "nr743")[2] blood of a human, and blood of a black cat.
  ]
  #p_normal[
  ...
  #p_normal[
    In addition to these fumigations, of Saturn are all fragrant roots, costus, and the herb frankincense.#t_footnote(<nt744>, "nr744")[3] Fumigations of Jupiter are fragrant fruits, such as nutmeg and cloves. Of Mars are all fragrant woods such as sandalwood, cypress, balsam, and lignum aloe. For the Sun are all gums, frankincense, mastic, benzoin, storax, labdanum, amber, and musk. Of Venus are flowers, rose, violet, saffron, and the like. Mercury has all bark from wood and fruit, such as cinnamon, cassia wood, mace, citrus peel, laurel grain,#t_footnote(<nt745>, "nr745")[4] and all fragrant seeds. The Moon has for fumigations vegetation and all leaves, such as malabar#t_footnote(<nt746>, "nr746")[5] leaves, myrtle and laurel leaves.#t_footnote(<nt747>, "nr747")[6]
  ]
  #p_normal[
...
#emph[asam]#t_footnote(<nt748>, "nr748")[7] for Capricorn, euphorbium for Aquarius, and #emph[thymiama]#t_footnote(<nt749>, "nr749")[8] for Pisces.#t_footnote(<nt750>, "nr750")[9]
  ]
  #p_normal[
...
#character[
  ...
  #p_normal[
    Collyries#t_footnote(<nt751>, "nr751")[1] and ointments harmonize natural and celestial powers around our spirits. They multiply, change, transform, and change in shape. They also transpose those forces that belong to themselves: not only can they act in their own body but also near them#t_footnote(<nt752>, "nr752")[2] and by visible rays, through bewitchings, and touch by a certain similar quality.
  ]
  #p_normal[
    But our spirits are a vapor of blood: subtle, pure, lucid, airy, and unctuous.#t_footnote(<nt753>, "nr753")[3] We, therefore, make collyries uniting similar vapors, which are more agreeable to our spirits in substance. Then, because of their great similarity, [these collyries] draw, attract, and change the spirit.
  ]
  #p_normal[
  ...
  #p_normal[
    Therefore, collyries are made so that we can immediately see shadowy daemons of the air or elsewhere, of which I have learned to make from a preparation of the gall of a man, the eyes of a black cat, and certain other things.#t_footnote(<nt756>, "nr756")[6] Also like this, is a preparation from the blood of a hoopoe, bat, and a male goat. As it is said: “If you take a steel mirror with the juice of mugwort#t_footnote(<nt757>, "nr757")[7] and fumigate, it makes it possible to see hidden spirits.”
  ]
  #p_normal[
  ...
  #p_normal[
    Not only by these arts are these kinds of passions, apparitions, and imaginations induced, but, in fact, also things and men can be exchanged and transformed into various forms, such as the poet wrote about Proteus, Pericleminus, Achelous, and Metra the daughter of Erisichthon.#t_footnote(<nt758>, "nr758")[8] “Circe changed the companions of Ulysses,”#t_footnote(<nt759>, "nr759")[9] and as once [happened] with the sacred Lycaean Jupiter, who ate the entrails of a sacrifice, changed a man to a wolf. Pliny said this happened to a certain Demarchus.#t_footnote(<nt760>, "nr760")[10]
  ]
  #p_normal[
    Augustine thought the same. He said that while in Italy, certain women gave travelers sorceries in cheese that changed them into mules and then back again. When the load [the women] wished to be carried was finished, [the mules] were restored to men. The father of a certain Praestantius also befell this accident.#t_footnote(<nt761>, "nr761")[11] The sacred scriptures themselves testify that Pharaoh’s magicians changed their wands into serpents and water into blood, among other things.#t_footnote(<nt762>, "nr762")[12]
  ]
]
...
#character[
  ...
  #p_normal[
    Therefore, through these alligations, suspensions,#t_footnote(<nt763>, "nr763")[1] wrappings, substitutions, and contact with the body, the soul is accidentally#t_footnote(<nt764>, "nr764")[2] changed through illness, health, boldness, fear, sadness, gladness, and the like.#t_footnote(<nt765>, "nr765")[3] [The World Soul] returns to the wearer kindness or fright, acceptance or rejection, honor and esteem, or distaste and abomination.#t_footnote(<nt766>, "nr766")[4]
  ]
  #p_normal[
    But these kinds of passions are said to be infused by no other [reason] than as is shown in the grafting of trees,#t_footnote(<nt767>, "nr767")[5] where the vital virtues are transferred from the trunk to the branch grafted onto it, bound to the other, as if by contact but not touching each other.#t_footnote(<nt768>, "nr768")[6] For example, when a female palm tree approaches the male, her branches bend toward him and curve. When gardeners see this, they bind the branches from male to female, then return to their straight positions, as she has now inherited the male’s virtues through the continuity of the rope.#t_footnote(<nt769>, "nr769")[7]
  ]
  #p_quote[
...
#character[
  ...
  #p_normal[
    There are wondrous virtues for places, whether from things in those places, from stellar influences accompanying them, or from any distant method. For instance, Pliny refers to the cuckoo, saying that in the place where one first hears [this bird], if one traces around one’s right foot and then digs that spot up, fleas will not breed in that spot.#t_footnote(<nt783>, "nr783")[1]
  ]
  #p_normal[
    Thus, it is said that if bees are sprinkled with the dust collected from the track of a serpent, they will return to their beehive. Likewise, the dust in the place where a she-mule has rolled, if sprinkled on the body, will soften the fires of love.#t_footnote(<nt784>, "nr784")[2] Moreover, if the dust in which a hawk has rolled itself is bound with red linen, it cures quartan fever.#t_footnote(<nt785>, "nr785")[3] Also, a small stone collected from a swallow’s nest is said to immediately cure epilepsy, and if bound will perpetually protect from it, especially if a swallow’s blood or heart is wrapped with it.#t_footnote(<nt786>, "nr786")[4] It is said that if one has a cut vein, and while they are fasting, walks over to a place where someone recently fell into an epileptic state, they will catch that sickness. Pliny wrote that an iron nail fastened in the place where the head first fell into an epileptic state will cure him of that evil.#t_footnote(<nt787>, "nr787")[5] Also if the herbs growing in the head of a statue are collected and bound in any garments with a red thread, pain in the head will immediately weaken. Furthermore, whatever herbs are collected from streams or fountains before sunrise and bound to the left arm will cure tertian fever—that is, if no one sees them collecting the herbs and if the sick person is unaware of it.#t_footnote(<nt788>, "nr788")[6]
  ]
  #p_quote[
...
#character[
  ...
  #p_normal[
    It is said that epilepsy can be cured with meat from the flesh of a wild beast, if it is killed from the same iron that killed a man.#t_footnote(<nt820>, "nr820")[3] One will never have faulty and sore eyes if they touch their eyes three times with the same water in which they washed their feet.#t_footnote(<nt821>, "nr821")[4] Sexual organs are healed by taking a thread from a loom and tying it into nine or seven knots, and with each knot naming a widow.#t_footnote(<nt822>, "nr822")[5] Likewise, a sheep’s spleen stretched over a painful spleen is said to be a medicine to heal spleens: after which [the sheep’s spleen] is to be enclosed in the wall or roof of a sleeping room and sealed with a ring and a prayer spoken twenty-seven times.#t_footnote(<nt823>, "nr823")[6] The same disorder is cured if the urine of a green lizard is placed in a pot and suspended in front of the sleeping room, with the sick person touching it with their hand when leaving and entering.#t_footnote(<nt824>, "nr824")[7]
  ]
  #p_normal[
    Likewise, it is said that a lizard killed in the urine of a man#t_footnote(<nt825>, "nr825")[8] will restrain that man’s lust;#t_footnote(<nt826>, "nr826")[9] however, it is said that if a dog’s urine is mixed with a man’s own [urine], it will relax lust and his loins will feel numb.#t_footnote(<nt827>, "nr827")[10] It is said that if one’s own urine is dropped on the feet early in the morning it will be contrary to all evil medicines.#t_footnote(<nt828>, "nr828")[11] The small frog that climbs in trees, if spat from one’s mouth and let go, is said to cure coughs.#t_footnote(<nt829>, "nr829")[12]
  ]
  #p_quote[
    #emph[The effects of spittle or saliva.]
  ]
  #p_normal[
    Likewise, wonderful but easily experienced is what was mentioned by Pliny, that if one regrets a blow inflicted from afar or near and immediately spits into the middle of their hand that hit, immediately the hurt of the blow is lightened. This is approved for injured four-footed animals who are immediately cured by such remedies. Also, certain blows before they happen are made heavier when carrying spittle in the hand.#t_footnote(<nt830>, "nr830")[13] Similarly, spitting in the right shoe before getting dressed is beneficial when about to cross into a place that is dangerous.#t_footnote(<nt831>, "nr831")[14] Likewise, we spit to repel the contagion of epilepsy. We also spit in our laps hoping for a pardon from the gods for having too much boldness.#t_footnote(<nt832>, "nr832")[15] In a similar manner, it is customary to spit three times in prayer for all medicines and for helping their effects.
  ]
  #p_quote[
    #emph[How to prevent wolves from the borders.]
  ]
  #p_normal[
    It is said that wolves will not approach fields if one is captured, its feet broken,#t_footnote(<nt833>, "nr833")[16] and a knife driven into it, with its blood gradually scattered around the boundary and then buried in that place where it first set foot.#t_footnote(<nt834>, "nr834")[17]
  ]
  #p_normal[
    The Methanian people of Troezenia#t_footnote(<nt835>, "nr835")[18] had a certain quick acting remedy that was always verified by experience against injury to vines from the south wind. If that wind blows, a white rooster is pulled into two pieces down its the middle by two men. Having done this, each holds onto their part and walks into the vineyard, moving around the border until they reach the original place. There, they bury the rooster’s pieces.#t_footnote(<nt836>, "nr836")[19]
  ]
  #p_normal[
    It is also said, that if one holds a viper over a vapor with a staff, they will predict the future.#t_footnote(<nt837>, "nr837")[20] Likewise, a staff that has shaken out a frog#t_footnote(<nt838>, "nr838")[21] from a snake will aid birth.#t_footnote(<nt839>, "nr839")[22] Pliny himself wrote these.
  ]
  #p_normal[
    It is also commanded that when collecting roots and herbs, we must first draw three circles around them with a sword, then dig them up, but additionally be wary of an opposing wind. It is likewise said that if one measures a dead man with a rope, first from the elbow to the largest finger, then from the shoulder to the same digit, afterward from the head to the feet (making all measurements three times),#t_footnote(<nt840>, "nr840")[23] anyone afterward who is measured with the same rope in the same manner will have a lack of prosperity and misfortune and fall into disaster and sadness.
  ]
  #p_normal[
    And Albertus writes from #emph[Kyranides,] if a woman has maliciously bound one with love, take her shirt and urinate through her hood and right sleeve outdoors. Then the maleficence will dissolve.#t_footnote(<nt841>, "nr841")[24] And Pliny said that if sitting with someone who is pregnant, or when medicine is given to anyone, one should hold their fingers together like the teeth in a comb. This is a spell verified when Alcmene bore Hercules. It unlukier if they are around one or both knees. Similarly, sitting with legs crossed is a spell and is therefore forbidden in councils with leaders and powerful men, as it hinders all actions.#t_footnote(<nt842>, "nr842")[25]
  ]
  #p_normal[
...
#character[
  ...
  #p_normal[
    Faces and gestures, motions, positions, and shapes of the body are conducive for obtaining celestial gifts from above and expose us to the superiors and produce certain effects in us. For instance, with hellebore, when collecting that herb or leaf, pull up or down, for this causes those humors to be drawn up or down.#t_footnote(<nt843>, "nr843")[1]
  ]
  #p_quote[
...
frightens them. Thus, gestures and the figure easily move [others] to pity, to mourning, and thus the figure easily excites people to love.#t_footnote(<nt844>, "nr844")[2]
  ]
  #p_normal[
    But you must know that gestures and figures of this kind are, as it were, a harmony of the body that is exposed in no other way to the celestials than by odors, spiritual medicines, and passions of the inner soul. For just as in medicines and passions of the soul, certain celestial dispositions coalesce, thus also certain celestial influences produce effects in gestures and movements of the body.#t_footnote(<nt845>, "nr845")[3]
  ]
  #p_quote[
  ...
  #p_poetry[
    #emph[And words weighed with stretched out lips.#t_footnote(<nt846>, "nr846")[4]]
  ]
  #p_normal[
  ...
  #p_normal[
    Venus has dancing, laughing,#t_footnote(<nt847>, "nr847")[5] friendly and happy faces.
  ]
  #p_normal[
    Mercury has gestures that are inconstant, active, deceitful, and the like, and the same with faces.
  ]
  #p_normal[
    The Moon has gestures that are movable, sorcerous,#t_footnote(<nt848>, "nr848")[6] youthful, and the like.
  ]
  #p_normal[
    Just as we spoke about gestures, there are also specific figures of men. Indeed, Saturn indicates in men among colors black and yellow, thin, bent, rough skin, prominent veins, a hairy body, small eyes, joined eyebrows,#t_footnote(<nt849>, "nr849")[7] a thin beard, large lips, gazing at the ground, heavy steps, shuffling the feet as he walks; crafty, clever, a seducer, and a killer.
  ]
  #p_quote[
    #emph[The figures to which the planets respond.]
  ]
  #p_normal[
    However, Jupiter signifies the colors white suffused with red, a beautiful body, good stature, bald,#t_footnote(<nt850>, "nr850")[8] having somewhat large eyes, not absolutely black, wide pupils, a short unequal nose, teeth somewhat forward, a curly beard, a good soul, and good morals.
  ]
  #p_normal[
  ...
  #p_normal[
    However, the Moon signifies a man colored white mixed with red, a beautiful stature, a round face and often marked, eyes not entirely black, and joined eyebrows; benevolent, easy, and sociable.#t_footnote(<nt851>, "nr851")[9]
  ]
  #p_normal[
    The signs and the decans of the signs have their figures, which if one wishes to know, one may search in astrological books. Finally there are arts that derive information from the body, such as physiognomy, metoposcopy, chiromancy, and other divinatory arts that depend upon figures and gestures. [These figures] do not predict future events as causes but as signs—similar effects produced by similar causes.#t_footnote(<nt852>, "nr852")[10] And although these kinds of divination may be considered to prophesy by inferior and weak signs, yet do not judge them harshly nor condemn them when such prognostication is made not from superstition but from a harmonious correspondence of all parts of the body.#t_footnote(<nt853>, "nr853")[11] Whoever best imitates the celestials in nature, study, action, motion, gesture, face, disposition of the soul, and opportune time is more likely to receive the gifts from the superiors.#t_footnote(<nt854>, "nr854")[12]
  ]
]
...
#emph[On Times].#t_footnote(<nt855>, "nr855")[1] Among the kinds of divinations, the chief are auspices and auguries. The Romans once held these in such great value, that no public or private business would be completed without auspices being performed. However, the Etruscan#t_footnote(<nt856>, "nr856")[2] people especially excelled in the art, which Cicero eloquently declared in his book 
#emph[On Divination].
  ]
  #p_quote[
...
#emph[fernova, fervetus, confert,]#t_footnote(<nt859>, "nr859")[5]#emph[emponenthem, sonnasarnova, 
...
He then explains the names:
  ...
  #p_normal[
    #emph[Scassarnova#t_footnote(<nt860>, "nr860")[6]] is if you see behind you a man or a bird, but before they reach you or come toward you, you see them pause on the right side. This is a good sign for you.
  ]
  #p_normal[
  ...
  #p_normal[
    #emph[Hartenam ]is an augury if a man or a bird comes from behind on the right side passing to the left and then you see them pausing somewhere. This is a bad sign.#t_footnote(<nt861>, "nr861")[7] This is from Scot.
  ]
  #p_normal[
    The ancients also had auguries from sneezes, which Homer remembers in the seventeenth book of the 
#emph[Odyssey,] because they were thought to have proceeded from a sacred place—that is, the head from where the intellect thrives and operates;#t_footnote(<nt862>, "nr862")[8] and from whichever unexpected speech that comes from the mouth or mind early in the morning, is said to be some prognostication or augury.
  ]
]
...
#emph[albanellus]#t_footnote(<nt882>, "nr882")[20] flies past from the left to the right, it is hospitable to cheerfulness, if from the opposite indicates the opposite. Owls are always unlucky as is the little owl, which, because they approach chickens unforeseen at night, just as death approaches unforeseen, it is therefore said that they foretell death.#t_footnote(<nt883>, "nr883")[21] Yet sometimes, because they are not blind in the darkness of night, owls are said to signify diligence and vigilance in men—because [an owl] was approved when it settled on the spear of Hiero.#t_footnote(<nt884>, "nr884")[22] However, Dido saw unluckiness in owls when stirring up Aeneas; of which the poet sang:
  ]
  #p_poetry[
    #emph[From its height, the lonely owl cries]
  ]
  #p_poetry[
    #emph[Often pleading and sending out its long weeping call;]#t_footnote(<nt885>, "nr885")[23]
  ]
  #p_normal[
    and elsewhere:
  ]
  #p_poetry[
    #emph[The ignoble owl is a dire omen to mortals.]#t_footnote(<nt886>, "nr886")[24]
  ]
  #p_normal[
    Likewise, [an owl] sang in the Capitol when Roman things were inferior at Numantia, and also Fragellae was destroyed because of a conspiracy in Rome against them.#t_footnote(<nt887>, "nr887")[25] And Almadel says that horned owls and night ravens, when they divert to unusual regions and houses, indicate the death of men in that same region or house because those birds delight in corpses and sense them beforehand; moreover, dying men have an association#t_footnote(<nt888>, "nr888")[26] with corpses.#t_footnote(<nt889>, "nr889")[27] However, the hawk foretells conflict, as sung by Naso:#t_footnote(<nt890>, "nr890")[28]
  ]
  #p_poetry[
    #emph[We hate the hawk because it always lives in arms.]#t_footnote(<nt891>, "nr891")[29]
  ]
  #p_normal[
    Laelius, the envoy of Pompey, was killed in Spain among purveyors; it was said that a hawk flew over his head and foretold his doom.#t_footnote(<nt892>, "nr892")[30] And Almadel said that if members of the same species of bird are seen fighting 
among themselves, it signifies a change of kings. If, however, different kinds [of birds] are fighting with them and are never seen to come together, it predicts new fortunes for that region.#t_footnote(<nt893>, "nr893")[31]
  ]
  #p_normal[
  ...
  #p_normal[
    Swallows, because when they are dying they prepare a safe place for their young, predict a great inheritance or a bequest from a death.#t_footnote(<nt894>, "nr894")[32] A bat meeting a fleeing swallow signifies escape, because a bat (even though they have no feathers) is able to fly.#t_footnote(<nt895>, "nr895")[33] However, a sparrow is a bad omen for one fleeing. This is because they flee from hawks and run toward the owl, but both are equally predators.#t_footnote(<nt896>, "nr896")[34] Still, seeing sparrows is taken as a good auspice in love, since when these birds are roused in desire they have intercourse seven times in an hour.#t_footnote(<nt897>, "nr897")[35] Bees are a good omen for kings, for they show a compliant people.#t_footnote(<nt898>, "nr898")[36] However, flies signify inconsideration and shamelessness, because often when they are driven away, they nevertheless return.#t_footnote(<nt899>, "nr899")[37]
  ]
  #p_quote[
    #emph[Domestic auguries.]
  ]
  #p_normal[
    Domestic birds are not without auguries. For instance, crowing roosters promote hope and the beginnings of journeys. For example, when Tiberius was about to be born, his pregnant mother, Livia, took a hen’s egg and kept it warm in her bosom until a rooster with a great comb emerged. Augurs interpreted this that the boy about to be born would be a king.#t_footnote(<nt900>, "nr900")[38] And Cicero wrote that the Theban roosters crowing the entire night portended victory of the Boeotians against the Lacedaemonians. That augury was explained thus, because the bird is silent when conquered, and crows when victorious.#t_footnote(<nt901>, "nr901")[39]
  ]
  #p_quote[
    #emph[Auguries taken from animals.]
  ]
  #p_normal[
    Likewise, omens of events are taken from animals and beasts with a similar rationale. For instance, meeting a weasel is ominous.#t_footnote(<nt902>, "nr902")[40] Meeting a hare is fearful for the traveler unless it is captured.#t_footnote(<nt903>, "nr903")[41] Likewise, a mule is hostile because it is barren.#t_footnote(<nt904>, "nr904")[42] However, pigs are destructive; indeed, such is their nature, and therefore they signify destructive men.#t_footnote(<nt905>, "nr905")[43] Horses show quarrels and battles; from Virgil, when seeing white horses, Anchises exclaimed:
  ]
  #p_poetry[
  ...
  #p_normal[
    Yet, when horses meet while connected to a chariot because they are drawn united together with a yoke, this signifies expected peace.#t_footnote(<nt906>, "nr906")[44] Asses are useless, yet one was useful to Marius, who, when he was proclaimed an enemy in his country, saw an ass scorning the food offered to him while running toward water, which he reasoned was an augury that showed him a way to safety. He asked for the help of his friends and asked for them to gather at the sea, where they obtained a small boat and thus escaped the triumphant Sulla’s threat.#t_footnote(<nt907>, "nr907")[45] Whenever someone meets a female ass, it is an augury always signifying labor, endurance, and impediments.
  ]
  #p_normal[
    However, wolves are known as good messengers. Their effectiveness was seen by Hiero of Sicily, who had a wolf snatch away his writing tablet in school, thus declaring the success of his kingdom. Yet, if a wolf sees [the person] first, it will mute his voice.#t_footnote(<nt908>, "nr908")[46] The watchman of consuls P. Africanus and C. Fulvius was torn apart by a wolf when the Roman army was overcome by the slaves in Sicily.#t_footnote(<nt909>, "nr909")[47] [The wolf] also signifies faithless men and bad faith. This was known to the descendants of Romulus, who [with Remus] had formerly sucked faith from the shewolf and kept it to themselves from the beginning, and it flowed as if by natural law to their descendants.#t_footnote(<nt910>, "nr910")[48]
  ]
  #p_normal[
    If a lion is met, it is good, since among other animals it is the strongest and strikes fear in all.#t_footnote(<nt911>, "nr911")[49] However, a woman meeting a lioness is bad because it impedes conception: this is because a lioness does not give birth a second time.#t_footnote(<nt912>, "nr912")[50] Meeting sheep and goats is good: as was gathered in the #emph[Prodigies of the Etruscans,]#t_footnote(<nt913>, "nr913")[51] if this animal has any unusual color, it portends to the emperor the abundance of all things with happiness. As Virgil sings about Pollio:
  ]
  #p_poetry[
    #emph[But in the meadows rams will be agreeably red]
  ]
  #p_poetry[
    #emph[Their changing fleece now purple now yellow.#t_footnote(<nt914>, "nr914")[52]]
  ]
  #p_normal[
    It is also good to meet an ox threshing, but it is better if it is plowing. Even if the way is broken on a journey and hindered by such an encounter, this delay is compensated by the grace of this augury. Meeting a dog is favorable in a journey: when Cyrus was abandoned in the forest, he was nurtured by a dog until he came to his kingdom.#t_footnote(<nt915>, "nr915")[53] Likewise, the angel, an associate of Tobias, did not despise the dog as a companion.#t_footnote(<nt916>, "nr916")[54] A beaver, because it bites off its own testicles and leaves them for the hunters, is a bad omen: it predicts that a man will inflict ruin on himself.#t_footnote(<nt917>, "nr917")[55]
  ]
  #p_quote[
    #emph[Omens with small animals.]
  ]
  #p_normal[
    Among small animals, mice also signify ruin. When they chewed the gold in Rome, that same day both consuls were ambushed near Tarentum by Hannibal.#t_footnote(<nt918>, "nr918")[56] Locusts, if making a stand or destroying a place, hinder prayers and are a bad omen. On the other hand, cicadas promote journeys and announce the good outcomes of things. Spiders, weaving their thread from above, are said to announce the coming of expected money. Similarly, ants, because they learned to provide for themselves and prepare a safe hiding place, portend security and wealth and signify a great army.#t_footnote(<nt919>, "nr919")[57] Hence, when Tiberius Caesar saw that ants devoured a tame serpent,#t_footnote(<nt920>, "nr920")[58] this sign told him to beware the tumult of the multitude.#t_footnote(<nt921>, "nr921")[59]
  ]
  #p_normal[
    If you meet a snake, beware of a slanderous enemy: for this animal is powerful from its mouth and no other member.#t_footnote(<nt922>, "nr922")[60] A snake creeping into Tarquinius’s palace augured his fall. Two snakes, male and female, were found in the bed of [Tiberius] Sempronius Gracchus. He was told by a soothsayer that, depending upon if the male or female was released, either he or his wife would shortly die. Gracchus, preferring the life of his wife, killed the male and released the female. He died a little while later.#t_footnote(<nt923>, "nr923")[61] A viper signifies crooked women#t_footnote(<nt924>, "nr924")[62] and wicked children,#t_footnote(<nt925>, "nr925")[63] and an eel signifies a man hostile to everything: indeed, they live separately from other fish. They are not found together with any other.#t_footnote(<nt926>, "nr926")[64]
  ]
  #p_normal[
    Among all auspices and omens, nothing is more effective than men, and nothing is more powerful, because truly nothing can be explained clearer. Therefore, diligently observe and seek his condition: life, sex, profession, structure, gestures, movements, exercise, complexion, habits, name, words, and speech. For, among other animals, in which so many presages are revealed, no doubt the most efficacious and clearest omens are those infused in the human soul: [Marcus] Tullius [Cicero] himself testified to this, saying that there is a certain divination naturally in the human soul that belongs to mankind eternally and allows us to recognize the sequence of all things and their causes.#t_footnote(<nt927>, "nr927")[65] In the foundation of the city of Rome, the head of a man was found with his entire face: this portended the greatness of the empire and gave the name of the Capitoline hill. The soldiers of Brutus battling against Octavian and Marc Antony offended an Ethiopian in the entrance of their camp, whom they slaughtered. This [was seen] as an unfavorable augury, and thus their battle was unfavorable, and both Brutus and Cassius perished. Also, meeting monks is generally ominous, but more so if it happens early in the morning. This is because these kinds of men live much for the dead, just as vultures do for the slaughtered.#t_footnote(<nt928>, "nr928")[66]
  ]
  #p_quote[
...
#character[
  ...
  #p_normal[
    Auspices and auguries, which foretell the future from animals and birds, we read were first demonstrated by the theologian Orpheus.#t_footnote(<nt929>, "nr929")[1] Afterward, all great nations made use of them. But they are verified by the light of the natural senses. Certain lights of divination descending from above to quadrupeds, winged animals, and other beasts through which [creatures] they may portend to us human events.#t_footnote(<nt930>, "nr930")[2] Virgil also seemed to perceive this, as he sang:
  ]
  #p_poetry[
    #emph[Nor do I believe that they have divine]
  ]
  #p_poetry[
    #emph[Knowledge, or a greater foresight of the fates of things.]#t_footnote(<nt931>, "nr931")[3]
  ]
  #p_normal[
  ...
  #p_normal[
    Similarly, vultures, with their senses, foresee future massacres from battles. They congregate in places where such events will happen, as they foresee future food for themselves from corpses. With the same senses, partridges recognize their [real] mother, who they have never seen, and abandon the [partridge] who stole their mother’s eggs and kept them warm.#t_footnote(<nt932>, "nr932")[4]
  ]
  #p_normal[
    These same senses (the soul of man being entirely ignorant of them) perceive certain harmful and terrifying things, from where terror and horror possess many men, perceiving or considering none of these things. Thus, a robber hidden somewhere in a house, with no one knowing or thinking about it, strikes horror and terror and disturbs the heart of those dwelling in the house—perhaps not everyone, because that brilliance does not belong to all men but only a few. Thus, some are able to sense a prostitute hidden in a large house, while others are ignorant#t_footnote(<nt933>, "nr933")[5] [of the prostitute’s presence].
  ]
  #p_normal[
    In histories, a certain Heraiscus from Egypt is named: a man with a divine nature, who could recognize an unclean woman not only with his eyes but also from hearing her voice from afar. Immediately, his head would hurt because that kind of thing did not affect him moderately.#t_footnote(<nt934>, "nr934")[6] Likewise, William of Auvergne refers to a certain woman of his time who loved a man. When approaching a place where she stayed, with her senses, she could perceive him coming from two miles away.#t_footnote(<nt935>, "nr935")[7]
  ]
  #p_normal[
    [William of Auvergne] also refers to a certain [female] stork, also in his time, who was convicted of adultery by a male who could smell it. The male gathered a multitude of storks and uncovered the crime of the female. That entire multitude judged the culprit guilty, then defeathered and mangled her.#t_footnote(<nt936>, "nr936")[8] He also wrote of a certain horse, who was ignorant of his mother and had intercourse with her. Afterward, he understood this, and with his own teeth, tore off his genitals, as if he were punishing himself for incest.#t_footnote(<nt937>, "nr937")[9] Similar horses were written about by Aristotle,#t_footnote(<nt938>, "nr938")[10] Varro,#t_footnote(<nt939>, "nr939")[11] and Pliny.#t_footnote(<nt940>, "nr940")[12] Pliny himself wrote of a certain asp who acted in a similar way, who, after coming daily to a certain table in Egypt to feed, gave birth to some young, who killed one son of the host. The asp returned and recognized the crime, killed the young, and afterward never returned to the house.#t_footnote(<nt941>, "nr941")[13]
  ]
  #p_normal[
    From these examples, we see how the lights of presages can descend over certain animals, such as signs of things in their movement, voice, flight, approach, food, color, and other agreements of this sort.#t_footnote(<nt942>, "nr942")[14] For, according to the doctrine of the Platonists, there is a certain power engrafted into inferior things, which for the most part agree with their superiors. From these, the tacit consensus of animals seems to agree with the divine bodies, and these bodies and effects cause their strengths, whose names are ascribed by the divine.#t_footnote(<nt943>, "nr943")[15]
  ]
  #p_normal[
  ...
  #p_poetry[
    #emph[The ignoble owl, a dreadful mortal omen.]#t_footnote(<nt944>, "nr944")[16]
  ]
  #p_normal[
    Indeed, the swan is a delightful bird, Venusian, and also sacred to Phoebus. It is said to presage happiness, especially in auspices for sailors, because swans do not drown in water; as Aemilius#t_footnote(<nt945>, "nr945")[17] sang:
  ]
  #p_quote[
    #emph[Swans.]
  ]
  #p_poetry[
    #emph[In auspices, the swan is always the happiest bird.]#t_footnote(<nt946>, "nr946")[18]
  ]
  #p_normal[
    There are also omenal songbirds,#t_footnote(<nt947>, "nr947")[19] who make auspices through their mouth and sing, as with the raven, woodpecker, and crow;#t_footnote(<nt948>, "nr948")[20] from Virgil:
  ]
  #p_poetry[
    #emph[Often the crow inauspiciously predicts from the hollow oak.#t_footnote(<nt949>, "nr949")[21]]
  ]
  #p_normal[
    However, there are birds that predict by flight such as buzzards, ospreys, eagles, vultures,#t_footnote(<nt950>, "nr950")[22] cranes, swans, and the like. Their flight is to be considered, whether flying slowly or quickly, whether flying from the left or right, and likewise how many of them are flying over. In this manner, cranes—when flying quickly—signify storms. When silent, [they signify] good weather. Likewise, two birds#t_footnote(<nt951>, "nr951")[23] flocking together is deadly and is said to predict evil, because that is the number of confusion. Investigate the others in a similar way, transferring the rationale of the numbers here.
  ]
  #p_quote[
  ...
  #p_poetry[
    #emph[Or holding at port or approaching with full sails.]#t_footnote(<nt952>, "nr952")[24]
  ]
  #p_normal[
    But the most wonderful auguries are the kind that hear and understand the conversation of animals, as we read from the ancients Melampus, Tiresias, Thales,#t_footnote(<nt953>, "nr953")[25] and Apollonius of Tyana, who excelled in understanding the conversations of birds. Philostratus and Porphyry wrote that once when Apollonius sat in the company of friends, he observed some sparrows sitting in a tree. Then, coming from elsewhere, a single sparrow chattered and made loud noises and flew away with the others following him. Then Apollonius said to his friends: “That sparrow reported to the others that near Rome an ass laden with wheat fell in a narrow street, and the wheat was spilled everywhere on the ground.” These words very much excited everyone, and they went to test this and thus found Apollonius’s words were fact.#t_footnote(<nt954>, "nr954")[26] But the Platonist Porphyry in the third book of 
#emph[The Sacrifices] said that it was a swallow.
  ]
  #p_normal[
    Indeed this is certain, because every voice of each animal signifies some of the passions, dispositions, happiness, sadness, or anger of its soul. That their voices can be understood among trained men is no wonder.#t_footnote(<nt955>, "nr955")[27] However, Pliny tells us that Democritus named certain birds that, when their blood was mixed by an art he handed down, this would beget serpents. Whoever ate of these understood the speech of birds.#t_footnote(<nt956>, "nr956")[28] Hermes said that if on a certain day on the calends#t_footnote(<nt957>, "nr957")[29] of November, one goes out to hunt birds, and then cooks the first bird captured with the heart of a fox, everyone who eats this bird will understand the voices of birds and other animals.#t_footnote(<nt958>, "nr958")[30] Also, the Arabs wrote that they could understand the thoughts of beasts if the heart or liver of a serpent#t_footnote(<nt959>, "nr959")[31] was consumed. Proclus the Platonist believed and wrote that the heart of a mole was good for predictions.#t_footnote(<nt960>, "nr960")[32]
  ]
  #p_quote[
  ...
  #p_poetry[
    #emph[Was Tages . . .]#t_footnote(<nt961>, "nr961")[33]
  ]
  #p_normal[
  ...
  #p_poetry[
    #emph[The other part trembles and the veins prominently pulse.]#t_footnote(<nt962>, "nr962")[34]
  ]
  #p_normal[
    Then, the entrails completed, the heart was searched for; because, if the victim was found without one, or a head was missing in the liver, that was a disastrous auspice and were called expiatory.#t_footnote(<nt963>, "nr963")[35] It was the same if the victim escaped from the altar, or made a loud cry when pierced, or fell on a different part of his body than he should.#t_footnote(<nt964>, "nr964")[36]
  ]
  #p_normal[
    We read about Julius Caesar, that he appeared on a day in his purple robe and sat in his golden chair, but the sacrifices twice lacked a heart. C. Marius sacrificed at Utica, and it was found lacking a liver.#t_footnote(<nt965>, "nr965")[37] It was the same with the prince Caius#t_footnote(<nt966>, "nr966")[38] and M. Marcellus. C. Claudius and L. Petellius consulted with sacrificial victims, where the liver suddenly melted away: not much later one became sick, the other died in battle in Liguria.#t_footnote(<nt967>, "nr967")[39] The entrails predicted this, because it was thought to proceed from a virtue of the gods or the work of daemons.
  ]
  #p_normal[
    Hence, according to the ancients, it was always of greatest importance if something unusual appeared in entrails: as when Sulla sacrificed at Laurentum, the likeness of a crown appeared in the head of the liver, which the soothsayer Posthumius interpreted as victory for the kingdom and therefore suggested that only Sulla should eat the entrails.#t_footnote(<nt968>, "nr968")[40] Also, the color of the entrails must be considered; as recalled by Lucan:
  ]
  #p_poetry[
  ...
  #p_poetry[
    #emph[Sprinkled much with bluish blood.]#t_footnote(<nt969>, "nr969")[41]
  ]
  #p_normal[
...
#character[
  ...
  #p_normal[
    Thus, prodigies came before the birth or death of many eminent men and kings. Cicero recounts how when Midas was a young boy an ant threw grains of wheat in his mouth while he was sleeping, which was an omen of great wealth. While Plato was sleeping in the cradle, a bee landed on his mouth, foretelling the sweetness of his speech. When Hecuba was giving birth to Paris, she saw a burning torch, which would burn all of Troy and Asia. The mother of Phalarus saw an image of Mercury pouring blood on the ground, which flooded the entire house. The mother of Dionysus saw herself giving birth to a satyr,#t_footnote(<nt972>, "nr972")[3] which was a prodigious dream that was proved by the event that followed. The wife of Tarquinius Priscus saw flames licking the head of Servius Tullius, predicting his kingdom.#t_footnote(<nt973>, "nr973")[4] In a similar manner, as Aeneas disputed with his father, Anchises, about fleeing after the capture of Troy, there appeared a flame licking the top of Ascanius’s head, but not harming him. This portended the reign of Ascanius, so Anchises was persuaded to leave.#t_footnote(<nt974>, "nr974")[5]
  ]
  #p_normal[
    All preceded and portended notable disasters and prodigies.#t_footnote(<nt975>, "nr975")[6] Thus, we read in Pliny that while M. Attilius and C. Portius were consuls, it rained milk and blood, which foretold a strong pestilence that would fall upon Rome the following year. Likewise, in Lucania, it rained iron that was almost like sponges in the year before M. Crassus was killed in Parthia, and then all of the Lucanian army, which was a very numerous army, were killed. Likewise, while L. Paulus and C. Marcellus were consuls, it rained wool around the castle of Corisanus, where T. Annius would be killed by Milo the following year. Likewise, during the Cimbrian war, the rattle of armor and sound of trumpets were heard from the sky.#t_footnote(<nt976>, "nr976")[7]
  ]
  #p_normal[
    And Livy [wrote] of the Macedonian war: “In the year that Hannibal died, it rained blood for two days.”#t_footnote(<nt977>, "nr977")[8] Likewise, in the second Punic war, it was said that water mixed with blood fell from the sky like rain at the time Hannibal destroyed Italy.#t_footnote(<nt978>, "nr978")[9] The Lacedaemonians shortly before the defeat of Leuctra heard the sound of arms in the shrine of Hercules, and at the same time in Thebes in the temple of Hercules, the double doors that were closed with bars opened themselves, and arms that were fixed to the wall were found on the ground.#t_footnote(<nt979>, "nr979")[10]
  ]
  #p_normal[
...
#character[
  ...
  #p_poetry[
    #emph[Seas, plains, and rocks of Rhodope speak.]#t_footnote(<nt980>, "nr980")[1]
  ]
  #p_normal[
    Therefore, the first is geomancy, the moving, rattling, swelling, trembling, tearing, making deep holes, exhaling vapors, and other impressions of the earth, indicate the future. The Arab Almadel handed down these arts to us.#t_footnote(<nt981>, "nr981")[2] But there is another kind of geomancy, which is divined by inscribing certain forceful or chance pricks in the earth, of which we will not speculate here, but we will speak of this later among the lots.#t_footnote(<nt982>, "nr982")[3]
  ]
  #p_quote[
    #emph[Geomancy.]
  ]
  #p_normal[
    But hydromancy excels in prophecy through impressions of water, such as ebbing and flowing, raising and lowering, storms, colors, and the like. To these are also added visions that happen in water. The Persians discovered a kind of divination that was referred by Varro, where a boy saw an effigy of Mercury in water that predicted in 150 verses all of the events of Mithridates’ war.#t_footnote(<nt983>, "nr983")[4]
  ]
  #p_quote[
    #emph[The kind of hydromancy called lecanomancy.]
  ]
  #p_normal[
    We also read that Numa Pompilius practiced hydromancy. Indeed, he elicited the images of gods in water and learned the future from them—and Pythagoras also practiced this art a long time after Numa.#t_footnote(<nt984>, "nr984")[5] There was also a kind of hydromancy called lecanomancy that the Assyrians once held in great esteem. In that art, plates of gold, silver, and precious stones inscribed with certain images, names, and characters were placed into a basin full of water.#t_footnote(<nt985>, "nr985")[6] It is said about this art that melted lead or wax was also cast into the water, and things that one desired to know were shown as notable images.
  ]
  #p_normal[
    There were also once prophetic springs, such as the Patraean fountain at Achaea,#t_footnote(<nt986>, "nr986")[7] and, it was said, the water of Juno at Epidaurus,#t_footnote(<nt987>, "nr987")[8] and many more of which we will speak later in the section on oracles. However, here we refer to the divination of fish, once captured by the Lycians 
...
#emph[Lycian History] by Athenaeus.#t_footnote(<nt988>, "nr988")[9]
  ]
  #p_normal[
  ...
  #p_normal[
    Divination of fire is through impressions of fire, through comets, colors of fire, and through visions and imagination in fire. Thus, the wife of Cicero predicted the future, that the following year he would be consul. After certain sacrifices, as she wished in the ashes, she saw that flames suddenly burst forth.#t_footnote(<nt989>, "nr989")[10] In this manner, Pliny said that [if fires kindled on the] earth are pale and hum, this will report storms. Also, rain is predicted if in a lamp, the flame twists and flies about. It portends wind if the flames go out in lamps or can scarcely be kindled. It is the same when sparks fly out in a mass, or when the coals stick to the pot when lifted, or when the fire has subsided and the embers shatter or send out sparks, or when the ash in the hearth solidifies, and when it glows excessively from the coals.#t_footnote(<nt990>, "nr990")[11]
  ]
  #p_normal[
  ...
  #p_poetry[
    #emph[Two-headed and red [the flame] gyrates and rolls.]#t_footnote(<nt991>, "nr991")[12]
  ]
  #p_normal[
    From the craters of Aetna and the fields of the nymphs in Apollonia, auguries were taken from fire and flames. It was thought happy if the flames took what was cast into them and sad if it was rejected.#t_footnote(<nt992>, "nr992")[13]
  ]
]
...
#character[
  ...
  #p_normal[
    Arab philosophers agree that some men can rise above the powers of their bodies and over their sensitive strengths, and surpass the perfection of the heavens, and receive the power of the divine intelligences.#t_footnote(<nt993>, "nr993")[1]
  ]
  #p_normal[
  ...
  #p_normal[
    As they say, all similar things are connected to their like. They are brought about by similar natures and capable of bearing all. Every act receives its agent. It is also clothed in the nature of that agent and shares its nature.#t_footnote(<nt994>, "nr994")[2] Hence it is thought that this vivification is no less directed than with certain herbs and magical confections, such as we read are made with the ashes of the phoenix and shed skin of a serpent. Though many seem fabulous and impossible, they have been proved to be historically true.
  ]
  #p_normal[
    For instance, many have been drowned in water, others thrown into fire and placed on pyres, and others are killed in war. We also read of others who were killed, and many days later live again, just as we read from Pliny of a man who was a consul from Aviola, of L. Lamia, C. Aelius Tubero, Corfidius, Gabienus, and many others.#t_footnote(<nt995>, "nr995")[3] Similarly, Aesop the storymaker, Tindoreus, Hercules, and the Palici (the sons of Jupiter and Thalia) died and were revived again. Also, history shows that there were many who were brought to life again by magicians and physicians, such as Asclepius. We mentioned above#t_footnote(<nt996>, "nr996")[4] of what Juba, Xanthus, and Philostratus [said] about Tillon, a certain Arab,#t_footnote(<nt997>, "nr997")[5] and Apollonius of Tyana.#t_footnote(<nt998>, "nr998")[6]
  ]
  #p_normal[
    We also read that a certain Glaucus was dead beyond all expectations, but a physician hastened to him with an herb called #emph[dragon,]#t_footnote(<nt999>, "nr999")[7] which is said by some to have restored him to life. Others say the physician revived him with a medicine that tasted like honey, from which arose the proverb: “Glaucus was revived from drinking honey.”#t_footnote(<nt1000>, "nr1000")[8]
  ]
  #p_normal[
    Also, Apuleius referred to these kinds of rites of revivification, of which Zachlas the Egyptian prophet said: “The prophet thus propitiated with some small herb on the mouth of the corpse and placed another on the breast. Then turned toward the east or the rising of the majestic Sun, praying silently and making a venerable scene for prompting earnest excitement for such a miracle. Now the breast rose, now the healthy veins pulsed, now filled with the spirit of the body, and the corpse arose and the young man spoke.”#t_footnote(<nt1001>, "nr1001")[9] If this is true, it follows that dying souls are sometimes hidden in the body, where they are oppressed by a vehement ecstasy and freed from all corporeal actions as life, senses, and all movement desert the body. However, a person in that state is not truly dead but rather lying lifeless and seemingly dead for a long time.
  ]
  #p_normal[
  ...
  #p_normal[
    The rabbi Moses [Maimonides] said from the book of Galen, which the patriarch translated, that this happened to a man who had suffocated for six days, neither eating nor drinking, and his arteries were hard. He said in the same book that a man who was filled#t_footnote(<nt1002>, "nr1002")[10] and lost the pulse in his entire body; his heart did not move and he lay down as if dead. He said that [a man who suffers] an accidental fall from a high place, hears a great noise, or is submerged in water for a long time may fall into a faint for forty-eight hours and lay down as if dead, his face growing dusty and green. He wrote in the same book of a man who was buried seventy-two hours after death and thus killed, because he was buried alive. There are signs where one can recognize if someone is alive, although they lay down as if dead and surely [seem to be] dead, unless assisted or through blood-letting or other cures,#t_footnote(<nt1003>, "nr1003")[11] though these seldom happen. It is in this manner that the understandings of the magicians and physicians have revived the dead, as once when one was bitten and killed by a serpent, the tribes of the Marsorus and Psillorus restored them to life.#t_footnote(<nt1004>, "nr1004")[12]
  ]
  #p_quote[
  ...
  #p_normal[
    Physicians say that with antidotes taken in small portions one can bear a long fasting as, for example, Elias, who was given a certain food from an angel and could walk and fast “from the power of that food for forty days.”#t_footnote(<nt1008>, "nr1008")[16]
  ]
  #p_normal[
    Ioannes Bocatius#t_footnote(<nt1009>, "nr1009")[17] said that in his time there was a man in Venice who each year fasted without food for forty days.#t_footnote(<nt1010>, "nr1010")[18] What is more wonderful, at the same time in lower Germany, was a woman who did not accept food for thirty years. This may indeed seem incredible to us, but it is confirmed by recent things, a miracle in our age: brother Nicolaus the Saxon from the Helvetii nation lived without any food in the wilderness for twenty-two years before he died.
  ]
  #p_quote[
    #emph[Wondrous examples of hunger.]
  ]
  #p_normal[
    Also wonderful is a certain man named Philinus mentioned by Theophrastus, who had nothing to drink or eat except milk.#t_footnote(<nt1011>, "nr1011")[19] There are serious authorities, as we read, who describe certain herbs of Sparta, with which the Scythians could endure for twelve days without food or drink if they only but taste it or hold it in their mouth.#t_footnote(<nt1012>, "nr1012")[20]
  ]
]
...
#character[
  ...
  #p_normal[
    Indeed, this [white bile], when kindled and burning, stirs up frenzy and brings to us knowledge and divination.#t_footnote(<nt1021>, "nr1021")[3] This process is especially helped by the influence of some celestial—especially Saturn,#t_footnote(<nt1022>, "nr1022")[4] who is cold and dry just like a melancholic humor and has a daily influence on the melancholic person, increasing and preserving [those tendencies]. Additionally, since Saturn is the author of secret contemplations and separation from all public business and the highest planet, his soul revokes outward offices and is always secret. He rises from below, pulls himself higher, and grants knowledge and predictions of the future.#t_footnote(<nt1023>, "nr1023")[5] This is what Aristotle intended in his book #emph[Problems,] saying: “Of melancholy, some are made as if divine, predicting the future, and some are made poets.”#t_footnote(<nt1024>, "nr1024")[6]
  ]
  #p_quote[
    #emph[Melancholics possess a genius.]
  ]
  #p_normal[
    He also said that all men in any excellent science, very much stand out as melancholic. Also, Democritus and Plato confirmed, saying that there are some melancholics who have such an excellent genius that they were seen as divine rather than men.#t_footnote(<nt1025>, "nr1025")[7] Thus, many melancholics at first stand out as undeveloped, inept, and insane. As they say, Hesiod, Ion, Tynnichus of Calcys, Homer, and Lucretius were often suddenly seized by a frenzy and, as poets, retreated and sang certain wonderful and divine things, which they themselves scarcely understood.#t_footnote(<nt1026>, "nr1026")[8] Of this, the divine Plato said in Ion: “Many prophets, after their attack of frenzy has relaxed, do not fully understand what they write. Yet each art is treated correctly in frenzy, because each artist by reading them decides this.”#t_footnote(<nt1027>, "nr1027")[9]
  ]
  #p_quote[
  ...
  #p_poetry[
    #emph[Now new races descend from the heavens above.]#t_footnote(<nt1029>, "nr1029")[11]
  ]
  #p_normal[
  ...
  #p_poetry[
    #emph[The earth freed of perpetual fear.]#t_footnote(<nt1030>, "nr1030")[12]
  ]
  #p_normal[
    And next:
  ]
  ...
  #p_poetry[
    #emph[He will rule a peaceful world with his father’s virtues.]#t_footnote(<nt1031>, "nr1031")[13]
  ]
  #p_normal[
  ...
  #p_poetry[
    #emph[The serpents and the deceitful poisonous herbs will die.]#t_footnote(<nt1032>, "nr1032")[14]
  ]
  #p_normal[
    Yet he implies that some small remnants of original sin will remain, as he said:
  ]
  #p_poetry[
    #emph[Yet some relics of ancient crimes are near.]#t_footnote(<nt1033>, "nr1033")[15]
  ]
  #p_normal[
  ...
  #p_poetry[
    #emph[The spirit to proclaim how great your accomplishments will be!]#t_footnote(<nt1034>, "nr1034")[16]
  ]
  #p_normal[
    Also, there are certain predictions, which are divinations, confined between the middle of the natural and beyond the natural,#t_footnote(<nt1035>, "nr1035")[17] as in those who are near death and debilitated by old age. People in such states sometimes foresee the future because, as Plato says in the 
#emph[Republic,] when they are less shackled to their senses, their understanding is more acute. Because they are closer to the place where they must go, the chains are, as it were, a little more relaxed and not entirely liable to the body. Thus, such people are easily illuminated by divine revelations.#t_footnote(<nt1036>, "nr1036")[18]
  ]
]
...
#character[
  ...
  #p_normal[
    Therefore, the gods lent and bound earth, fire, air, and water to each other in certain portions, making one body from all, subjecting souls to their ministry, assigning each of their powers to each province. They assigned them to certain lowly and humble places, such as passion in the breast and desire in the womb; the more noble senses [they placed] in the head, as it is the summit of the entire body;#t_footnote(<nt1037>, "nr1037")[1] then [they created] the many organs of speech.
  ]
  #p_quote[
    #emph[Which outer senses respond to the elements.]
  ]
  #p_normal[
    But the senses are divided into the outer and inner. The outer then, are divided into five notable parts, which equally have five organs or subjects, as if they were certain foundations. They are assigned and disposed thus, that they are to be collected in the most eminent parts of the body and likewise the purest.#t_footnote(<nt1038>, "nr1038")[2] Indeed, the eyes are arranged in the order of the highest place and are the purest. They are related to the natures of fire and light. Then the ears hold the second place and purity and are compared to air. The third position belongs to the nostrils, which hold the middle between air and water. However, the next is taste, which is denser and as a nature, similar to water. The last position is touch, diffused throughout the entire body. It has a density like earth.#t_footnote(<nt1039>, "nr1039")[3]
  ]
  #p_normal[
...
unless close, but touch is according to both methods: for it is perceived when near the body, and just as sight distinguishes through the medium of air, thus also touch can perceive through the medium of a stick or rod, sensing hardness and dampness. However, touch is the only sense common to all animals. But certainly, man possesses this sense: inasmuch as in touch and taste [man] excels over the other animals. But in the other three senses, some other animals prevail, such as dogs who can see, hear, and smell more acutely than man. Likewise, lynxes and eagles can see more acutely than many other animals and man.
  ...
  #p_normal[
    The fourth and last is called spite, which is a certain pleasure of evil to another without any benefit to oneself. It is said to be without any benefit to oneself, because if one is happy at some evil suffered by another because it proves useful to one’s own self, this is better, [as it is] out of love for oneself rather than malice toward another.#t_footnote(<nt1047>, "nr1047")[11]
  ]
  #p_normal[
...
or obtaining, fleeing or expelling. This sometimes [rises] with confidence, and thus indeed causes hope, then boldness; whenever with mistrust, thus arises desperation and dread or fear. And whenever that irascible power rises in vengeance, this only happens around past evil, such as with inflicted injuries or attacks, and causes anger.
  ...
  #p_normal[
    And thus, we find eleven passions in the mind, which are love, hate, loss, horror, joy, pain, hope, desperation, boldness, fear, and anger.#t_footnote(<nt1050>, "nr1050")[3]
  ]
]
...
#character[
  ...
  #p_normal[
    Anger or lust for vengeance produces heat, redness, a bitter taste, and a flux in the belly. Fear induces cold, trepidation in the heart, a failing voice, and pallor. Sadness induces sweat and a bluish white. Pity, which is a certain sadness, often induces an evil effect in the body, as it affects other bodies seeing it.#t_footnote(<nt1051>, "nr1051")[1] It is likewise widely known that, among some lovers, there is such a strong bond of love that when one suffers the other suffers.#t_footnote(<nt1052>, "nr1052")[2] Likewise, anxiety induces dryness and blackness.#t_footnote(<nt1053>, "nr1053")[3]
  ]
  #p_normal[
    Also, physicians recognize that such great heat of amorous lust stirs up in the liver and the pulse. From that opinion, the name of one’s beloved [causes the lover to be] seized in a heroic passion: thus, Nausistratus recognized that Antiochus was captivated in love for Stratonice.#t_footnote(<nt1054>, "nr1054")[4]
  ]
  #p_quote[
    #emph[The passions of the mind sometimes bring death.]
  ]
  #p_normal[
    Additionally, it is undoubted that passions of this kind, when violent, can cause death. This is plain to all people. Excessive joy, sadness, love, and hatred sometimes kill men,#t_footnote(<nt1055>, "nr1055")[5] and also often lift sickness. Thus, we read that Sophocles and Dionysius, the tyrant of Sicily, each received the announcement of a tragic victory and suddenly died. Thus, also a mother, when seeing a son returning from the battle of Cannae, suddenly died.
  ]
  #p_normal[
    Everyone knows what sadness can do. We also know that dogs often die from excessive sadness from the death of its owner. Sometimes from these kinds of passions, lasting diseases follow. In other cases, ailments are sometimes cured. Some people, when looking down from heights, shake from excessive fear, become dizzy, weaken, and lose their senses. Sobbing and fever sometimes follow epilepsy. However, when they recede, sometimes certain wonderful effects emerge. Such was the case with the son of Croesus, who was born from his mother mute: violent fear and desire shook out his voice, which nature denied long ago.#t_footnote(<nt1056>, "nr1056")[6] Thus, it often happens that due to a certain sudden accident, life, senses, and sudden movement of members leave and then suddenly return.
  ]
  #p_normal[
    Also, what such noble spirit connected with violent anger can accomplish is shown in Alexander the Great. When he was surrounded in a battle in India, he was seen to have light and fire pouring from him. We read that the father of Theodoric sent out sparks of fire from his entire body so that sparks of flames jumped out with a noise. Things like these sometimes also appear in beasts, such as the horse of Tiberius, who projected flames from his mouth.#t_footnote(<nt1057>, "nr1057")[7]
  ]
]
...
#character[
  ...
  #p_normal[
    Passions of the soul that follow imagination, when most vehement, not only change one’s own body but can also move across to operate in another’s body.#t_footnote(<nt1069>, "nr1069")[1] 
Therefore, certain wonderful impressions are produced in elements and external things, and also certain illnesses of the mind or body can thus be taken away or brought.#t_footnote(<nt1070>, "nr1070")[2] Passions of the soul are the most prominent cause of temperament in one’s own body. Thus, the soul, strongly elevated and inflamed by vehement imagination, brings health or illness—not only in one’s own body but also in another’s body.#t_footnote(<nt1071>, "nr1071")[3]
  ]
  #p_normal[
    Thus, Avicenna thought that a camel can be killed from the imagination of anyone.#t_footnote(<nt1072>, "nr1072")[4] Thus, when one is bitten by a rabid dog, the figure of a dog appears in their urine. Thus, a lusting pregnant woman can act upon another’s body, afflicting the fetus in the womb by marking it with the thing desired.#t_footnote(<nt1073>, "nr1073")[5] 
Thus, many monstrous generations are produced from pregnancies with monstrous imaginations. Such a case was referred to by Marcus Damascenus at Petra Sancta, a town situated in the confines of Pisa [province], that King Charles, emperor of Bohemia, was offered a girl whose entire body was shaggy and covered with hair like a wild beast. Her mother had a certain religious dread of the image of John the Baptist, which was near her bed during conception. This afterward affected her [pregnancy] and produced such [a child].
  ...
  #p_normal[
    The phenomena I have described does not only occur in men. We may also see it happen in brutish animals. Thus, we read that Jacob the patriarch, throwing twigs in the water, discolored the sheep of Laban.#t_footnote(<nt1074>, "nr1074")[6] Thus, peacocks and other different birds, when lying together, imprint their color upon each other’s feathers from the power of their strong imaginations, which produces white peacocks when the birds are lying together in a home with white linens hanging nearby.
  ]
  #p_quote[
    #emph[How white peacocks are produced.]
  ]
  #p_normal[
    Now, in these examples, it is shown how the affection of imagination, where it intends most vehemently, not only affects one’s own body but also another’s. Thus, enchanters who desire to destructively bewitch men harm them with a fixed gaze.#t_footnote(<nt1075>, "nr1075")[7] Avicenna, Aristotle, Algazel, and Galen assent to the same.#t_footnote(<nt1076>, "nr1076")[8] Indeed, it is known that a body is most easily corrupted by illness from the vapors of another body, which we plainly see in plague and leprosy. Again, vapors of the eyes are of such great power that they can bewitch and corrupt those who are near. The basilisk and catoblepas#t_footnote(<nt1077>, "nr1077")[9] kill men with their glance, and certain women from Scythia among the Illyrians and Triballi kill with their gaze when they are angry.#t_footnote(<nt1078>, "nr1078")[10]
  ]
  #p_normal[
    Therefore, no one should marvel that the body and soul of one can affect the mind of another, since the mind is by far more powerful, stronger, more fervent, and moves more strongly than vapors exhaling from bodies. Nor are bodies lacking through the means by which they operate, and nor is a body less subject to another’s mind than to another’s body.#t_footnote(<nt1079>, "nr1079")[11]
  ]
  #p_normal[
...
#character[
  ...
  #p_normal[
    Indeed, our mind, through imagination or reason, can conform to some star by a certain imitation, so that it is suddenly filled with the gifts of that same star, as it were, [becoming] a receptacle of its own influence. However, the contemplating mind, inasmuch as it removes and separates itself from all senses, imagination, nature, and deliberation, recollects itself—unless it exposes itself to Saturn,#t_footnote(<nt1081>, "nr1081")[1] which is not of the present investigation. Indeed, our mind works much through faith, which is a firm link, a fixed intention, and vehement application of the operation or undertaking in whatever thing cooperating with and giving power to the work that we intend to accomplish, so that an image of the virtue being received is made in us in a certain way and creates things in us or from us.#t_footnote(<nt1082>, "nr1082")[2] Therefore, we must vehemently aspire, imagine, expect, and firmly believe in any operation and thing applied. Indeed, it will be the greatest help.
  ]
  #p_normal[
    It is verified among physicians that a firm belief, undoubted hope, and love for healing and medicine are conducive for greater health, sometimes even more than medicine.#t_footnote(<nt1083>, "nr1083")[3] Because of this, since the power of the medicine and its effective strength works, the strong intellect of the physician also works. It is powerful for changing qualities in sick bodies, especially when one has faith in that physician. [Such faith] disposes them to accept the virtue of the physician and medicine.#t_footnote(<nt1084>, "nr1084")[4]
  ]
  #p_normal[
    Therefore, you must steadfastly believe in magical operations with confidence and consequently have no doubt or hesitation in your mind. For, as a firm and persevering belief makes wonderful operations (and also sometimes false operations), so disbelief with hesitation, which is a medium among two extremes, dissipates and breaks the virtue of the mind of the worker. From this, if it happens that one is frustrated and deprived of the desired influences of the superiors,#t_footnote(<nt1085>, "nr1085")[5] whereby without our mind having a stable and solid virtue with our things and operations, little can connect and unite.
  ]
]
...
#character[
  ...
  #p_normal[
    Philosophers, especially the Arabs, say that the human mind—when made attentive by its passions and dispositions toward some work—connects with the mind of the stars, and also with their intelligences. Likewise, that connection is a cause, as certain wonderful virtues are infused into our operations and into things,#t_footnote(<nt1086>, "nr1086")[1] because with them is an apprehension and power in all things. This is so because there is a natural obedience in all things to the stars and this has the natural effect [of motivating] movement toward that which the mind strongly desires when it is aligned with them.#t_footnote(<nt1087>, "nr1087")[2] Accordingly, it is verified that the mind is affected by the art of certain characters, images, incantations, sermons, and many other wonderful experiments.
  ]
  #p_quote[
...
#emph[Against the Gentiles].#t_footnote(<nt1088>, "nr1088")[3]
  ]
  #p_normal[
  ...
  #p_normal[
    And it is a general rule that all minds, which are more excellent in their desire and disposition, bring about things more suitable to them, striving for things more effective and powerful.#t_footnote(<nt1089>, "nr1089")[4] Therefore, whoever wishes to work in magic must know and recognize in their own soul its quality, virtue, measure, arrangement, and degree of power in the universe.
  ]
]
...
#character[
  ...
  #p_normal[
    It should now be plain that there is a great virtue residing in the dispositions of the mind. Additionally, you must understand that there is no less virtue in words and the names of things, and there is a great virtue included in speech and orations.#t_footnote(<nt1097>, "nr1097")[1] It is in this that we chiefly differ from beasts. We are called rational not from [mere] reasoning, which obeys according to the soul, and which they say contains affections, and which Galen also said we have in common with bestial animals (although one greater, the other less). But we are said to be rational for the reason that the voice is understood in words and speech, which is called “enunciative reason.” This is the part that far surpasses the other animals:#t_footnote(<nt1098>, "nr1098")[2] for, λόγος#t_footnote(<nt1099>, "nr1099")[3] is pronounced in Greek for reason, speech, and words.#t_footnote(<nt1100>, "nr1100")[4]
  ]
  #p_normal[
...
#emph[Hidden Things].#t_footnote(<nt1107>, "nr1107")[6]
  ]
]
...
#character[
  ...
  #p_poetry[
    #emph[Brings a love not sown . . .#t_footnote(<nt1117>, "nr1117")[4]]
  ]
  #p_normal[
    And elsewhere:
  ]
  ...
  #p_poetry[
    #emph[Perishes by enchantment . . .#t_footnote(<nt1118>, "nr1118")[5]]
  ]
  #p_normal[
  ...
  #p_poetry[
    #emph[By a song, a cold snake in the meadows is destroyed;]#t_footnote(<nt1119>, "nr1119")[6]
  ]
  #p_normal[
    And:
  ]
  #p_poetry[
    #emph[And I have seen [Moeris] move sown corn to others’ fields.]#t_footnote(<nt1120>, "nr1120")[7]
  ]
  #p_normal[
  ...
  #p_poetry[
    #emph[Fall, and fruits fall for no reason.]#t_footnote(<nt1121>, "nr1121")[8]
  ]
  #p_normal[
    If these are not true, there would not be such strict penal statutes with laws sanctioning against those who enchant fruit.#t_footnote(<nt1122>, "nr1122")[9] And Tibullus said of a certain enchantress: #emph[I have seen her draw the stars from the sky,]
  ]
  #p_poetry[
  ...
  #p_poetry[
    #emph[As she pleases, she summons snow in the summer.]#t_footnote(<nt1123>, "nr1123")[10]
  ]
  #p_normal[
  ...
  #p_poetry[
    #emph[I draw you also, Moon . . .]#t_footnote(<nt1124>, "nr1124")[11]
  ]
  #p_normal[
...
#emph[Rustic Things,] used certain incantations against illnesses of beasts,#t_footnote(<nt1125>, "nr1125")[12] which are recorded in his writings. Likewise, Solomon was experienced in incantations of this kind, as Josephus testified. Celsus Africanus likewise wrote about Egyptian doctrine, that [the parts of] the human body (just as the number of decans of the signs of the zodiac are thirty-six) are attended by [an equivalent number of] daemons, each of which supports and protects his own part, whose names are called in the name of their homeland#t_footnote(<nt1126>, "nr1126")[13] and are invoked in incantations to restore impaired parts of the body and restore health.#t_footnote(<nt1127>, "nr1127")[14]
  ]
]
...
#character[
  ...
  #p_poetry[
    #emph[Tie, Amaryllis, and in this manner, you say, “to Venus I tie these chains”;]#t_footnote(<nt1132>, "nr1132")[5]
  ]
  #p_normal[
  ...
  #p_poetry[
    #emph[With one and the same fire, thus Daphnis our love.]#t_footnote(<nt1133>, "nr1133")[6]
  ]
]
...
#character[
  ...
  #p_normal[
    God has given man a mind and speech, which (as Hermes Trismegistus said) are thought to be a gift of the same virtue, power, and immortality.#t_footnote(<nt1134>, "nr1134")[1] However, the omnipotent God Himself, by His providence, divided the speech of men into different languages. Indeed, with these languages, according to their diversity, they have likewise received different and individual letters for writing, constant in their certain reliable order, number, and figures, not accidental, by chance, nor from the fragile will of man, but divinely disposed and formed, agreeing with the celestials and the divine bodies and virtues themselves.
  ]
  #p_normal[
    However, among all languages Hebrew is notable as the most sacred of all writings.#t_footnote(<nt1135>, "nr1135")[2] In the figures of [Hebrew] characters, vowel stops, and accent points, just as consisting in matter, form, and spirit, the positions of the stars were first noted down in the seat of God, which is heaven. According to these figures, as Hebrew teachers testify, are the most fully formed letters of the celestial mysteries. [Such mysteries are shown] through their figure, form, and signification, then through the numbers signified by them, then through the various harmony bound in them.#t_footnote(<nt1136>, "nr1136")[3] The more secret Hebrew mekubalim assert that everything can be explained from the figures of their letters, forms of their characters, and their signature, simplicity, composition, separation, crookedness, direction, defect, abundance, largeness, smallness, crown, opening, closing, order, changing, connecting, revolutions, points, tops of the letters, 
...
characteristics proceed from the First Cause and repeatedly renew themselves thereby.
  ...
  #p_normal[
    To these, they arrange points and tops. Therefore, the names of all things are appointed from the characters and points of these letters and thus from the aspects of planets and signs, and likewise from the elements, the Maker, the spirit, and truly all that has been and will be,#t_footnote(<nt1137>, "nr1137")[4] 
signifying those [things] that are produced, and just as a certain sacrament and vehicle for explaining things, they bring their essence and strength everywhere with them.#t_footnote(<nt1138>, "nr1138")[5]
  ]
  #p_normal[
    These profound perceptions and sacraments are inherent in these characters and figures, and their numbers, structure, order, and revolution.#t_footnote(<nt1139>, "nr1139")[6] Origen, therefore, thought that names translated into other languages retain little of their own power, because they do not retain their natural signification.#t_footnote(<nt1140>, "nr1140")[7] Indeed, only original names, which are rightly imposed because they naturally signify, have a natural function. It is not so in those [names] which signify [only] from pleasure, that do not have the function they signify, but as they are certain natural things in themselves.
  ]
  #p_normal[
    But if there is a first and causal language, whose words have a natural signification, it is agreed that this is Hebrew,#t_footnote(<nt1141>, "nr1141")[8] whose order is indeed profound. It is held as a root, and its letters are known to revolve.#t_footnote(<nt1142>, "nr1142")[9] They are the standard and rule of any perfectly invented language.#t_footnote(<nt1143>, "nr1143")[10] Therefore, there are twenty-two letters that are the foundation of the world and all creations that are named in it: all that is said and created in the world is obtained from their revolutions, names, and strengths.
  ]
  #p_normal[
    But the investigator must search them for a long time by combining single letters, until which time the voice of God is revealed and opens the most sacred texts of the letters. Indeed, voices and words have efficacy in magical operations, because in them the first magic nature exercises, is the voice of God.#t_footnote(<nt1144>, "nr1144")[11] But these are of a higher speculation than what is handled in this book.
  ]
  #p_normal[
    But now we return to the distribution of letters. Of these the Hebrew three mothers are 
א ,ו ,י the seven doubles, 
ב ,ג ,ד ,כ ,פ ,ר ,ת then the remaining twelve, ה ,ז ,ח ,ט ,ל ,מ ,נ ,ס ,ע ,צ ,ק ,ש are simple;#t_footnote(<nt1145>, "nr1145")[12] there is an equal rationale among the Chaldeans.
  ]
  #p_normal[
...
letters and their numbers. Then they also have integral numbers, which result from the names of the letters according to the various ways of numbering them.#t_footnote(<nt1146>, "nr1146")[13]
  ]
  #p_normal(center: true)[
